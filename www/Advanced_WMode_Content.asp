...
document.getElementById("repeaterModeHint_desc").innerHTML = "<#1432#>";
document.getElementById("repeaterModeHint").style.display = "";
}
else{
show_wl_wdslist();
...
code +='<tr><td style="color:#FFCC00;"><#2027#></td>';
}
else{
...
code += '<div style="text-decoration:underline;font-weight:bolder;" onclick="rescan();"><#1237#></div>';
}
else{
...
document.getElementById("check_mac").innerHTML="<br><br><#288#>";
...
childsel.style.color="#FFCC00";
obj.parentNode.appendChild(childsel);
document.getElementById("check_mac").innerHTML="<br><br><#253#>";
document.getElementById("check_mac").style.display = "";
return false;
}else{
...
<div>&nbsp;</div>
<div class="formfonttitle"><#315#> - <#318#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#3233#></div>
<div class="formfontdesc" style="color:#FFCC00;"><#833#></div>
<div class="formfontdesc" style="color:#FFCC00;margin-left:28px;">
<#3234#>&nbsp;<#3235#><br><#2649#>
</div>
<div class="formfontdesc"><#3236#>
<ol>
<li><#3237#></li>
<li><#3238#></li>
<li><#3239#></li>
...
<div id="wl_bw_hint" style="font-size:13px;font-family: Arial, Helvetica, sans-serif;color:#FC0;margin-left:28px;"><#3241#></div>
<div id="wl_ch_hint" style="font-size:13px;font-family: Arial, Helvetica, sans-serif;color:#FC0;margin-left:28px;"><#3242#></div>
...
<td id="repeaterModeHint_desc" colspan="2" style="color:#FFCC00;height:30px;" align="center"><#398#></td>
</tr>
...
<option value="0" <% nvram_match("wl_mode_x", "0","selected"); %>><#3288#></option>
<option value="1" <% nvram_match("wl_mode_x", "1","selected"); %>><#3289#></option>
<option value="2" <% nvram_match("wl_mode_x", "2","selected"); %>><#3290#></option>
</select>
</td>
</tr>
...
<td>
<input type="radio" value="1" name="wl_wdsapply_x" class="input" <% nvram_match("wl_wdsapply_x", "1", "checked"); %>><#176#>
<input type="radio" value="0" name="wl_wdsapply_x" class="input" <% nvram_match("wl_wdsapply_x", "0", "checked"); %>><#175#>
</td>
</tr>
</table>
...
<td colspan="4"><#3258#>&nbsp;(<#2203#>&nbsp;4)</td>
</tr>
</thead>
<tr id="wds_list_add_delete_field">
<th width="80%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#3258#></th>
<th class="edit_table" width="20%"><#2202#></th>
</tr>
...
<img style="float:left;" id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#2613#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
...
<div class="apply_gen">
<input class="button_gen" id="submitBtn" onclick="applyRule()" type="button" value="<#184#>" />
</div>
</td>
</tr>
</tbody>
