...
<title id="web_title"><#756#> - <#399#></title>
...
document.getElementById('content_title').innerHTML = "<#1123#> - <#2783#>";
document.getElementById('desc_title').innerHTML = "<#2418#>";
document.getElementById('web_title').innerHTML = "<#756#> - <#2783#>";
document.getElementById('PC_enable').innerHTML = "<#2416#>";
...
code +='<thead><tr><td colspan="4"><#1392#>&nbsp;(<#2203#>&nbsp;16)</td></tr></thead>';
code += '<tr><th width="15%" height="30px" title="<#2612#>">';
code += '<select id="selAll" class="input_option" onchange="selectAll();">';
code += '<option value=""><#2612#></option>';
code += '<option value="0"><#1345#></option>';
code += '<option value="1"><#1523#></option>';
code += '<option value="2"><#1274#></option>';
code += '</select>';
code += '</th>';
code += '<th width="45%"><#1357#> (<#2488#>)</th>';
code +='<th width="20%"><#2425#></th>';
code +='<th width="20%"><#2202#></th></tr>';
code += '<tr><td style="border-bottom:2px solid #000;">';
code += '<select id="newrule_Enable" class="input_option">';
code += '<option value="0"><#1345#></option>';
code += '<option value="1" selected><#1523#></option>';
code += '<option value="2"><#1274#></option>';
code += '</select>';
code += '</td>';
...
code +='<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;" onclick="pullLANIPList(this);" title="<#2615#>">';
...
code += '<option value="0" ' + ((MULTIFILTER_ENABLE_row[i] == 0) ? "selected" : "") + '><#1345#></option>';
code += '<option value="1" ' + ((MULTIFILTER_ENABLE_row[i] == 1) ? "selected" : "") + '><#1523#></option>';
code += '<option value="2" ' + ((MULTIFILTER_ENABLE_row[i] == 2) ? "selected" : "") + '><#1274#></option>';
code += '</select>';
code += '</td>';
...
$("#mainTable").fadeIn();
document.getElementById("ctrlBtn").innerHTML = '<input class="button_gen" type="button" onClick="applyRule(1);" value="<#184#>">';
showDropdownClientList('setClientIP', 'mac', 'all', 'ClientList_Block_PC', 'pull_arrow', 'all');
showclock();
}
function selectAll(){
...
code +='<tr><th style="width:40%;height:20px;" align="right"><#2426#></th>';
...
var code_temp = "";
code_temp = '<table><tr>';
code_temp += "<td><div style=\"font-family:Arial,sans-serif,Helvetica;font-size:18px;margin:0px 5px 0 10px\"><#1371#></div></td>";
code_temp += '<td><div>';
...
code_temp += '</select>';
code_temp += '</div></td>';
code_temp += '<td><div align="left" style="font-family:Arial,sans-serif,Helvetica;font-size:18px;margin:0px 5px 0 10px"><#2411#></div></td>';
code_temp += '<td><div style="width:90px;height:20px;background:#9CB2BA;"></div></td>';
code_temp += '<td><div align="left" style="font-family:Arial,sans-serif,Helvetica;font-size:18px;margin:0px 5px 0 10px"><#2413#></div></td>';
...
document.getElementById("ctrlBtn").innerHTML = '<input class="button_gen" type="button" onClick="cancel_lantowan('+client+');" value="<#186#>" style="margin:0 10px;">';
document.getElementById("ctrlBtn").innerHTML += '<input class="button_gen" type="button" onClick="saveto_lantowan('+client+');applyRule();" value="<#1433#>" style="margin:0 10px;">';
...
code += "<span class=\"clicked\"><#2783#></span>";
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span style=\"margin-left:10px\" class=\"click\"><#1046#></span>";
code += '</a>';
}
else{
code += '<a href="AiProtection_WebProtector.asp">';
code += "<span class=\"click\"><#2783#></span>";
code += '</a>';
code += "<span style=\"margin-left:10px\" class=\"clicked\"><#1046#></span>";
}
...
<tr>
<td align="left">
<div id="content_title" class="formfonttitle" style="width:400px"><#399#></div>
</td>
<td>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#1046#></td></tr></table>
</div>
</a>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#2783#></td></tr></table>
</div>
</div>
<td>
</tr>
...
<span id="desc_note" style="color:#FC0;"><#833#></span>
<ol style="color:#FC0;margin:-5px 0px 3px -18px;*margin-left:18px;">
<li><#2412#></li>
<li id="nat_desc"><#2414#></li>
</ol>
</td>
</tr>
</table>
...
<div id="svc_hint_div" style="display:none;"><span onClick="location.href='Advanced_System_Content.asp?af=ntp_server0'" style="color:#FFCC00;text-decoration:underline;cursor:pointer;"><#233#></span></div>
