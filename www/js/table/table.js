...
var $addTextHtml = $("<div>").html("" + _tableNameText + " ( <#2203#> " + _createRuleCount + " )").addClass("addRuleText");
...
alert("<#2086#> " + _createRuleCount + " <#2087#>");
return;
}
...
$actionButtonCancelHtml.html("<#186#>");
...
$(this).closest(".editFrame").siblings('.table_clientlist_dropdown').children(".clientList_offline_expand").html("<#2399#>");
...
if(!validDuplicateFlag) {
tableApi.showHintMsg($(this), "<#2080#>");
return false;
}
}
