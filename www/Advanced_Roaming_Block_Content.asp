...
wlHintHtml += '<div class="prod_madelName"><div class="title_name"><div class="div_td img_gap"><div class="login_img"></div></div><div class="div_td"><#757#></div></div></div>';
wlHintHtml += '<div id="login_filed">';
wlHintHtml += "<div class='p1 title_gap'><#204#></div>";
for(var i=0; i<wlObj.length; i++){
...
<div>&nbsp;</div>
<div class="formfonttitle"><#315#> - <#3197#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2559#></div>
...
<th width="30%"><#2560#></th>
<td>
<label><input type="radio" name="enable_roaming" value="1" onclick="enable_roaming_block();" <% nvram_match("rast_static_cli_enable", "1","checked"); %>><#176#></label>
<label><input type="radio" name="enable_roaming" value="0" onclick="enable_roaming_block();" <% nvram_match("rast_static_cli_enable", "0","checked"); %>><#175#></label>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="2"><#3197#>&nbsp;(<#2203#>&nbsp;64)</td>
</tr>
</thead>
<tr>
<th width="80%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#1357#> (<#2488#>)</a></th>
<th width="20%"><#2202#></th>
</tr>
<tr>
<td width="80%">
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;" onclick="pullWLMACList(this);" title="<#2623#>">
