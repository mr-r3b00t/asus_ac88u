...
if(<% check_acorpw(); %> == 1){
danger_count++;
document.getElementById('login_password').innerHTML = "<a href='Advanced_System_Content.asp' target='_blank'><#175#></a>";
...
safe_count++;
document.getElementById('login_password').innerHTML = "<#176#>";
...
safe_count++;
document.getElementById('wireless_encryption').innerHTML = "<#405#>";
document.getElementById('wireless_encryption').className = "status_yes";
}
else{
danger_count++;
document.getElementById('wireless_encryption').innerHTML = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#403#></a>";
...
if(wps_enable == 0){
safe_count++;
document.getElementById('wps_status').innerHTML = "<#176#>";
document.getElementById('wps_status').className = "status_yes";
}
else{
risk_count++;
document.getElementById('wps_status').innerHTML = "<a href='Advanced_WWPS_Content.asp' target='_blank'><#175#></a>";
...
safe_count++;
document.getElementById('upnp_service').innerHTML = "<#176#>";
document.getElementById('upnp_service').className = "status_yes";
}
else{
risk_count++
document.getElementById('upnp_service').innerHTML = "<a href='Advanced_WAN_Content.asp' target='_blank'><#175#></a>";
...
safe_count++;
document.getElementById('access_from_wan').innerHTML = "<#176#>";
document.getElementById('access_from_wan').className = "status_yes";
}
else{
risk_count++;
document.getElementById('access_from_wan').innerHTML = "<a href='Advanced_System_Content.asp' target='_blank'><#175#></a>";
...
safe_count++;
document.getElementById('ping_from_wan').innerHTML = "<#176#>";
document.getElementById('ping_from_wan').className = "status_yes";
}
else{
risk_count++;
document.getElementById('ping_from_wan').innerHTML = "<a href='Advanced_BasicFirewall_Content.asp' target='_blank'><#175#></a>";
...
if(document.form.dmz_ip.value == ""){
safe_count++;
document.getElementById('dmz_service').innerHTML = "<#176#>";
document.getElementById('dmz_service').className = "status_yes";
}
else{
risk_count++;
document.getElementById('dmz_service').innerHTML = "<a href='Advanced_Exposed_Content.asp' target='_blank'><#175#></a>";
...
safe_count++;
document.getElementById('port_tirgger').innerHTML = "<#176#>";
document.getElementById('port_tirgger').className = "status_yes";
}
else{
risk_count++;
document.getElementById('port_tirgger').innerHTML = "<a href='Advanced_PortTrigger_Content.asp' target='_blank'><#175#></a>";
...
safe_count++;
document.getElementById('port_forwarding').innerHTML = "<#176#>";
document.getElementById('port_forwarding').className = "status_yes";
}
else{
risk_count++;
document.getElementById('port_forwarding').innerHTML = "<a href='Advanced_VirtualServer_Content.asp' target='_blank'><#175#></a>";
...
if(ftp_account_mode == 1){
risk_count++;
document.getElementById('ftp_account').innerHTML = "<a href='Advanced_AiDisk_ftp.asp' target='_blank'><#175#></a>";
...
safe_count++;
document.getElementById('ftp_account').innerHTML = "<#176#>";
...
if(samba_account_mode == 1){
risk_count++;
document.getElementById('samba_account').innerHTML = "<a href='Advanced_AiDisk_samba.asp' target='_blank'><#175#></a>";
...
safe_count++;
document.getElementById('samba_account').innerHTML = "<#176#>";
...
safe_count++;
document.getElementById('wrs_service').innerHTML = "<#176#>";
document.getElementById('wrs_service').className = "status_yes";
}
else{
risk_count++;
document.getElementById('wrs_service').innerHTML = "<a href='AiProtection_HomeProtection.asp' target='_blank'><#175#></a>";
...
safe_count++;
document.getElementById('vp_service').innerHTML = "<#176#>";
document.getElementById('vp_service').className = "status_yes";
}
else{
risk_count++;
document.getElementById('vp_service').innerHTML = "<a href='AiProtection_HomeProtection.asp' target='_blank'><#175#></a>";
...
safe_count++;
document.getElementById('cc_service').innerHTML = "<#176#>";
document.getElementById('cc_service').className = "status_yes";
}
else{
risk_count++;
document.getElementById('cc_service').innerHTML = "<a href='AiProtection_HomeProtection.asp' target='_blank'><#175#></a>";
...
<!--[if lte IE 6.5.]><script>alert("<#1195#>");</script><![endif]-->
</div>
<div id="weakness_div" class="weakness">
<table style="width:99%;">
<tr>
<td>
<div class="weakness_router_status"><#1081#></div>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<input class="button_gen" type="button" onclick="close_weakness_status();" value="<#1416#>">
</td>
<td>
<input id="all_security_btn" class="button_gen" type="button" onclick="enable_whole_security();" value="<#1441#>">
</td>
</tr>
</table>
</td>
...
<tr>
<th>
<div style="font-size:16px;"><#1029#></div>
</th>
</tr>
<td>
<div class="formfontdesc" style="font-style: italic;font-size: 14px;"><#1077#></div>
</td>
<tr>
<td>
...
<span style="color: #FFF;"><#1139#></span>
</div>
<div>
<input type="checkbox" id="cc_item">
<span style="color: #FFF;"><#1033#></span>
</div>
</div>
</td>
</tr>
...
<input class="button_gen" type="button" onclick="close_alert_preference();" value="<#1416#>">
<input class="button_gen" type="button" onclick="apply_alert_preference();" value="<#184#>">
</div>
</td>
</tr>
</table>
...
<tr>
<td align="left">
<span class="formfonttitle"><#1123#></span>
</td>
</tr>
</table>
</div>
...
<tr>
<td>
<div style="width:430px"><#1078#></div>
<div style="width:430px">
<a id="faq" style="text-decoration:underline;" href="" target="_blank"><#1123#> FAQ</a>
</div>
</td>
<td>
...
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1081#></div>
<div style="font-style: italic;font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1082#></div>
</td>
<td width="6px">
...
<td style="width:20%;">
<div>
<input class="button_gen" type="button" onclick="showWeaknessTable();" value="<#1439#>">
</div>
</td>
<td>
<div class="line_vertical"></div>
...
<div>
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1120#></div>
<div style="font-style: italic;font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1119#></div>
</div>
</td>
<td width="6px">
<div class="line_vertical"></div>
...
<div style="font-size: 16px;"><#1112#></div>
...
<div>
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1139#></div>
<div style="font-style: italic;font-size: 14px;color:#FC0;height:auto;padding-top:5px;"><#1140#></div>
</div>
</td>
<td width="6px">
<div class="line_vertical"></div>
...
<div style="font-size:18px;text-shadow:1px 1px 0px black;"><#1033#></div>
<div style="font-style: italic;font-size: 14px;color:#FC0;height:auto;;padding-top:5px;"><#1032#></div>
</td>
<td>
<div class="line_vertical"></div>
</td>
...
<input class="button_gen" type="button" onclick="show_alert_preference();" value="<#1029#>">
</div>
</div>
