...
alert(document.form.ipsec_clients_start.value+" <#272#>");
...
html += "<div class='ipsec_connect_status_title'><#2724#></div>";
html += "<div class='ipsec_connect_status_title'><#787#></div>";
html += "<div class='ipsec_connect_status_title'><#3097#> <#2436#></div>";
...
<input class="button_gen" onclick="cancel_viewLog();" type="button" value="<#186#>"/>
<input class="button_gen" onclick="clear_viewLog();" type="button" value="<#1415#>"/>
<input class="button_gen" onclick="save_viewLog();" type="button" value="<#1434#>"/>
<input class="button_gen" onclick="refresh_viewLog();" type="button" value="<#1436#>"/>
</div>
</div>
...
<th><#668#></th>
<td>
<input class="button_gen" onclick="viewLog()" type="button" value="<#1414#>"/>
</td>
</tr>
</table>
...
<th><#3090#></th>
<td>
<input id="ipsec_preshared_key" name="ipsec_preshared_key" type="text" class="input_25_table" maxlength="32" placeholder="<#3082#>" autocomplete="off" autocorrect="off" autocapitalize="off">
</td>
</tr>
...
<span style="color:#FC0"><#1727#></span>
</td>
</tr>
<tr class="tr_advanced">
<th><#246#></th>
...
<label for='ipsec_dead_peer_detection_en' id="ipsec_dead_peer_detection_en_label"><#3276#></label>
...
<label for='ipsec_dead_peer_detection_dis' id="ipsec_dead_peer_detection_dis_label"><#3277#></label>
</td>
</tr>
