...
<div>&nbsp;</div>
<div class="formfonttitle">AiCloud 2.0 - <#2648#></div>
...
<tr>
<th style="white-space:normal;"><#858#></th>
...
<th><#857#></th>
<td style="text-align:left;">
<input type="text" name="webdav_lock_interval" class="input_3_table" maxlength="2" onblur="validator.numberRange(this, 1, 60);" value="<% nvram_get("webdav_lock_interval"); %>" autocorrect="off" autocapitalize="off"> <#2246#>
</td>
</tr>
</table>
</div>
...
<td>
<input id="unlockBtn" style="margin-top:10px;display:none;" class="button_gen" onclick="unlockAcc();" type="button" value="<#838#>"/>
</td>
</tr>
</table>
</div>
...
<td colspan="5" class="cloud_main_radius">
<div style="padding:30px;font-size:18px;word-break:break-all;border-style:dashed;border-radius:10px;border-width:1px;border-color:#999;">
<#872#> <input type="text" name="webdav_https_port" class="input_6_table" maxlength="5" onKeyPress="return validator.isNumber(this,event);" value="<% nvram_get("webdav_https_port"); %>" autocorrect="off" autocapitalize="off">
<br>
<br>
<#870#> <input type="text" name="webdav_http_port" class="input_6_table" maxlength="5" onKeyPress="return validator.isNumber(this,event);" value="<% nvram_get("webdav_http_port"); %>" autocorrect="off" autocapitalize="off">
</div>
</td>
</tr>
</table>
