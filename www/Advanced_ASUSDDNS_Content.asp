...
document.getElementById("DDNSName").value = "<#148#>";
}
else{
...
document.getElementById("ddns_hostname_x").value = "<#148#>";
}
...
show_alert_block("<#2130#> '" + s.charAt(i) +"' !");
return false;
}
}
return true;
...
function cleandef(){
if(document.form.DDNSName.value == "<#148#>")
...
document.getElementById("le_desc").innerHTML = "<#2163#>";
...
case "2":
document.getElementById("cert_desc").style.display = "none";
html_code += '<div style="display:table-cell"><input class="button_gen" onclick="open_upload_window();" type="button" value="<#1443#>"/><img id="loadingicon" style="margin-left:5px;display:none;" src="/images/InternetScan.gif"></div>';
document.getElementById("cert_act").innerHTML = html_code;
document.getElementById("cert_act").style.display = "";
if(orig_le_enable != "0")
document.getElementById("cert_details").style.display = "";
...
document.getElementById("cert_status").innerHTML = "<#3054#>";
else
document.getElementById("cert_status").innerHTML = "<#2945#>";
setTimeout("get_cert_info();", 1000);
}
else{
document.getElementById("cert_status").innerHTML = "<#649#>";
...
<div>&nbsp;</div>
<div class="formfonttitle"><#326#> - <#331#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2145#></div>
<div class="formfontdesc" style="margin-top:-8px;"><#2396#></div>
<div class="formfontdesc" id="wan_ip_hide2" style="color:#FFCC00; display:none;"><#2146#></div>
<div class="formfontdesc" id="wan_ip_hide3" style="color:#FFCC00; display:none;"><#2147#></div>
<div class="formfontdesc" id="lb_note" style="color:#FFCC00; display:none;"><#2189#></div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<input type="hidden" name="wl_gmode_protection_x" value="<% nvram_get("wl_gmode_protection_x"); %>">
<tr>
<th><#2144#></th>
<td>
<input type="radio" value="1" name="ddns_enable_x" onClick="change_cert_method();show_cert_details();return change_common_radio(this, 'LANHostConfig', 'ddns_enable_x', '1')" <% nvram_match("ddns_enable_x", "1", "checked"); %>><#176#>
<input type="radio" value="0" name="ddns_enable_x" onClick="return change_common_radio(this, 'LANHostConfig', 'ddns_enable_x', '0')" <% nvram_match("ddns_enable_x", "0", "checked"); %>><#175#>
</td>
</tr>
<tr>
<th id="ddns_wan_unit_th"><#3147#></th>
<td id="ddns_wan_unit_td">
<select name="ddns_wan_unit" class="input_option">
<option class="content_input_fd" value="-1" <% nvram_match("ddns_wan_unit", "-1","selected"); %>><#149#></option>
<option class="content_input_fd" value="0" <% nvram_match("ddns_wan_unit", "0","selected"); %>><#1619#></option>
<option class="content_input_fd" value="1"<% nvram_match("ddns_wan_unit", "1","selected"); %>><#1625#></option>
</select>
</td>
</tr>
<tr>
...
<a id="link" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#2155#></a>
<a id="linkToHome" href="javascript:openLink('x_DDNSServer')" style=" margin-left:5px; text-decoration: underline;"><#1459#></a>
</td>
</tr>
<tr id="ddns_hostname_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,13);"><#2151#></a></th>
<td>
...
<th><#2162#></th>
<td>
<input type="radio" value="1" name="ddns_wildcard_x" onClick="return change_common_radio(this, 'LANHostConfig', 'ddns_wildcard_x', '1')" <% nvram_match("ddns_wildcard_x", "1", "checked"); %>><#176#>
<input type="radio" value="0" name="ddns_wildcard_x" onClick="return change_common_radio(this, 'LANHostConfig', 'ddns_wildcard_x', '0')" <% nvram_match("ddns_wildcard_x", "0", "checked"); %>><#175#>
</td>
</tr>
<tr id="check_ddns_field" style="display:none;">
<th><#1470#></th>
<td>
<input type="radio" value="1" name="ddns_regular_check" onClick="change_ddns_setting(document.form.ddns_server_x.value);" <% nvram_match("ddns_regular_check", "1", "checked"); %>><#176#>
<input type="radio" value="0" name="ddns_regular_check" onClick="change_ddns_setting(document.form.ddns_server_x.value);" <% nvram_match("ddns_regular_check", "0", "checked"); %>><#175#>
</td>
</tr>
<tr style="display:none;">
<th><#1471#></th>
<td>
<input type="text" lass="input_3_table" name="ddns_regular_period" value="<% nvram_get("ddns_regular_period"); %>" autocorrect="off" autocapitalize="off"> <#2246#>
</td>
</tr>
<tr style="display:none;">
<th><#2158#></th>
...
<input type="submit" maxlength="15" class="button_gen" onclick="showLoading();return onSubmitApply('ddnsclient');" size="12" name="LANHostConfig_x_DDNSStatus_button" value="<#2156#>" /></td>
</tr>
...
<input type="radio" value="1" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "1", "checked"); %>><#1461#>
</span>
<input type="radio" value="2" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "2", "checked"); %>><#1463#>
<span id="self_signed" style="color:#FFF;">
<input type="radio" value="0" name="le_enable" onClick="change_cert_method(this.value);" <% nvram_match("le_enable", "0", "checked"); %>><#761#>
</span>
...
<div style="display:table-cell;"><#652#> :</div>
<div id="cert_status" style="display:table-cell; padding-left:10px;"></div>
</div>
<div style="display:table-row;">
<div style="display:table-cell;"><#3063#> :</div>
<div id="issueTo" style="display:table-cell; padding-left:10px;"></div>
</div>
<div style="display:table-row;">
<div style="display:table-cell;"><#3062#> :</div>
<div id="issueBy" style="display:table-cell; padding-left:10px;"></div>
</div>
<div style="display:table-row;">
<div style="display:table-cell;"><#3061#> :</div>
<div id="expireOn" style="display:table-cell; padding-left:10px;"></div>
</div>
<div>
<input class="button_gen" onclick="save_cert_key();" type="button" value="<#1348#>" />
</div>
</td>
</tr>
</table>
<div class="apply_gen">
<input class="button_gen" onclick="apply_eula_check();" type="button" value="<#184#>" />
</div>
</td>
</tr>
</tbody>
...
<div class="formfonttitle" style="margin-top: 15px; margin-left: 15px;"><#1463#></div>
<div class="formfontdesc" style="margin-left: 15px;"><#1464#></div>
<div class="Upload_item">
<div style="display:table-cell; width: 45%;"><#1465#> :</div>
<div style="display:table-cell;"><input type="file" name="file_key" class="input Upload_file"></div>
</div>
<div class="Upload_item">
<div style="display:table-cell; width: 45%;"><#1467#> :</div>
<div style="display:table-cell;"><input type="file" name="file_cert" class="input Upload_file"></div>
</div>
<div style="color: #FC0; margin-left: 15px; margin-top: 20px">* <#1466#></div>
<div align="center" style="margin-top:30px; padding-bottom:15px;">
<div style="display:table-cell;"><input class="button_gen" type="button" onclick="hide_upload_window();" id="cancelBtn" value="<#186#>"></div>
<div style="display:table-cell; padding-left: 5px;"><input class="button_gen" type="button" onclick="upload_cert_key();" value="<#1433#>"></div>
</div>
</div>
</form>
</body>
