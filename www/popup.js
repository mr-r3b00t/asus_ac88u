...
showtext(document.getElementById("proceeding_main_txt"), "<#302#>...");
...
showtext(document.getElementById("proceeding_main_txt"), "<#305#>");
showtext(document.getElementById("proceeding_txt"), Math.round(y)+"% <#302#>");
--seconds;
setTimeout("LoadingTime("+seconds+", '"+flag+"');", 1000);
}
else{
showtext(document.getElementById("proceeding_main_txt"), translate("<#304#>"));
