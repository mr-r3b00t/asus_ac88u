...
document.getElementById("account_type").innerHTML = "<#1899#>";
document.getElementById("ended_date").innerHTML = "<#1904#>";
...
document.getElementById("account_type").innerHTML = "<#1900#>";
else if(wtfast_status.Account_Type == "Advanced")
document.getElementById("account_type").innerHTML = "<#1901#>";
...
code +='<tr><td style="color:#EAE9E9;"><#2027#></td></tr>';
else{
rule_enable_array = [];
Object.keys(wtfast_rulelist_array).forEach(function(key) {
code +='<tr id="row'+key+'">';
...
document.getElementById("error_msg").style.display = "";
document.getElementById("error_msg").innerHTML = "* " + "<#221#>";
$("#wtf_passwd").focus();
}
}
function wtf_logout(){
...
<p style="color:#EBE8E8; font-size:13px;font-weight:bolder;"><#1865#> :</p>
<ul type="disc">
<li style="line-height:15px; margin-left:-25px; margin-top:-10px; color:#949393;"><#1866#></li>
<li style="line-height:15px; margin-left:-25px; color:#949393;"><#1867#></li>
<li id="benefit3" style="line-height:15px; margin-left:-25px; color:#949393;"><#1868#><br>(<#1869#>)</li>
<li style="line-height:15px; margin-left:-25px; color:#949393;"><#1870#></li>
<li style="line-height:15px; margin-left:-25px; color:#949393;"><#1871#></li>
</ul>
</div>
</td>
</tr>
...
<tr>
<th style="width:200px; height:35px; color:#949393; font-size:14px; text-align:right; padding-right:15px;"><#1149#></th>
...
<span ><a href="javascript:open_link('newAccount')" style="margin-left:5px;text-decoration:underline;color:#949393;"><#1406#></a></span>
</td>
</tr>
<tr>
<th style="height:35px; color:#949393; font-size:14px; text-align:right; padding-right:15px;"><#411#></th>
<td style="color:#949393; font-size:14px; text-align:left;">
...
<input id="login_button" class="wtfast_button" style="background-color:#A80000; opacity:0.9;" onclick="wtf_login();" type="button" value="<#1431#>"/>
<img id="loadingIcon_login" style="display:none;" src="images/InternetScan.gif">
</td>
</tr>
</table>
<div style="color:#ffffff; font-size:12px; text-align:center;"><#2224#> <#1905#></div>
<div>
...
</div><div id="ManagementPage" style="display:none;">
...
<div style="color:#EBE8E8; font-size:26px; font-weight:bold; font-family:calibri; float:left; margin-top:12px; margin-left:6px;"><#1880#></div>
</td>
<td align="right">
...
<thead>
<tr>
<td colspan="2" align="left" style="color:#FFFFFF; font-size:18px; font-family:calibri;"><#1874#></td>
</tr>
<tr>
...
<th id="ended_date_th" align="left"><#1902#></th>
</tr>
<tr style="vertical-align:top; color:#EAE9E9; font-family:calibri; font-size:15px;">
<td>
...
<td id="ended_date_td">
<span id="ended_date"></span><span id="days_title" style="margin-left:10px;">(Days Left: <span id="days_left"></span>)</span> <div id="trail_desc" style="color:#FFCC00; margin-top: 10px;"><#1903#></div>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="5" align="left" style="color:#FFFFFF; font-size:18px; font-family:calibri;"><#1910#></td>
</tr>
</thead>
<tr style="vertical-align:bottom; color:#949393; font-family:calibri; font-size:16px;">
<th width="15%"><#3276#>/<#3277#></th>
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);" style="vertical-align:bottom; color:#949393; font-family:calibri; font-size:16px;"><#2424#></th>
<th width="26%"><#1070#></th>
<th width="14%"><#2154#></th>
<th width="15%"><#2202#></th>
</tr>
...
<img id="pull_arrow" src="images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANList(this);" title="<#2618#>">
...
<ul>
<li style="color: #FFCC00;"><div class="comment_div"><#1905#></div></li>
<li style="color: #FFCC00;"><div class="comment_div"><#1906#></div></li>
<li style="color: #FFCC00;"><div class="comment_div"><#1907#></div></li>
<li style="color: #FFCC00;"><div class="comment_div"><#1908#></div></li>
<li style="color: #FFCC00;"><div class="comment_div"><#1909#></div></li>
</ul>
<div id="applyBtn" align="center" style="margin-top:20px; display:none;">
<input class="wtfast_button" onclick="applyRule()" type="button" value="<#184#>"/>
</div>
</td>
</tr>
</tbody>
