...
cal_panel_block("invitation", 0.25);
if(!isInvite){
document.getElementById("invitationInfo").innerHTML = "<br/> <#856#>";
...
htmlCode += "<tr height='40px'><td width='30%'><#1996#></td><td style='font-weight:bolder;'>" + decode_array[0] + "</td></tr>";
htmlCode += "<tr height='40px'><td width='30%'><#1377#></td><td style='font-weight:bolder;'>" + parseRule(decode_array[2]) + "</td></tr>";
htmlCode += "<tr height='40px'><td width='30%'>Destination</td><td style='font-weight:bolder;'>" + decode_array[1] + "</td></tr>";
htmlCode += "<tr height='40px'><td width='30%'><#2776#></td><td>";
htmlCode += "<input type='text' id='PATH_rs' class='input_20_table' style='margin-left:0px;height:23px;' name='cloud_dir' value='' onclick=''/>";
htmlCode += "<input name='button' type='button' class='button_gen' style='margin-left:5px;' onclick='get_disk_tree(1);document.getElementById(\"folderTree_panel\").style.marginLeft+=30;' value='<#1374#>'/>";
htmlCode += "</td></tr>";
if(decode_array[3] != ""){
...
htmlCode += "<span style='color:#FC0;display:none;margin-left:5px;' id='codeHint'><#2084#></span></td></tr>";
}
htmlCode += "</table>";
...
code +='<tr height="55px"><td style="color:#FFCC00;" colspan="6"><#2389#></td>';
else if(document.getElementById("usb_status").className == "usbstatusoff")
code +='<tr height="55px"><td style="color:#FFCC00;" colspan="6"><#2386#></td>';
else if(cloud_synclist_array == "")
code +='<tr height="55px"><td style="color:#FFCC00;" colspan="6"><#2027#></td>';
else{
...
<tr>
<td>
<div class="machineName" style="font-family:Microsoft JhengHei;font-size:12pt;font-weight:bolder; margin-top:20px;margin-left:30px;"><#1375#></div>
</td>
</tr>
</table>
...
<input class="button_gen" type="button" style="margin-left:27%;margin-top:18px;" onclick="cancel_invitation();" value="<#186#>">
<input class="button_gen" type="button" onclick="confirm_invitation();" value="<#1433#>">
</div>
</div>
</div>
...
<table><tr><td>
<div class="machineName" style="width:200px;font-family:Microsoft JhengHei;font-size:12pt;font-weight:bolder; margin-top:15px;margin-left:30px;"><#757#></div>
</td>
<td>
<div style="width:240px;margin-top:14px;margin-left:135px;">
<table >
<tr>
<td><div id="createFolderBtn" class="createFolderBtn" title="<#825#>"></div></td>
<td><div id="deleteFolderBtn" class="deleteFolderBtn" title="<#1477#>"></div></td>
<td><div id="modifyFolderBtn" class="modifyFolderBtn" title="<#2326#>"></div></td>
</tr>
</table>
</div>
</td></tr></table>
...
<div style="background-image:url(images/Tree/bg_02.png);background-repeat:no-repeat;height:90px;">
<input class="button_gen" type="button" style="margin-left:27%;margin-top:18px;" onclick="cancel_folderTree();" value="<#186#>">
<input class="button_gen" type="button" id="btn_confirm_folder0" onclick="confirm_folderTree0();" value="<#1433#>" style="display:none;">
<input class="button_gen" type="button" id="btn_confirm_folder" onclick="confirm_folderTree();" value="<#1433#>" style="display:none;">
</div>
</div>
...
<thead>
<tr>
<td colspan="6" id="cloud_synclist"><#845#></td>
</tr>
</thead>
<tr>
<th width="30%" style="height:40px;font-family: Calibri;font-weight: bolder;"><#2522#></th>
<td>
...
<dl>
<dt>
<div id="select_service" style="height:35px;margin:-4px 0px 0px 0px;padding:4px;" value=""><#823#></div>
</dt>
...
<input name="button" type="button" class="button_gen" onclick="get_disk_tree(0);" value="<#1374#>"/>
<div id="noUSB0" style="color:#FC0;display:none;margin-left: 3px;"><#2386#></div>
</td>
</tr>
<tr style="display:none;">
<th width="30%" style="font-family: Calibri;font-weight: bolder;">
...
<input name="button" type="button" class="button_gen" onclick="get_disk_tree(1);" value="<#1374#>"/>
<div id="noUSB" style="color:#FC0;display:none;margin-left: 3px;"><#2386#></div>
</td>
</tr>
<tr>
<th width="30%" style="font-family: Calibri;font-weight: bolder;">
...
<option value="0"><#1379#></option>
<option value="1"><#1378#></option>
<option value="2"><#1380#></option>
</select>
</td>
</tr>
</table>
<div class="apply_gen pop_div_bg" style="margin-top:20px;margin-bottom:10px;display:none;" id="applyDiv">
<input name="button" type="button" class="button_gen" onclick="showAddTable();" value="<#186#>"/>
<input id="applyBtn" name="button" type="button" class="button_gen" onclick="applyRule()" value="<#184#>"/>
<input id="authBtn" name="button" type="button" class="button_gen" value="Authenticate"/>
<span id="authHint" style="color:#FC0;display:none"><#1256#></span>
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle">AiCloud 2.0 - <#2695#></div>
...
<#2697#> <a href="https://www.asus.com/support/FAQ/1010006/" style="text-decoration:underline;font-weight:bolder;">FAQ</a>
</div>
</td>
</tr>
</table>
...
<tr>
<th width="10%"><#2522#></th>
<th width="25%"><#2990#></a></th>
<th width="10%"><#1377#></a></th>
<th width="30%"><#1833#></th>
<th width="15%"><#418#></th>
<th width="10%"><#1417#></th>
</tr>
...
<tbody>
<tr height="55px">
<td style="color:#FFCC00;" colspan="6"><#605#>...</td> </tr>
</tbody>
</table>
</div>
...
<input name="applybutton" id="applybutton" type="button" class="button_gen" onclick="showAddTable(9);" value="<#823#>" style="word-wrap:break-word;word-break:normal;">
