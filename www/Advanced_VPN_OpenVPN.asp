...
document.getElementById("privateIP_notes").innerHTML = "<#3080#>";
...
document.getElementById(username_status).innerHTML = '<#203#>';
}
...
document.getElementById(username_status).innerHTML = '<a class="hintstyle2" href="javascript:void(0);" onClick="showOpenVPNClients(\''+openvpnd_connected_clients[y].username+'\');"><#178#></a>';
break;
}
}
...
alert("<#3019#> " + origin_lan_ip);
vpnSubnet.focus();
vpnSubnet.select();
return false;
}
if(lan_ip_subnet == openvpn_server_subnet) {
alert("<#3017#>"+pool_start+" ~ "+pool_end);
vpnSubnet.focus();
vpnSubnet.select();
return false;
}
...
alert(document.form.vpn_server_r1.value + " <#272#>");
document.form.vpn_server_r1.focus();
document.form.vpn_server_r1.select();
return false;
}
...
alert(document.form.vpn_server_r2.value + " <#272#>");
document.form.vpn_server_r2.focus();
document.form.vpn_server_r2.select();
return false;
}
...
document.getElementById('openvpn_error_message').innerHTML = "<span><#3045#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if(vpnd_state != '2' && (vpn_server1_errno == '4' || vpn_server1_errno == '7')){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3046#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if(vpnd_state != '2' && vpn_server1_errno == '5'){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3047#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
else if(vpnd_state == '-1' && vpn_server1_errno == '0'){
document.getElementById('openvpn_initial').style.display = "none";
document.getElementById('openvpn_error_message').innerHTML = "<span><#3048#></span>";
document.getElementById('openvpn_error_message').style.display = "";
}
...
code +='<tr><td style="color:#FFCC00;" colspan="6"><#2027#></td>';
else{
...
document.getElementById("allowed_client_name").innerHTML = (flag==1)?"<#2990#>":"Common Name(CN)";
}
...
<tr>
<div class="description_down"><#3066#></div>
</tr>
<tr>
<div style="margin-left:30px; margin-top:10px;">
<p><#3057#> <span style="color:#FFCC00;">----- BEGIN xxx ----- </span>/<span style="color:#FFCC00;"> ----- END xxx -----</span> <#3058#>
<p><#3059#>
</div>
...
<input class="button_gen" type="button" onclick="cancel_Key_panel('tls');" value="<#186#>">
<input class="button_gen" type="button" onclick="save_keys('tls');" value="<#1434#>">
</div>
</td>
</tr>
</form>
...
<div style="margin-top:5px;width:100%;text-align:center;">
<input class="button_gen" type="button" onclick="cancel_Key_panel('secret');" value="<#186#>">
<input class="button_gen" type="button" onclick="save_keys('secret');" value="<#1434#>">
</div>
</td>
</tr>
</tbody>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#164#> - OpenVPN</div>
...
<option value="1" selected><#316#></option>
<option value="2"><#314#></option>
</select>
</td>
</tr>
<tr id="trServerPortBasic">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,6);"><#3218#></a></th>
<td>
...
<div id="portSuggestionBasic" style="color: #FFCC00;"><#2708#></div>
</td>
</tr>
...
<label for="vpn_server_client_access_local"><#3009#></label>
...
<label for="vpn_server_client_access_both"><#3010#></label>
...
<label for="vpn_server_client_access_custom" class="client_access_custom"><#1448#></label>
</td>
</tr>
...
<td>
<div id="export_div">
<input id="exportToLocal" class="button_gen" type="button" value="<#1348#>" />
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,27);"><#3025#></a></th>
<td>
<input id="exportCertToLocal" class="button_gen" type="button" value="<#1348#>" onClick="exportCert();"/>
</td>
</tr>
<tr id="openvpn_import_cert" style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,28);"><#3026#></a></th>
<td>
<input class="button_gen" type="button" value="<#1443#>" onClick="selectImportFile();"/>
</td>
</tr>
</table>
<div id="OpenVPN_setting" style="display:none;margin-top:8px;">
<div class="formfontdesc">
<#3039#>&nbsp;<#3041#>&nbsp;<#3042#>&nbsp;<#3040#><br>
<ol>
...
<td>
<input type="radio" name="vpn_server_x_eas" class="input" value="1"><#176#>
<input type="radio" name="vpn_server_x_eas" class="input" value="0"><#175#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,4);"><#3053#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,5);"><#2020#></a></th>
<td>
...
<div id="portSuggestionAdvanced" style="color: #FFCC00;"><#2708#></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,15);"><#3073#></a></th>
<td>
<input type="radio" name="vpn_server_x_dns" class="input" value="1" onclick="update_visibility();"><#176#>
<input type="radio" name="vpn_server_x_dns" class="input" value="0" onclick="update_visibility();"><#175#>
</td>
</tr>
<tr id="server_pdns">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,16);"><#3029#></a></th>
<td>
<input type="radio" name="vpn_server_pdns" class="input" value="1" <% nvram_match_x("", "vpn_server_pdns", "1", "checked"); %>><#176#>
<input type="radio" name="vpn_server_pdns" class="input" value="0" <% nvram_match_x("", "vpn_server_pdns", "0", "checked"); %>><#175#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,17);"><#3044#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,26);">HMAC Authentication</a></th>
<td>
<select name="vpn_server_digest" class="input_option" onChange="update_digest();"></select>
<span id="digest_hint" style="color:#FC0">(Not recommended)</span>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,18);"><#3036#></a></th>
<td>
<select name="vpn_server_comp" class="input_option">
<option value="-1" <% nvram_match("vpn_server_comp","-1","selected"); %> ><#3277#></option>
<option value="no" <% nvram_match("vpn_server_comp","no","selected"); %> ><#761#></option>
<option value="yes" <% nvram_match("vpn_server_comp","yes","selected"); %> ><#3276#></option>
<option value="adaptive" <% nvram_match("vpn_server_comp","adaptive","selected"); %> ><#793#></option>
...
<option value="auto" <% nvram_match("vpn_server_firewall","auto","selected"); %> ><#149#></option>
<option value="external" <% nvram_match("vpn_server_firewall","external","selected"); %> ><#1653#></option>
<option value="custom" <% nvram_match("vpn_server_firewall","custom","selected"); %> ><#1448#></option>
</select>
</td>
</tr-->
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,9);"><#3031#></a></th>
<td>
<input type="radio" name="vpn_server_igncrt" class="input" value="1" onchange="enable_server_igncrt(this.value);" <% nvram_match_x("", "vpn_server_igncrt", "1", "checked"); %>><#176#>
<input type="radio" name="vpn_server_igncrt" class="input" value="0" onchange="enable_server_igncrt(this.value);" <% nvram_match_x("", "vpn_server_igncrt", "0", "checked"); %>><#175#>
<span id="Hint_fixed_tls_crypto" style="display:none;">Authorization Mode fixes on TLS</span></td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,7);"><#3030#></a></th>
<td>
...
<span id="server_tls_crypto_text" onclick="set_Keys('tls');" style="text-decoration:underline;cursor:pointer;"><#3069#></span>
<span id="server_static_crypto_text" onclick="set_Keys('secret');" style="text-decoration:underline;cursor:pointer;"><#3069#></span>
<!-- rm 2017/06/28 span id="server_custom_crypto_text"><#3068#></span-->
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,8);"><#2600#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,10);"><#3032#></a></th>
<td>
<select name="vpn_server_hmac" class="input_option">
<option value="-1" <% nvram_match("vpn_server_hmac","-1","selected"); %> ><#3277#></option>
...
<tr id="server_snnm">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,11);"><#3075#></a></th>
<td>
...
<tr id="server_dhcp">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,13);"><#3043#></a></th>
<td>
<input type="radio" name="vpn_server_dhcp" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_dhcp", "1", "checked"); %>><#176#>
<input type="radio" name="vpn_server_dhcp" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_dhcp", "0", "checked"); %>><#175#>
</td>
</tr>
<tr id="server_range">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,14);"><#3034#></a></th>
<td>
...
<tr id="server_local">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,12);"><#3067#></a></th>
<td>
...
<th><#3070#></th>
<td>
<input type="text" maxlength="4" class="input_6_table" name="vpn_server_poll" onKeyPress="return validator.isNumber(this,event);" value="<% nvram_get("vpn_server_poll"); %>" autocorrect="off" autocapitalize="off"> <#2246#>
<span style="color:#FC0">(<#3428#>)</span>
</td>
</tr-->
<tr id="server_plan">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,2);"><#3071#></a></th>
<td>
<input type="radio" name="vpn_server_plan" class="input" value="1" <% nvram_match_x("", "vpn_server_plan", "1", "checked"); %>><#176#>
<input type="radio" name="vpn_server_plan" class="input" value="0" <% nvram_match_x("", "vpn_server_plan", "0", "checked"); %>><#175#>
</td>
</tr>
<tr id="server_rgw">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,3);"><#3072#></a></th>
<td>
<input type="radio" name="vpn_server_rgw" class="input" value="1" <% nvram_match_x("", "vpn_server_rgw", "1", "checked"); %>><#176#>
<input type="radio" name="vpn_server_rgw" class="input" value="0" <% nvram_match_x("", "vpn_server_rgw", "0", "checked"); %>><#175#>
</td>
</tr>
<tr id="server_reneg">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,19);"><#3076#></a></th>
<td>
<input type="text" maxlength="5" class="input_6_table" name="vpn_server_reneg" value="<% nvram_get("vpn_server_reneg"); %>" autocorrect="off" autocapitalize="off"> <#2610#>
<span style="color:#FC0">(<#2638#> : -1)</span>
</td>
</tr>
<tr id="server_ccd">
<th><#3074#></th>
<td>
<input type="radio" name="vpn_server_ccd" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd", "1", "checked"); %>><#176#>
<input type="radio" name="vpn_server_ccd" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd", "0", "checked"); %>><#175#>
</td>
</tr>
<tr id="server_c2c">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,20);"><#3033#></a></th>
<td>
<input type="radio" name="vpn_server_c2c" class="input" value="1" <% nvram_match_x("", "vpn_server_c2c", "1", "checked"); %>><#176#>
<input type="radio" name="vpn_server_c2c" class="input" value="0" <% nvram_match_x("", "vpn_server_c2c", "0", "checked"); %>><#175#>
</td>
</tr>
<tr id="server_ccd_excl">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(32,21);"><#3035#></a></th>
<td>
<input type="radio" name="vpn_server_ccd_excl" class="input" value="1" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd_excl", "1", "checked"); %>><#176#>
<input type="radio" name="vpn_server_ccd_excl" class="input" value="0" onclick="update_visibility();" <% nvram_match_x("", "vpn_server_ccd_excl", "0", "checked"); %>><#175#>
</td>
</tr>
</table>
...
<th width="20%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,23);"><#2738#></a></th>
<th width="20%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,24);">Mask</a></th>
<th width="12%"><a id="allowed_client_name" class="hintstyle" href="javascript:void(0);" onClick="openHint(32,25);"><#2525#></a></th>
<th width="12%"><#2202#></th>
</tr>
<tr>
...
<input id="mailSendPannelCancel" class="button_gen" type="button" value="<#186#>">
...
<div class="panelSubmiter">
<input id="mailConfigPannelCancel" class="button_gen" type="button" value="<#186#>">
<input id="mailConfigPannelSubmiter" class="button_gen" type="button" value="<#1434#>">
