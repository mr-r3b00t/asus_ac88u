...
notification.desc[12] = "<#2265#>";
notification.action_desc[12] = "<#1251#>";
...
notification.acpw = 1;
notification.desc[0] = '<#1244#>';
notification.action_desc[0] = '<#1251#>';
...
notification.desc[1] = '<#1245#>';
notification.action_desc[1] = '<#1252#>';
...
notification.action_desc[1] = '<a id="link_to_downlodpage" target="_blank" href="'+get_helplink()+'" style="color:#FFCC00;"><#1252#></a>';
...
notification.desc[2] = '<#1246#>';
notification.action_desc[2] = '<#1251#> (2.4GHz)';
...
notification.desc[3] = '<#1246#>';
notification.action_desc[3] = '<#1251#> (5 GHz)';
...
notification.ftp = 1;
notification.desc[4] = '<#1248#>';
notification.action_desc[4] = '<#737#>';
...
notification.array[4] = 'noti_ftp';
notification.ftp = 1;
notification.desc[4] = '<#1247#>';
notification.action_desc[4] = '<#1251#>';
notification.clickCallBack[4] = "showLoading();setTimeout('document.noti_ftp.submit();', 1);setTimeout('notification.redirectftp()', 2000);";
}else
notification.ftp = 0;
...
notification.desc[5] = '<#1250#>';
notification.action_desc[5] = '<#737#>';
...
notification.array[5] = 'noti_samba';
notification.samba = 1;
notification.desc[5] = '<#1249#>';
notification.action_desc[5] = '<#1251#>';
notification.clickCallBack[5] = "showLoading();setTimeout('document.noti_samba.submit();', 1);setTimeout('notification.redirectsamba()', 2000);";
}else
...
notification.action_desc[18] = '<#186#>';
...
notification.action_desc[8] = "<#1433#>";
...
notification.desc[16] = '<#236#><#237#><#238#><#239#>';
...
notification.desc[15] = '<#3429#>';
notification.action_desc[15] = '<#3430#>';
