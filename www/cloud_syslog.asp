...
<div>&nbsp;</div>
<div class="formfonttitle">AiCloud 2.0 - <#2206#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" style="font-style: italic;font-size: 14px;"><#859#></div>
...
<input type="button" onClick="location.href=location.href" value="<#1436#>" class="button_gen">
</form>
</td>
</tr>
</table>
