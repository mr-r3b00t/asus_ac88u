...
var title5_2 = 0;
if(itemNum == 50){
statusmenu ="<span><#528#></span>";
}
if(itemNum == 85){
statusmenu ="<span><#802#></span>";
}
else if(itemNum == 86){
statusmenu ="<span>For optimize online gaming process bandwidth including Diablo, WOW, Steam games and XBOX, ect.<br><#794#></span>"; /* untranslated */
}
else if(itemNum == 87){
statusmenu ="<span>For faster video streaming experience including Youtube, Netflix and Spotify, ect.<br><#795#></span>"; /* untranslated */
}
else if(itemNum == 88){
statusmenu ="<span><#818#><br><#797#></span>";
}
else if(itemNum == 89){
...
statusmenu ="<span><#794#></span>";
}
else if(itemNum == 92){
statusmenu ="<span><#795#></span>";
}
else if(itemNum == 93){
statusmenu ="<span><#796#></span>";
}
else if(itemNum == 94){
statusmenu ="<span><#797#></span>";
}
else if(itemNum == 95){
statusmenu ="<span><#798#></span>";
}
else if(itemNum == 96){
statusmenu ="<span><#799#></span>";
}
else if(itemNum == 97){
statusmenu ="<span><#800#></span>";
}
else if(itemNum == 103){
statusmenu ="<span><#821#></span>";
}
else if(itemNum == 104){
statusmenu ="<span><#820#></span>";
}
if(itemNum == 98){
var signal = parseInt(sim_signal);
if(isNaN(signal) || signal <= 0){
statusmenu += "<div class='StatusHint'><#2273#></div>";
}
else if(usb_state == 2 && usb_sbstate == 0 && usb_auxstate != 1){
statusmenu += "<div class='StatusHint'><#178#> <#1957#>: </div><span>" + modem_act_provider + "</span>";
}
else{
statusmenu += "<div class='StatusHint'><#203#></div>";
}
}
if(itemNum == 99){
if(sim_state == "1")
statusmenu += "<div class='StatusHint'><#2299#></div>";
else if(sim_state == "2"){
if( g3err_pin == "1" && pin_remaining_count < 3)
statusmenu += "<div class='StatusHint'>Wrong PIN code. Please input the correct PIN code.</div>";
else
statusmenu += "<div class='StatusHint'><#2266#></div>";
}
else if(sim_state == "3")
statusmenu += "<div class='StatusHint'><#2268#></div>";
else if(sim_state == "4")
statusmenu += "<div class='StatusHint'><#2267#></div>";
else if(sim_state == "5")
statusmenu += "<div class='StatusHint'><#2269#></div>";
else if(sim_state == "6")
statusmenu += "<div class='StatusHint'><#2318#></div>";
else if(sim_state == "-1")
statusmenu += "<div class='StatusHint'><#2298#></div>";
else if(sim_state == "-10" || sim_state == "-2")
statusmenu += "<div><#2296#></div>";
else
statusmenu += "<div><#2256#></div>";
}
if(itemNum == 24)
...
if(itemNum == 25)
statusmenu += "<span><#1110#></span>";
else if(itemNum == 23)
statusmenu += "<span><#1109#></span>";
else if(itemNum == 22)
statusmenu += "<span><#1108#></span>";
else if(itemNum == 21)
statusmenu += "<span><#1107#></span>";
else if(itemNum == 20)
statusmenu += "<span><#1106#></span>";
else if(itemNum == 19)
statusmenu += "<span><#1105#></span>";
else if(itemNum == 18)
statusmenu += "<span><#1104#></span>";
else if(itemNum == 17)
statusmenu += "<span><#1103#></span>";
else if(itemNum == 16)
statusmenu += "<span><#1102#></span>";
else if(itemNum == 15)
statusmenu += "<span><#1101#></span>";
else if(itemNum == 14)
statusmenu += "<span><#1100#></span>";
else if(itemNum == 13)
statusmenu += "<span><#1099#></span>";
else if(itemNum == 12)
statusmenu += "<span><#1098#></span>";
else if(itemNum == 11)
statusmenu += "<span><#1097#></span>";
else if(itemNum == 10)
statusmenu += "<span><#1096#></span>";
if(itemNum == 26)
statusmenu += "<span><#2543#></span>";
if(itemNum == "A"){
statusmenu = "<div class='StatusHint'><#811#> :</div>";
if(bwdpi_app_rulelist.indexOf('game') != -1){
modeDesc = "<#1070#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('media') != -1){
modeDesc = "<#1071#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('web') != -1){
modeDesc = "<#817#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('eLearning') != -1){
modeDesc = "<#819#>"; /* untranslated */
}
else if(bwdpi_app_rulelist.indexOf('videoConference') != -1){
modeDesc = "<#808#>"; /* untranslated */
}
else{
modeDesc = "<#1449#>"; /* untranslated */
}
...
statusmenu += "<span>" + lineDesc + "</span>";
statusmenu += "<div class='StatusHint'><#2330#> :</div>";
lineDesc = ""; /* Untranslated */
...
wifiDesc = "<b>2.4GHz -</b> <#1346#>";
else
wifiDesc = "<b>2.4GHz -</b> <#1347#>";
if(wlan1_radio_flag == "0")
wifiDesc += "<br><br><b>5GHz-1 -</b> <#1346#>";
else
wifiDesc += "<br><br><b>5GHz-1 -</b> <#1347#>";
if(wlan2_radio_flag == "0")
wifiDesc += "<br><br><b>5GHz-2 -</b> <#1346#>";
else
wifiDesc += "<br><br><b>5GHz-2 -</b> <#1347#>";
statusmenu += "<span>" + wifiDesc + "</span>";
}
else if(wl_info.band5g_support){
if(wlan0_radio_flag == "0" && wlan1_radio_flag == "0")
wifiDesc = "<b>2.4GHz -</b><br><#1346#><br><br><b>5 GHz -</b><br><#1346#>";
else if(wlan0_radio_flag == "1" && wlan1_radio_flag == "0")
wifiDesc = "<b>2.4GHz -</b><br><#1347#><br><br><b>5 GHz -</b><br><#1346#>";
else if(wlan0_radio_flag == "0" && wlan1_radio_flag == "1")
wifiDesc = "<b>2.4GHz -</b><br><#1346#><br><br><b>5 GHz -</b><br><#1347#>";
else
wifiDesc = "<b>2.4GHz -</b><br><#1347#><br><br><b>5 GHz -</b><br><#1347#>";
statusmenu += "<span>" + wifiDesc + "</span>";
}
else{
if(wlan0_radio_flag == "0")
...
statusmenu += "<div><#1423#></div>";
if(monoClient != "monoClient=")
statusmenu += "<div><#2514#>" + monoClient.substring(11, monoClient.length) + "</div>";
}
else
statusmenu += "<div><#1420#></div>";
}
if(statusmenu != "")
...
if(itemNum == 5){
statusmenu = "<span class='StatusHint'><#2385#></span>";
}
if(itemNum == 4){
...
statusmenu += '<#2330#>: ';
if(expire_day > 0)
statusmenu += '<b id="expire_day_'+i+'">'+ expire_day + '</b> <#1458#> <b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#1943#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2246#>';
else if(expire_hr > 0)
statusmenu += '<b id="expire_hr_'+i+'">'+ expire_hr + '</b> <#1943#> <b id="expire_min_'+i+'">' + expire_min +'</b> <#2246#>';
else{
if(expire_min > 0)
statusmenu += '<b id="expire_min_'+i+'">' + expire_min +'</b> <#2246#>';
else
statusmenu += '<b id="expire_min_'+i+'">< 1</b> <#2246#>';
}
statusmenu += ")</span><br>";
}
}
...
statusmenu += "<div class='StatusHint'><#234#>:</div><span><#1420#></span>";
}
if(itemNum == 3){
var eLAN_str = "<#1650#>".replace(/WAN/, "LAN");
if(gobi_support){
if(dualWAN_support && wans_dualwan_array.indexOf("none") == -1){
if( wans_dualwan_array[0] == "wan")
statusmenu += "<div class='StatusHint'><#1650#>:</div>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<div class='StatusHint'>"+eLAN_str+" (<#2467#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<div class='StatusHint'><#2308#>:</div>";
}
else
statusmenu = "<div class='StatusHint'><#2725#>:</div>";
}
else{
if(dualWAN_support && wans_dualwan_array.indexOf("none") == -1)
statusmenu = "<div class='StatusHint'><#1619#>:</div>";
else
statusmenu = "<div class='StatusHint'><#2725#>:</div>";
if( wans_dualwan_array[0] == "wan")
statusmenu += "<b><#1650#> -</b><br>";
else if( wans_dualwan_array[0] == "lan")
statusmenu += "<b><#2467#> "+wans_lanport+" -</b><br>";
else if( wans_dualwan_array[0] == "usb")
statusmenu += "<b><#336#> -</b><br>";
}
if(dualWAN_support && wans_dualwan_array.indexOf("none") == -1 ){
if(first_link_status == "1")
statusmenu += "<span><#725#></span>";
...
statusmenu += "<span><#651#></span>";
else
statusmenu += "<span><#178#></span>";
}
else{
if(sw_mode == 1){
...
if(wan0_enable == "0"){
if(gobi_support)
statusmenu += "<div><#2254#></div>";
else
statusmenu += "<div><#2962#></div>";
}
else{
if(sim_state != ""){
if(sim_state == "2"){
...
statusmenu += "<div><#2266#></div>";
}
else if(sim_state == "3")
statusmenu += "<div><#2268#></div>";
else if(sim_state == "4")
statusmenu += "<div><#2267#></div>";
else if(sim_state == "5")
statusmenu += "<div><#2269#></div>";
else if(sim_state == "6")
statusmenu += "<div><#2318#></div>";
else if(sim_state == "-1")
statusmenu += "<div><#2298#></div>";
else if(sim_state == "-10" || sim_state == "-2")
statusmenu += "<div><#2296#></div>";
else
statusmenu += "<div><#2256#></div>";
...
statusmenu += "<span><#203#></span>";
}
}
else{
if(wan0_enable == 0){
statusmenu += "<span><#3144#></span>";
}
else{
if(first_link_auxstatus == "1"){
if( wans_dualwan_array[0] == "lan"){
statusmenu += "<span><#1355#> : <#2467#> "+wans_lanport+"</span>";
}
else
statusmenu += "<span><#2534#></span>";
}
else if(first_link_sbstatus == "1")
statusmenu += "<span><#727#></span>";
else if(first_link_sbstatus == "2")
statusmenu += "<span><#619#></span>";
else if(first_link_sbstatus == "3")
statusmenu += "<span><#618#></span>";
else if(first_link_sbstatus == "4")
statusmenu += "<span><#730#></span>";
else if(first_link_sbstatus == "5")
statusmenu += "<span><#729#></span>";
else if(first_link_sbstatus == "6")
statusmenu += "<span>System error. <#2540#></span>";
else
statusmenu += "<span><#203#></span>";
}
}
...
statusmenu += "<span><#105#></span><br><br>";
if(wlc_band == 0)
...
statusmenu += "<span><#95#></span>";
else
statusmenu += "<span><#94#></span>";
}
}
}
}
...
statusmenu += "<div class='StatusHint'><br><#1650#>:</div>";
else if( wans_dualwan_array[1] == "lan")
statusmenu += "<div class='StatusHint'><br>"+eLAN_str+" (<#2467#> "+wans_lanport+"):</div>";
else if( wans_dualwan_array[1] == "usb")
statusmenu += "<div class='StatusHint'><br><#2308#>:</div>";
}
else{
statusmenu += "<div class='StatusHint'><br><#1625#>:</div>";
if( wans_dualwan_array[1] == "wan")
statusmenu += "<b><#1650#> -</b><br>";
else if( wans_dualwan_array[1] == "lan")
statusmenu += "<b><#2467#> "+wans_lanport+" -</b><br>";
...
statusmenu += "<span><#1193#> <#2540#></span>";
else
statusmenu += "<span><#203#></span>";
}
}
...
return "<#2330#> : <span>0</span> <#1943#> <span>0</span> <#2246#>";
else
return "<#2330#> : <span>"+EHours+"</span> <#1943#> <span>"+EMinutes+"</span> <#2246#>";
}
...
statusmenu = "<span class='StatusClickHint' onclick='cancel_dblog();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1693#></span>";
_caption = "System Diagnostic capture";
}
else if(hint_show_id == 9){ //2015.07 Viz add for bwdpi : Adaptive QoS mode
statusmenu = "<span class='StatusClickHint' onclick='priority_change();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#801#></span><br>";
statusmenu += "<span class='StatusClickHint' onclick='qos_disable();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1663#></span>";
_caption = "<#811#>";
}
else if(hint_show_id == 8){ //2014.10 Viz add for dsl dslx_diag_state
statusmenu = "<span class='StatusClickHint' onclick='cancel_diag();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1693#></span>";
...
if(gobi_support){
statusmenu += "<#2294#></span>"
_caption = "<#2308#>";
}
else{
statusmenu += "<#1918#></span>"
_caption = "<#336#>";
}
}
}
...
statusmenu = "<span class='StatusClickHint' onclick='gotoguestnetwork();' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1917#></span>";
...
statusmenu = "<span class='StatusClickHint' onclick='suspendconn(0, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1501#></span>";
else{
...
statusmenu += "<span class='StatusClickHint' onclick='suspendconn(1, 0);' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#1501#></span>";
else{
...
statusmenu = "<span class='StatusClickHint' onclick='top.location.href=\"/QIS_wizard.htm?flag=sitesurvey_rep\";' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#100#></span>";
}
else if(sw_mode == 4){
statusmenu = "<span class='StatusClickHint' onclick='top.location.href=\"/QIS_wizard.htm?flag=sitesurvey_mb\";' onmouseout='this.className=\"StatusClickHint\"' onmouseover='this.className=\"StatusClickHint_mouseover\"'><#100#></span>";
}
...
statusmenu += "<#1627#> <span style='font-weight:normal'>"+ usbDevicesList[i].deviceName +"</span></div>";
}
}
if(statusmenu == "")
statusmenu = "<span class='StatusHint'><#1502#></span>";
...
return overlib('<#200#>', HAUTO, VAUTO);
...
if (typeof ol_text=='undefined') var ol_text='<#855#>';
...
if (nScore >= 0 && nScore < 20) { sComplexity = "<#402#>"; }
else if (nScore >= 20 && nScore < 40) { sComplexity = "<#403#>"; }
else if (nScore >= 40 && nScore < 60) { sComplexity = "<#404#>"; }
else if (nScore >= 60 && nScore < 80) { sComplexity = "<#405#>"; }
else if (nScore >= 80 && nScore <= 100) { sComplexity = "<#406#>"; }
}
else{
if (nScore >= 0 && nScore < 20) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#402#></a>"; }
else if (nScore >= 20 && nScore < 40) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#403#></a>"; }
else if (nScore >= 40 && nScore < 60) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#404#></a>"; }
else if (nScore >= 60 && nScore < 80) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#405#></a>"; }
else if (nScore >= 80 && nScore <= 100) { sComplexity = "<a href='Advanced_Wireless_Content.asp' target='_blank'><#406#></a>"; }
}
