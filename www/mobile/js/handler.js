...
$("#settingProfileBar").showSelectorHint("<#260#>");
return false;
}
if(
...
{
$("#settingProfileBar").showSelectorHint("<#2644#>");
return false;
}
...
httpUserInput.showTextHint("<#700#>");
return false;
}
/* check user name */
if(isSku("KR")){
...
if(!confirm("<#256#>")){
httpPassInput.showTextHint("<#1097#>");
return false;
}
}
return true;
...
$("#static_ipaddr").showTextHint("<#242#>");
return false;
}
...
if(sim_act == 2)
$(".sim_puk_apply").html("<#184#>");
else
$(".sim_pin_apply").html("<#184#>");
switch(sim_state){
case '1':
$("#sim_desc").html("<#2299#>");
$(".sim_pin_apply").html("<#191#>");
...
$("#verify_pincode_status").html("<#2319#>");
...
break;
case '4':
$("#verify_pincode_status").html("<#2267#>");
break;
case '6':
$("#verify_pincode_status").html("<#2318#>");
break;
case '-1':
$("#verify_pincode_status").html("<#2298#>");
break;
case '-2':
case '-10':
$("#verify_pincode_status").html("<#2296#>");
break;
default:
break;
}
...
$("#verify_pincode_status").html("<#2083#>");
$("#verify_pincode_status").css("display", "");
return false;
}
else{
...
$("#new_pincode_status").html("<#2272#>");
else
$("#new_pincode_status").html("<#2083#>");
...
if(!confirm("<#256#>")){
$("#wireless_key_" + band).showTextHint("<#1097#>");
return false;
}
}
return true;
...
if(pppoeAuthFail){
$(".btn_wireless_apply").html("<#184#>");
$(".btn_login_apply").html("<#184#>");
$("#wan_pppoe_passwd").showTextHint("<#619#>");
...
if(isSupport("concurrep"))
$("#siteSurvey_page").find(".titleSub").html("<#3584#>");
else
$("#siteSurvey_page").find(".titleSub").html("<#3258#>");
...
if(isSupport("RPMesh"))
$("#papList_page").find(".titleSub").html("<#3584#>");
else
$("#papList_page").find(".titleSub").html("<#3258#>");
genPAPList(systemVariable.papList, systemVariable.multiPAP.wlcOrder);
...
var applyBtn = (systemVariable.isNewFw == 2) ? "<#199#>" : "<#1442#>";
var abortBtn = (systemVariable.isNewFw == 2) ? "<#198#>" : "<#186#>";
...
$("#upgradeBtn").show();
$(".detectIcon").hide();
$("#liveUpdateStatus").html("<#177#><br/><#254#>");
}
else{
errCount++;
setTimeout(arguments.callee, 1000);
...
$("#liveUpdateStatus").html("<#1845#>...");
setTimeout(arguments.callee, 1000);
}
else if(fwUpgradeInfo.webs_state_error != "0" && fwUpgradeInfo.webs_state_error != ""){
$("#upgradeBtn").show();
$(".detectIcon").hide();
$("#liveUpdateStatus").html("<#223#>");
}
else{
$("#liveUpdateStatus").html("<#224#>");
setTimeout(arguments.callee, 1000);
}
}, 500);
...
if(isSwMode("RP"))
$("#summary_page").find("#stepText2").html("<#386#>");
}
else{
$("#summary_page").find("#stepText1").html("<#384#> <#383#>");
$("#summary_page").find("#stepText2").html("<#386#>");
}
if(isSupport("lantiq")){
