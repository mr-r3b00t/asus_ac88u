...
$obj.showTextHint('<#275#> ' + min + ' <#276#> ' + max + '.');
}
})
if($(".hint").length > 0) return true;
}
...
.append($("<div>").addClass("inputTitle").html(wl.title + " <#491#>"))
...
$("<div>")
.addClass("inputTitleContainer")
.append($("<div>").addClass("inputTitle").html(wl.title + " <#492#>"))
...
testResult.errReason = "<#280#> '" + invalid_char.join('') + "' !";
}
return testResult;
};
