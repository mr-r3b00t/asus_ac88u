...
x.options[0].text = "<#3251#>";
x.options[0].value = "lower";
}
else if ((CurrentCh >= 5) && (CurrentCh <= 7)){
x.options[0].text = "<#3251#>";
x.options[0].value = "lower";
add_option(document.form.wl_nctrlsb, "<#3252#>", "upper");
...
x.options[0].text = "<#3252#>";
x.options[0].value = "upper";
if (option_length >=14){
add_option(document.form.wl_nctrlsb, "<#3251#>", "lower");
