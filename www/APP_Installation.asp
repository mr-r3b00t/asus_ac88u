...
<link rel="icon" href="images/favicon.png"><title><#756#> - <#312#></title>
...
var fileflex_text = "<#1751#>";
function initial(){
show_menu();
default_apps_array = [["AiDisk", "aidisk.asp", "<#902#>", "Aidisk_png", ""],
["<#2626#>", "mediaserver.asp", "<#2951#>", "server_png", ""],
["<#2362#>", "PrinterServer.asp", "<#2361#>", "PrinterServer_png", ""],
["3G/4G", "Advanced_Modem_Content.asp", "<#1951#>", "modem_png", ""],
["<#2784#>", "Advanced_TimeMachine.asp", "<#2789#>", "TimeMachine_png", "1.0.0.1"]];
if(!media_support){
default_apps_array[1][1] = "Advanced_AiDisk_samba.asp";
default_apps_array[1].splice(2,1,"<#2232#>");
}
...
default_apps_array = default_apps_array.del(default_apps_array.getIndexByValue2D("<#2362#>")[0]);
...
default_apps_array = default_apps_array.del(default_apps_array.getIndexByValue2D("<#2784#>")[0]);
...
document.getElementById("apps_state_desc").innerHTML = "<#2978#>";
else if(apps_state_error == 2)
document.getElementById("apps_state_desc").innerHTML = "<#2966#>";
else if(apps_state_error == 4)
document.getElementById("apps_state_desc").innerHTML = "<#2965#>";
else if(apps_state_error == 6)
document.getElementById("apps_state_desc").innerHTML = "<#2968#>";
else if(apps_state_error == 7)
document.getElementById("apps_state_desc").innerHTML = "<#2971#>";
else if(apps_state_error == 9)
document.getElementById("apps_state_desc").innerHTML = "<#2970#>";
else if(apps_state_error == 10)
document.getElementById("apps_state_desc").innerHTML = "<#2967#>";
else if(apps_state_upgrade == 0)
document.getElementById("apps_state_desc").innerHTML = "<#2977#>";
...
document.getElementById("apps_state_desc").innerHTML = "[" + cookie.get("apps_last") + "] " + "<#1652#> <b>" + Math.round(installPercent) +"</b> <span style='font-size: 16px;'>%</span>";
...
document.getElementById("apps_state_desc").innerHTML = "<#2987#>";
else{
if(apps_depend_action_target != "terminated" && apps_depend_action_target != "error"){
if(apps_depend_action_target == "")
document.getElementById("apps_state_desc").innerHTML = "<b>[" + cookie.get("apps_last") + "] " + "<#1652#> </b>";
else
document.getElementById("apps_state_desc").innerHTML = "<b>[" + cookie.get("apps_last") + "] " + "<#1652#> </b>"
+"<br> <span style='font-size: 16px;'> <#1652#>："+apps_depend_do+"</span>"
...
if(apps_state_error == 1)
document.getElementById("apps_state_desc").innerHTML = "<#2969#>";
else if(apps_state_error == 2)
document.getElementById("apps_state_desc").innerHTML = "<#2966#>";
else if(apps_state_error == 3)
document.getElementById("apps_state_desc").innerHTML = "<#2964#>";
else if(apps_state_error == 8)
document.getElementById("apps_state_desc").innerHTML = "Enable error!";
else{
document.getElementById("loadingicon").style.display = "";
document.getElementById("apps_state_desc").innerHTML = "<#427#>";
}
}
else if(apps_state_update != 2 && apps_state_update != ""){
errorcode = "apps_state_update = " + apps_state_update;
if(apps_state_error == 1)
document.getElementById("apps_state_desc").innerHTML = "<#2958#>";
else if(apps_state_error == 2)
document.getElementById("apps_state_desc").innerHTML = "<#2956#>";
else
document.getElementById("apps_state_desc").innerHTML = "<#2945#>";
}
else if(apps_state_remove != 2 && apps_state_remove != ""){
errorcode = "apps_state_remove = " + apps_state_remove;
document.getElementById("apps_state_desc").innerHTML = "<#2943#>";
}
...
document.getElementById("apps_state_desc").innerHTML = "<#2959#>";
else if(apps_state_switch == 2)
document.getElementById("apps_state_desc").innerHTML = "<#2960#>";
else if(apps_state_switch == 3)
document.getElementById("apps_state_desc").innerHTML = "<#2957#>";
else
document.getElementById("apps_state_desc").innerHTML = "<#1652#>";
}
...
document.getElementById("apps_state_desc").innerHTML = "<#2954#>";
else if(apps_state_install == 2)
document.getElementById("apps_state_desc").innerHTML = "<#2961#>";
else
document.getElementById("apps_state_desc").innerHTML = "<#1259#>";
}
...
document.getElementById("apps_state_desc").innerHTML = "<#2963#>";
else if(apps_state_error == 6)
document.getElementById("apps_state_desc").innerHTML = "<#2968#>";
else if(apps_state_error == 7)
document.getElementById("apps_state_desc").innerHTML = "<#2971#>";
...
document.getElementById("apps_state_desc").innerHTML = "<#2979#>";
...
document.getElementById("apps_state_desc").innerHTML = "<b>[" + cookie.get("apps_last") + "] " + "<#1652#> </b>"
+"<br> <span style='font-size: 16px;'> <#1652#>："+_apps_depend_do+"</span>"
...
var trNum;
function show_apps(){
document.getElementById("usbHint").innerHTML = "<#2545#>";
var counter = 0;
appnum = 0;
if(apps_array == "" && (appnet_support || appbase_support)){
apps_array = [["downloadmaster", "", "", "no", "no", "", "", "<#1541#>", "downloadmaster_png", "", "", ""],
...
if(i ==3){
htmlcode += '<div class="app_desc">' + default_apps_array[i][2] + ' <a href="https://www.asus.com/event/networks_3G4G_support/" target="_blank" style="text-decoration:underline;"><#2739#></a></div>\n';
}
else{
...
htmlcode += '<span class="app_action" onclick="apps_form(\'enable\',\''+ apps_array[i][0] +'\',\'no\');"><#3277#></span>\n';
else
htmlcode += '<span class="app_action" onclick="apps_form(\'enable\',\''+ apps_array[i][0] +'\',\'yes\');"><#3276#></span>\n';
...
if(apps_array[i][0] == "downloadmaster"){
htmlcode += '<span class="app_action" onclick="divdisplayctrl(\'none\', \'none\', \'none\', \'\');"><#1428#></span>\n';
}
else if(apps_array[i][0] == "fileflex")
htmlcode += '<span class="app_action" onclick="location.href=\'fileflex.asp\';"><#1428#></span>\n';
...
htmlcode += '</div><div style="color:#FC0;margin-top:10px;"><span class="app_action" onclick="apps_form(\'upgrade\',\''+ apps_array[i][0] +'\',\'\');"><#2944#></span>\n';
...
htmlcode += '<span class="app_action" onclick="_appname=\''+apps_array[i][0]+'\';check_usb_app_dev();"><#1651#></span>\n'; /* untranslated */
else
htmlcode += '<span class="app_action" onclick="apps_form(\'install\',\''+ apps_array[i][0] +'\',\''+ partitions_array[i] +'\');"><#1651#></span>\n'; /* untranslated */
}
...
if(accessableSize > 1)
htmlcode += '<div class="app_desc"><#1260#>: <b>'+ accessableSize+" GB" + '</b></div>';
else
htmlcode += '<div class="app_desc"><#1260#>: <b>'+ accessableSize+" GB <span style=\'color:#FFCC00\'>(Disk quota can not less than 1GB)" + '</span></b></div>';
htmlcode += '<div class="app_desc"><#2811#>: <b>'+ totalSize+" GB" + '</b></div>';
...
htmlcode += '<tr height="360px"><td colspan="2" class="nohover"><span class="app_name" style="line-height:100%"><#2386#></span></td></tr>\n';
document.getElementById("partition_div").innerHTML = htmlcode;
document.getElementById("usbHint").innerHTML = "<#1542#> :";
});
}
...
document.getElementById("quick_dmlink").onclick = function(){alert("<#1539#>");return false;}
}
document.getElementById("return_btn").style.display = "";
}
if(flag4 == "none")
...
<tr>
<td align="left">
<span class="formfonttitle"><#312#></span>
</td>
<td>
<img id="return_btn" onclick="reloadAPP();" align="right" style="cursor:pointer;position:absolute;margin-left:-30px;margin-top:-25px;" title="<#312#>" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
</td>
</tr>
</table>
</div>
...
<tr>
<td>
<div class="formfontdesc" id="usbHint"><#2545#></div>
</td>
</tr>
<tr>
<td valign="top">
...
<span style="margin-left:15px;" id="apps_state_desc"><#1240#></span>
<img id="loadingicon" style="margin-left:10px" src="/images/InternetScan.gif">
<br>
<br>
<br>
<div id="cancelBtn" style="display:none;">
<input class="button_gen" onclick="apps_form('cancel','','');" type="button" value="<#186#>"/>
</div>
</div>
...
<table>
<tr>
<td><div class="top-heading" style="cursor:pointer;margin-top:10px;height:20px;" id="quick_dmlink"><a id="realLink" href="" target="_blank"><b style="text-decoration:underline;color:#FC0;font-size:16px;"><#1544#></b></></a></div></td>
...
<br>
<li>
<a id="faq" href="" target="_blank" style="text-decoration:underline;font-size:14px;font-weight:bolder;color:#FFF"><#1547#> FAQ</a>
</li>
<li style="margin-top:10px;">
<a id="faq2" href="" target="_blank" style="text-decoration:underline;font-size:14px;font-weight:bolder;color:#FFF"><#1547#> Tool FAQ</a>
</li>
<li style="margin-top:10px;">
<a id="DMUtilityLink" href="http://dlcdnet.asus.com/pub/ASUS/wireless/RT-AC5300/UT_Download_Master_2228_Win.zip" style="text-decoration:underline;font-size:14px;font-weight:bolder;color:#FFF"><#1540#></a>
</li>
</ul>
</td>
</tr>
