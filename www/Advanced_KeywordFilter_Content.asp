...
<div>&nbsp;</div>
<div class="formfonttitle"><#337#> - <#341#></div>
...
<th><#1766#></th>
<td>
<input type="radio" value="1" name="keyword_enable_x" <% nvram_match("keyword_enable_x", "1", "checked"); %>><#1423#>
<input type="radio" value="0" name="keyword_enable_x" <% nvram_match("keyword_enable_x", "0", "checked"); %>><#1420#>
</td>
</tr>
</table>
