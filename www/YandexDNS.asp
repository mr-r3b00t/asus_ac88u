...
code +='<option value="1"'+(value == 1 ? "selected" : "")+'><#3420#></option>';
code +='<option value="2"'+(value == 2 ? "selected" : "")+'><#3422#></option>';
code +='<option value="0"'+(value == 0 ? "selected" : "")+'><#3418#></option>';
if (defmode)
code +='<option value="-1"'+(value == -1 ? "selected" : "")+'><#1346#></option>';
code += '</select>'
return code;
}
...
code +='<thead><tr><td colspan="5"><#1392#>&nbsp;(<#2203#>&nbsp;16)</td></tr></thead>';
code +='<tr><th width="3%" height="30px" title="<#2612#>"><input id="select_all" type="checkbox" onchange="selectRows_main(this);"></th>';
code +='<th width="38%"><#2426#></th>';
code +='<th width="19%"><#2424#></th>';
code +='<th width="15%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(27,1);"><#3417#></a></th>';
code +='<th width="10%"><#2202#></th></tr>';
code +='<tr><td style="border-bottom:2px solid #000;" title="<#3276#>/<#1345#>"><input type="checkbox" name="rule_enable" checked></td>';
...
<div>&nbsp;</div>
<div class="formfonttitle"><#3411#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="yadns_desc" style="margin-bottom:10px;">
<table width="700px" style="margin-left:25px;">
<tr>
<td>
<a href="<#3416#>" target="_blank"><img src="/images/New_ui/<#3415#>"></a>
</td>
<td>&nbsp;&nbsp;</td>
