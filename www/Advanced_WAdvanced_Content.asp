...
country_array = [];
var country_selection_list = [["AA", "<#1397#>"], ["CN", "<#1399#>"], ["SG", "<#1403#>"], ["EU", "<#1400#>"], ["KR", "<#1401#>"], ["RU", "<#1402#>"], ["US", "<#1404#>"], ["AU", "<#1398#>"], ["XX", "<#1398#>"]];
...
document.getElementById('wl_txbf_desc').innerHTML = "<#3280#>";
}
else{
document.getElementById('wl_txbf_desc').innerHTML = "<#3281#>";
}
}
else{
document.getElementById('wl_txbf_desc').innerHTML = "<#3280#>";
...
document.getElementById('wl_txbf_desc').innerHTML = "<#3314#>";
inputCtrl(document.form.wl_txbf, 1);
inputCtrl(document.form.wl_itxbf, 1);
}
}
...
var name = country ? country.name : '<#3357#> ' + index;
if(tcode == index){
matched = true;
name += ' (<#2638#>)';
}
...
if(!matched){
code += '<option value='+ tcode +' ><#2638#></option>';
}
code += '</select>';
...
power_table_desc = ["<#3263#>", "<#3264#>", "<#3265#>", "<#3266#>", "<#3267#>"];
...
if(time_temp == ""){
alert("If you want to deny WiFi radio all time, you should check the '<#3350#>' to No");
return false;
}
...
code +='<thead><tr><td colspan="6" id="LWFilterList"><#2410#></td></tr></thead>';
code +='<tr><th style="width:40%;height:20px;" align="right"><#232#></th>';
...
code_temp += "<td><div style=\"width:95px;font-family:Arial,sans-serif,Helvetica;font-size:18px;\"><#1371#></div></td>";
code_temp += '<td><div>';
...
code_temp += '</select>';
code_temp += '</div></td>';
code_temp += '<td><div align="left" style="font-family:Arial,sans-serif,Helvetica;font-size:18px;margin:0px 5px 0px 30px;"><#2411#></div></td>';
code_temp += '<td><div style="width:90px;height:20px;background:#9CB2BA;"></div></td>';
code_temp += '<td><div align="left" style="font-family:Arial,sans-serif,Helvetica;font-size:18px;margin:0px 5px 0px 30px;"><#2413#></div></td>';
...
document.getElementById("ctrlBtn").innerHTML = '<input class="button_gen" type="button" onClick="cancel_wifi_schedule();" value="<#186#>" style="margin:0 10px;">';
document.getElementById("ctrlBtn").innerHTML += '<input class="button_gen" type="button" onClick="save_wifi_schedule();" value="<#1433#>" style="margin:0 10px;">';
...
<div>&nbsp;</div>
<div class="formfonttitle"><#315#> - <#321#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="titl_desc" class="formfontdesc"><#3243#></div>
<div id="lantiq_ready" style="display:none;color:#FC0;margin-left:5px;font-size:13px;">Wireless is setting...</div>
<div id="svc_hint_div" style="display:none;margin-left:5px;"><span onClick="location.href='Advanced_System_Content.asp?af=ntp_server0'" style="color:#FFCC00;text-decoration:underline;cursor:pointer;"><#233#></span></div>
...
<tr id="wl_rf_enable">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 1);"><#3350#></a></th>
<td>
<input type="radio" value="1" name="wl_radio" class="input" onClick="control_TimeField();" <% nvram_match("wl_radio", "1", "checked"); %>><#176#>
<input type="radio" value="0" name="wl_radio" class="input" onClick="control_TimeField();" <% nvram_match("wl_radio", "0", "checked"); %>><#175#>
</td>
</tr>
<tr id="wl_sched_enable">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 23);"><#3365#></a></th>
<td>
<input type="radio" value="1" name="wl_timesched" class="input" onClick="control_TimeField();return change_common_radio(this, 'WLANConfig11b', 'wl_timesched', '1');" <% nvram_match("wl_timesched", "1", "checked"); %>><#176#>
<input type="radio" value="0" name="wl_timesched" class="input" onClick="control_TimeField();return change_common_radio(this, 'WLANConfig11b', 'wl_timesched', '0')" <% nvram_match("wl_timesched", "0", "checked"); %>><#175#>
<span id="time_setting" style="padding-left:20px;cursor:pointer;text-decoration:underline" onclick="show_wifi_schedule();"><#2783#></span>
</td>
</tr>
<tr id="wl_ap_isolate_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 5);"><#3326#></a></th>
<td>
<input type="radio" value="1" name="wl_ap_isolate" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_ap_isolate', '1')" <% nvram_match("wl_ap_isolate", "1", "checked"); %>><#176#>
<input type="radio" value="0" name="wl_ap_isolate" class="input" onClick="return change_common_radio(this, 'WLANConfig11b', 'wl_ap_isolate', '0')" <% nvram_match("wl_ap_isolate", "0", "checked"); %>><#175#>
</td>
</tr>
<tr id="rssiTr" class="rept ew">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 31);"><#2557#></a></th>
<td>
<select id="wl_user_rssi_option" class="input_option" onchange="changeRSSI(this.value);">
<option value="1"><#3276#></option>
<option value="0" <% nvram_match("wl_user_rssi", "0","selected"); %>><#3277#></option>
</select>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,34);"><#3300#></a></th>
<td>
<select name="wl_btc_mode" class="input_option">
<option value="0" <% nvram_match("wl_btc_mode", "0","selected"); %> ><#3277#></option>
<option value="1" <% nvram_match("wl_btc_mode", "1","selected"); %> ><#3276#></option>
<option value="2" <% nvram_match("wl_btc_mode", "2","selected"); %> >Pre-emptive</option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 22);"><#3322#></a></th>
<td>
<select name="wl_igs" class="input_option">
<option value="1" <% nvram_match("wl_igs", "1","selected"); %>><#3276#></option>
<option value="0" <% nvram_match("wl_igs", "0","selected"); %>><#3277#></option>
</select>
</td>
</tr>
<tr id="wl_mrate_select">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 7);"><#3256#></a></th>
<td>
<select name="wl_mrate_x" class="input_option">
<option value="0" <% nvram_match("wl_mrate_x", "0", "selected"); %>><#149#></option>
</select>
</td>
</tr>
<tr id="wl_plcphdr_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,20);"><#3391#></a></th>
<td>
<select name="wl_plcphdr" class="input_option">
<option value="long" <% nvram_match("wl_plcphdr", "long", "selected"); %>><#3392#></option>
<option value="short" <% nvram_match("wl_plcphdr", "short", "selected"); %>><#3393#></option>
<!-- auto mode applicable for STA only
<option value="auto" <% nvram_match("wl_plcphdr", "auto", "selected"); %>><#149#></option>
-->
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 9);"><#3317#></a></th>
<td>
...
<option value="1" <% nvram_match("wl_ampdu_rts", "1", "selected"); %>><#3276#></option>
<option value="0" <% nvram_match("wl_ampdu_rts", "0", "selected"); %>><#3277#></option>
</select>
</td>
</tr>
<tr id="rts_threshold">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 10);"><#3363#></a></th>
<td>
...
<tr id="wl_dtim_field">
<th><a class="hintstyle" id="wl_dtim_th" href="javascript:void(0);" onClick=""><#3310#></a></th>
<td>
...
<tr id="wl_bcn_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 12);"><#3297#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 13);"><#3370#></a></th>
<td>
<select name="wl_frameburst" class="input_option">
<option value="off" <% nvram_match("wl_frameburst", "off","selected"); %>><#3277#></option>
<option value="on" <% nvram_match("wl_frameburst", "on","selected"); %>><#3276#></option>
</select>
</td>
</tr>
<tr id="PktAggregate"><th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 16);"><#3346#></a></th>
<td>
<select name="wl_PktAggregate" class="input_option">
<option value="0" <% nvram_match("wl_PktAggregate", "0","selected"); %>><#3277#></option>
<option value="1" <% nvram_match("wl_PktAggregate", "1","selected"); %>><#3276#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3, 14);"><#3373#></a></th>
<td>
<select name="wl_wme" id="wl_wme" class="input_option" onChange="enable_wme_check(this);">
<option value="auto" <% nvram_match("wl_wme", "auto", "selected"); %>><#149#></option>
<option value="on" <% nvram_match("wl_wme", "on", "selected"); %>><#3276#></option>
<option value="off" <% nvram_match("wl_wme", "off", "selected"); %>><#3277#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,15);"><#3342#></a></th>
<td>
<select name="wl_wme_no_ack" id="wl_wme_no_ack" class="input_option">
<option value="off" <% nvram_match("wl_wme_no_ack", "off","selected"); %>><#3277#></option>
<option value="on" <% nvram_match("wl_wme_no_ack", "on","selected"); %>><#3276#></option>
</select>
</td>
</tr>
<tr id="wl_wme_apsd_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,17);"><#3292#></a></th>
<td>
<select name="wl_wme_apsd" class="input_option">
<option value="off" <% nvram_match("wl_wme_apsd", "off","selected"); %> ><#3277#></option>
<option value="on" <% nvram_match("wl_wme_apsd", "on","selected"); %> ><#3276#></option>
</select>
</td>
</tr>
<tr id="DLSCapable" class="rept"> <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,18);"><#3307#></a></th>
<td>
<select name="wl_DLSCapable" class="input_option">
<option value="0" <% nvram_match("wl_DLSCapable", "0","selected"); %>><#3277#></option>
<option value="1" <% nvram_match("wl_DLSCapable", "1","selected"); %>><#3276#></option>
</select>
</td>
</tr>
<tr> <th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,21);"><#3313#></a></th>
<td>
<select name="wl_noisemitigation" class="input_option" onChange="">
<option value="0" <% nvram_match("wl_noisemitigation", "0","selected"); %>><#3277#></option>
<option value="1" <% nvram_match("wl_noisemitigation", "1","selected"); %>><#3276#></option>
</select>
</td>
</tr>
<tr> <th><a class="hintstyle" href="javascript:void(0);"><#3366#></a></th>
<td>
<select name="traffic_5g" class="input_option">
<option value="1" <% nvram_match("traffic_5g", "1","selected"); %>><#3276#></option>
<option value="0" <% nvram_match("traffic_5g", "0","selected"); %>><#3277#></option>
</select>
</td>
</tr>
<tr id="wl_ampdu_mpdu_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,26);"><#3284#></a></th>
<td>
<select name="wl_ampdu_mpdu" class="input_option">
<option value="0" <% nvram_match("wl_ampdu_mpdu", "0","selected"); %> ><#3277#></option>
<option value="1" <% nvram_match("wl_ampdu_mpdu", "1","selected"); %> ><#3276#></option>
</select>
</td>
</tr>
<tr id="wl_ack_ratio_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,27);"><#3282#></a></th>
<td>
<select name="wl_ack_ratio" class="input_option">
<option value="0" <% nvram_match("wl_ack_ratio", "0","selected"); %> ><#3277#></option>
<option value="1" <% nvram_match("wl_ack_ratio", "1","selected"); %> ><#3276#></option>
</select>
</td>
</tr>
<tr>
<th id="turbo_qam_title"><a id="turbo_qam_hint" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,28);"><#3367#></a></th>
<td>
<select name="wl_turbo_qam" class="input_option">
<option value="0" <% nvram_match("wl_turbo_qam", "0","selected"); %> ><#3277#></option>
<option value="1" <% nvram_match("wl_turbo_qam", "1","selected"); %> ><#3276#></option>
</select>
</td>
</tr>
<tr>
...
<option value="0" <% nvram_match("wl_turbo_qam_brcm_intop", "0","selected"); %> ><#3277#></option>
<option value="1" <% nvram_match("wl_turbo_qam_brcm_intop", "1","selected"); %> ><#3276#></option>
</select>
</td>
</tr>
<tr id="wl_80211h_tr" style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#3279#></a></th>
<td>
<select name="wl1_80211h" class="input_option">
<option value="0" <% nvram_match("wl1_80211h", "0","selected"); %>><#3277#></option>
<option value="1" <% nvram_match("wl1_80211h", "1","selected"); %>><#3276#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(3,32);"><#3293#></a></th>
<td>
<select name="wl_atf" class="input_option">
<option value="0" <% nvram_match("wl_atf", "0","selected"); %> ><#3277#></option>
<option value="1" <% nvram_match("wl_atf", "1","selected"); %> ><#3276#></option>
</select>
</td>
</tr>
<tr id="wl_MU_MIMO_field" style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#3257#></a></th>
<td>
<div style="display:table-cell;vertical-align:middle">
<select name="wl_mumimo" class="input_option" onchange="handle_mimo(this.value)" disabled>
<option value="0" <% nvram_match("wl_mumimo", "0","selected"); %> ><#3277#></option>
<option value="1" <% nvram_match("wl_mumimo", "1","selected"); %> ><#3276#></option>
</select>
</div>
</td>
</tr>
<tr id="ofdma_field" style="display:none">
<th><a class="hintstyle"><#2397#></a></th>
<td>
<div style="display:table-cell;vertical-align:middle">
<select name="wl_ofdma" class="input_option">
<option value="0" <% nvram_match("wl_ofdma", "0","selected"); %>><#3277#></option>
...
<tr id="wl_txbf_field">
<th><a id="wl_txbf_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,24);"><#3314#></a></th>
<td>
<select name="wl_txbf" class="input_option" onchange="handle_beamforming(this.value)">
<option value="0" <% nvram_match("wl_txbf", "0","selected"); %> ><#3277#></option>
<option value="1" <% nvram_match("wl_txbf", "1","selected"); %> ><#3276#></option>
</select>
</td>
</tr>
<tr id="wl_itxbf_field">
<th><a id="wl_itxbf_desc" class="hintstyle" href="javascript:void(0);" onClick="openHint(3,25);"><#3371#></a></th>
<td>
<select name="wl_itxbf" class="input_option" disabled>
<option value="0" <% nvram_match("wl_itxbf", "0","selected"); %> ><#3277#></option>
<option value="1" <% nvram_match("wl_itxbf", "1","selected"); %> ><#3276#></option>
</select>
</td>
</tr>
<tr id="wl_implicitxbf_field" style="display:none">
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#3371#></a></th>
<td>
<select name="wl_implicitxbf" class="input_option">
<option value="0" <% nvram_match("wl_implicitxbf", "0","selected"); %>><#3277#></option>
<option value="1" <% nvram_match("wl_implicitxbf", "1","selected"); %>><#3276#></option>
</select>
</td>
</tr>
<tr id="wl_txPower_field">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(0, 16);"><#3262#></a></th>
<td>
<div>
<table>
<tr>
...
<option value="0" <% nvram_match("wl_hwol", "0","selected"); %> ><#3277#></option>
<option value="1" <% nvram_match("wl_hwol", "1","selected"); %> ><#3276#></option>
</select>
</td>
</tr>
<tr id="region_tr" style="display:none" class="rept ew">
<th><a class="hintstyle" href="javascript:void(0);" onClick=""><#3357#></a></th>
