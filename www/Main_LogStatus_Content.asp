...
document.getElementById('dstzone').innerHTML = "<#231#>";
}
}
function initial(){
show_menu();
...
<div>&nbsp;</div>
<div class="formfonttitle"><#668#> - <#349#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#1915#></div>
...
<tr>
<th><#1914#></a></th>
<td><span id="boot_days"></span> <#1458#> <span id="boot_hours"></span> <#1943#> <span id="boot_minutes"></span> <#2246#> <span id="boot_seconds"></span> <#2610#></td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(11,1)"><#2174#></a></th>
<td>
...
<input class="button_gen" onclick="applySettings();" type="button" value="<#184#>" />
...
<input type="submit" onClick="onSubmitCtrl(this, ' Clear ')" value="<#1415#>" class="button_gen">
</form>
</td>
<td width="50%" align="left">
<form method="post" name="form2" action="syslog.txt">
<input type="submit" onClick="onSubmitCtrl(this, ' Save ');" value="<#1434#>" class="button_gen">
</form>
</td>
</tr>
</table>
