...
html += "<td>";
html += '<div>';
html += '<input type="button" id="update" name="update" class="button_gen" onclick="show_offline_msg(true);" value="<#2204#>" />';
html += '<div><input type="button" id="amas_update" class="button_gen" style="display:none;" onclick="cfgsync_firmware_upgrade();" value="<#1442#>"/><div>';
html += '</div>';
html += '<div id="linkpage_div" class="button_helplink" style="margin-left:200px;margin-top:-38px;display:none;">';
html += '<a id="linkpage" target="_blank"><div style="padding-top:5px;"><#2204#></div></a>';
html += '</div>';
...
html += "<tr>";
html += "<td class='aimesh_node_category_bg' colspan='2'><#993#></td>";
html += "</tr>";
html += "<tr>";
html += "<th>";
html += "<#757#>";
...
html += "<div id='current_version'><#92#> : " + FWString + "</div>";
html += "<div id='amesh_manual_upload_fw'>";
html += "<#1849#> : ";
html += "<span class='aimesh_fw_update_offline' style='margin-left:0px;' onclick='open_AiMesh_router_fw_upgrade();'><#1443#></span>";
html += "</div>";
html += "<div id='checkNewFW' class='checkNewFW' style='display:none;'><#93#> : <span class='checkFWReuslt'></span></div>";
html += "</td>";
html += "</tr>";
$("#fw_version_tr").before(html);
...
if(!have_node) {
html += "<tr>";
html += "<td class='aimesh_node_category_bg' colspan='2'><#946#></td>";
html += "</tr>";
}
html += "<tr>";
html += "<th>";
...
html += "<br>";
html += "<#960#> : " + htmlEnDeCode.htmlEncode(alias);
html += "</th>";
html += "<td id='amas_" + mac_id + "'>";
html += "<div id='current_version'><#92#> : " + fwver + "</div>";
...
document.getElementById('update_states').innerHTML="<#1986#>";
...
document.getElementById('update_scan').style.display="none";
document.getElementById('update_states').innerHTML="<#223#><br><#1844#>";
document.getElementById('update').disabled = false;
}
else{
document.getElementById('update_scan').style.display="none";
...
contentA: "<#214#><br>",
contentC: "<br><#833#> <#306#>",
left_button: (flag==2)? "<#198#>":"<#186#>",
left_button_callback: function(){confirm_cancel();},
left_button_args: {},
right_button: (flag==2)? "<#199#>":"<#1442#>",
...
document.getElementById('update_states').innerHTML="<#254#>";
}
}
...
document.getElementById('update_states').style.display="";
document.getElementById('update_states').innerHTML="<#1356#>";
...
document.getElementById('update_scan').style.display="none";
document.getElementById('update_states').style.display="";
document.getElementById('update_states').innerHTML="<#1390#>";
return false;
}
}
var dead = 0;
...
document.getElementById('loading_block3').innerHTML = "<div><#226#></div>";
}
else{
dead++;
}
...
document.getElementById("drword").innerHTML = "<#1390#>";
return false;
}
},
success: function(){
...
document.getElementById("drword").innerHTML = "&nbsp;&nbsp;&nbsp;<#1845#>...";
setTimeout("isDownloading();", 1000);
}
}
else if(cfg_check == "0") {
...
document.getElementById("drword").innerHTML = "<#223#><br><#1844#>";
return false;
}
...
document.getElementById("drword").innerHTML = "&nbsp;&nbsp;&nbsp;<#1845#>..."+fwdl_percent;
setTimeout("isDownloading();", 1000);
}
...
document.getElementById("drword").innerHTML = "Memory space is NOT enough to upgrade on internet. Please wait for rebooting.<br><#1844#>"; /* untranslated */ //Untranslated. fw_size_higher_mem
return false;
}
...
var date_format = "<#1857#> : " + year + "/" + month + "/" + date + " " + hour + ":" + minute;
return date_format;
}
...
$amesh_ok.attr({"type" : "button", "value" : "<#1433#>"});
...
var online = get_cfg_clientlist[idx].online;
var mac_id = mac.replace(/:/g, "");
$("#amas_" + mac_id + "").children("#current_version").html("<#92#> : " + fwver + "");
...
html += "<#1849#> : ";
if(_online == "0") {
html += "<span class='aimesh_fw_update_offline' style='margin-left:0px;' onclick='show_offline_msg(false);'><#1365#></span>";
amesh_offline_flag = true;
}
else {
html += "<span class='aimesh_fw_update_offline' style='margin-left:0px;' onclick='open_AiMesh_node_fw_upgrade(\"" + _node_ip + "\");'><#1443#></span>";
}
}
else {
html += "<span class='aimesh_fw_update_offline' style='margin-left:0px;text-decoration:none;cursor:none;'><#1854#></span>";
}
return html;
}
...
<div id="loading_block2" style="margin:5px auto; width:85%;"><#224#><br><#306#></div>
...
<tr>
<td>
<div class="drword" id="drword" style="">&nbsp;&nbsp;&nbsp;&nbsp;<#305#> <#302#>...</div>
</td>
</tr>
</table>
<!--[if lte IE 6.5]><iframe class="hackiframe"></iframe><![endif]-->
...
<div>&nbsp;</div>
<div class="formfonttitle"><#343#> - <#347#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><strong><#1852#></strong>
<ol>
<li><#1850#></li>
<li><#229#></li>
<li id="fw_note2"><#1851#></li>
<li id="fw_note3"><#1843#></li>
</ol>
</div>
<br>
...
<input type="button" id="sig_check" name="sig_check" class="button_gen" onclick="sig_version_check();" value="<#2204#>">
</div>
<div>
...
<input type="button" id="update" name="update" class="button_gen" onclick="detect_update();" value="<#2204#>" />
</div>
<div id="linkpage_div" class="button_helplink" style="margin-left:200px;margin-top:-38px;display:none;">
<a id="linkpage" target="_blank"><div style="padding-top:5px;"><#2204#></div></a>
</div>
<div id="check_states">
...
<input type="button" name="upload" class="button_gen" onclick="submitForm()" value="<#1443#>" />
</td>
</tr>
</table>
...
<input type="checkbox" name="upgrade_date_x_Sun" class="input" onclick="check_Timefield_checkbox();"><#1454#>
<input type="checkbox" name="upgrade_date_x_Mon" class="input" onclick="check_Timefield_checkbox();"><#1452#>
<input type="checkbox" name="upgrade_date_x_Tue" class="input" onclick="check_Timefield_checkbox();"><#1456#>
<input type="checkbox" name="upgrade_date_x_Wed" class="input" onclick="check_Timefield_checkbox();"><#1457#>
<input type="checkbox" name="upgrade_date_x_Thu" class="input" onclick="check_Timefield_checkbox();"><#1455#>
<input type="checkbox" name="upgrade_date_x_Fri" class="input" onclick="check_Timefield_checkbox();"><#1451#>
<input type="checkbox" name="upgrade_date_x_Sat" class="input" onclick="check_Timefield_checkbox();"><#1453#>
</td>
</tr>
<tr>
...
<tr align="center">
<td colspan="2" >
<input type="button" name="apply" class="button_gen" onclick="applyRule()" value="<#184#>" />
</td>
</tr>
</table>
</td>
