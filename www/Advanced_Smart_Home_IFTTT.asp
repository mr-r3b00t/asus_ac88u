...
<div id="divSwitchMenu" style="margin-top:-40px;float:right;"><div style="width:150px;height:30px;float:left;border-top-left-radius:8px;border-bottom-left-radius:8px;" class="block_filter"><a href="Advanced_Smart_Home_Alexa.asp"><div class="block_filter_name"><#1227#></div></a></div><div style="width:110px;height:30px;float:left;border-top-right-radius:8px;border-bottom-right-radius:8px;" class="block_filter_pressed"><div class="tab_font_color" style="text-align:center;padding-top:5px;font-size:14px">IFTTT</div></div></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="div_table">
<div class="div_tr">
<div class="div_td div_desc" style="width:55%">
<div style="font-weight:bolder;font-size:16px;padding:25px 40px"><#1973#></div>
<div style="padding:0px 40px;font-family:Arial, Helvetica, sans-serif;font-size:13px;">
<span><#1974#></span>
<p style="font-size:13px;padding-top: 20px;padding-left: 20px;font-style:italic;">“<#1975#>”</p>
<p style="font-size:13px;padding-left: 20px;font-style:italic;">“<#1976#>”</p>
<p style="font-size:13px;padding-left: 20px;font-style:italic;">“<#1977#>”</p>
<p style="font-size:13px;padding-left: 20px;font-style:italic;">“<#1978#>”</p>
<a style="font-size:13px;padding-top: 2px;padding-left: 20px;font-style:italic;text-decoration: underline;cursor:pointer;" href="https://ifttt.com/asusrouter" target="_blank"><#1979#></a>
</div>
<div style="text-align:center;padding-top:60px;font-family:Arial, Helvetica, sans-serif;font-style:italic;font-weight:lighter;font-size:18px;"><#1983#></div>
<div id="acc_link_status" style="text-align:center;padding-top:10px;font-size:15px;color:#FFCC00;font-weight:bolder;"></div> <div class="div_img">
<table style="width:99%">
<div style="font-size:20px;color:#c0c0c0;padding-bottom:20px;"><#1984#></div>
...
<div style="color:#c0c0c0;"><#1982#></div> </div>
</div>
<div class="div_tr" style="height: 45px;">
...
<div style="color:#c0c0c0"><#1972#></div> </div>
</div>
</div>
<div class="div_tr">
...
<div class="div_td" style="font-size:16px;padding:5px 0px 0px 10px;">
<div><span style="color:#FFCC00;text-decoration:underline;cursor:pointer;" onclick="get_activation_code();"><#1228#></span> ,<#1230#></div>
</div>
</div>
<div style="font-weight:bolder;font-size:20px;color:#c0c0c0;padding-top:57px;padding-left:15px;"><#1971#></div>
...
<tr>
<th colspan="2">
<div style="font-size:14px;padding-bottom:8px;"><#1980#></div>
</th>
</tr>
<tr>
<td colspan="2">
