...
<link rel="icon" href="images/favicon.png"><title><#756#> - <#1860#></title>
...
var code = '';
code += '<thead><tr><td colspan="4">Game Device List&nbsp;(<#2203#>&nbsp;64)</td></tr></thead>';
code += '<tr>';
code += '<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,10);"><#1357#> (<#2488#>)</a></th>';
code += '<th><#2202#></th>';
code += '</tr>';
code += '<tr>';
code += '<td width="40%">';
...
code += '<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#2618#>">';
...
<td colspan="2">
<div style="padding: 5px 10px;font-size:20px;color:#FFCC66;"><#1878#></div>
</td>
</tr>
<tr>
<td colspan="3">
...
<div onclick="showGameListField();" class="btn" style="margin: 12px 0;width:100px;height:40px;line-height: 40px;text-align: center;border-radius: 5px;font-size:18px;"><#1411#></div>
</td>
<td>
<div class="switch" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px">
...
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="location.href='GameProfile.asp';"><#1349#></div>
</td>
</tr>
<tr style="height:50px;"></tr>
<tr id='wtfast_1' style="display:none">
<td style="width:200px">
<div style="padding: 5px 0;font-size:20px;"><#1875#></div>
</td>
<td colspan="2">
...
<td style="width:400px;height:120px;">
<div style="font-size:16px;color:#949393;padding-left:10px;"><#1872#></div>
</td>
<td>
<div class="btn" style="margin:auto;width:100px;height:40px;text-align:center;line-height:40px;font-size:18px;cursor:pointer;border-radius:5px;" onclick="location.href='Advanced_WTFast_Content.asp';"><#1349#></div>
</td>
</tr>
</tbody>
</table>
