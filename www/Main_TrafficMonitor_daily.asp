...
grid += "<tr><th style=\"height:30px;\"><#1450#></th>";
grid += "<th><#2800#></th>";
grid += "<th><#2807#></th>";
grid += "<th><#2810#></th></tr>";
...
if(rows == 0)
grid +='<tr><td style="color:#FFCC00;" colspan="4"><#2027#></td></tr>';
...
<option value="3" selected><#2239#></option>
</select>
</div>
</td>
</tr>
...
<thead>
<tr>
<td colspan="2" id="TriggerList" style="text-align:left;"><#2184#> <span style="color:#FFF;background-color:transparent;" id='last-dates'></span></td>
</tr>
</thead>
<tbody>
<tr class='even'><th width="40%"><#2800#></th><td id='last-dn'>-</td></tr>
<tr class='odd'><th width="40%"><#2807#></th><td id='last-up'>-</td></tr>
<tr class='footer'><th width="40%"><#2810#></th><td id='last-total'>-</td></tr>
</tbody>
</table>
</td>
</tr>
