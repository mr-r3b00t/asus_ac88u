...
if(flag == 3){
document.getElementById("error_status_field").innerHTML ="* <#2091#>";
}
else if(flag == 7){
...
<div class="div_td"><#195#></div>
</div>
<div class="prod_madelName"><#757#></div>
<div id="login_filed">
<div class="p1 title_gap"><#647#></div>
<div id="name_title_ie" style="display:none;margin:20px 0 -10px 78px;" class="p1 title_gap"><#2990#></div>
<div class="title_gap">
<input type="text" id="login_username" name="login_username" tabindex="1" class="form_input" maxlength="20" autocapitalize="off" autocomplete="off" placeholder="<#2990#>">
</div>
<div id="password_title_ie" style="display:none;margin:20px 0 -20px 78px;" class="p1 title_gap"><#1959#></div>
<div class="password_gap">
<input type="password" name="login_passwd" tabindex="2" class="form_input" maxlength="16" placeholder="<#1959#>" autocapitalize="off" autocomplete="off">
</div>
...
<div class="button" onclick="login();"><#195#></div>
</div>
