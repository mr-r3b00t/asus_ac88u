...
add_option(document.form.LWKnownApps, "<#2013#>", "User Defined", 1);
...
<div>&nbsp;</div>
<div class="formfonttitle"><#337#> - <#340#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#1756#></div>
<div class="formfontdesc"><#1758#></div>
<div class="formfontdesc" style="color:#FFCC00;"><#1759#></div>
...
<thead>
<tr>
<td colspan="6" id="filter_lwlist"><#340#></td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,5);"><#1778#></a></th>
<td>
<input type="radio" value="1" name="fw_lw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_lw_enable_x', '1')" <% nvram_match_x("FirewallConfig","fw_lw_enable_x", "1", "checked"); %>><#176#>
<input type="radio" value="0" name="fw_lw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_lw_enable_x', '0')" <% nvram_match_x("FirewallConfig","fw_lw_enable_x", "0", "checked"); %>><#175#>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,3);"><#1775#></a></th>
<td>
<select name="filter_lw_default_x" class="input_option">
<option value="DROP" <% nvram_match("filter_lw_default_x", "DROP","selected"); %>><#3191#></option>
<option value="ACCEPT" <% nvram_match("filter_lw_default_x", "ACCEPT","selected"); %>><#1273#></option>
</select>
</td>
</tr>
<tr>
...
<option value="User Defined"><#2013#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,1);"><#1771#></a></th>
<td>
<input type="checkbox" name="filter_lw_date_x_Mon" class="input" onclick="check_Timefield_checkbox()"><#1452#>
<input type="checkbox" name="filter_lw_date_x_Tue" class="input" onclick="check_Timefield_checkbox()"><#1456#>
<input type="checkbox" name="filter_lw_date_x_Wed" class="input" onclick="check_Timefield_checkbox()"><#1457#>
<input type="checkbox" name="filter_lw_date_x_Thu" class="input" onclick="check_Timefield_checkbox()"><#1455#>
<input type="checkbox" name="filter_lw_date_x_Fri" class="input" onclick="check_Timefield_checkbox()"><#1451#>
</td>
</tr>
<tr id="enable_time_week_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,2);"><#1773#></a></th>
<td>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,1);"><#1771#></a></th>
<td>
<input type="checkbox" name="filter_lw_date_x_Sat" class="input" onclick="check_Timefield_checkbox()"><#1453#>
<input type="checkbox" name="filter_lw_date_x_Sun" class="input" onclick="check_Timefield_checkbox()"><#1454#>
</td>
</tr>
...
<tr>
<th ><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,4);"><#1780#></a></th>
<td>
...
<thead>
<tr>
<td colspan="6" id="filter_lwlist"><#1783#>&nbsp;(<#2203#>&nbsp;32)</td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,3);"><#1781#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,2);"><#1782#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,3);"><#1776#></a></th>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,2);"><#1782#></a></th>
<th><#2020#></th>
<th><#2202#></th>
</tr>
