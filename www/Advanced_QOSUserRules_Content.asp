...
if(bwdpi_support){
document.getElementById('content_title').innerHTML = "<#2240#> - <#1668#>";
}
else{
document.getElementById('content_title').innerHTML = "<#311#> - QoS";
}
showqos_rulelist();
load_QoS_rule();
...
function validForm(){
if(document.form.qos_service_name_x_0.value == '<#646#>'){ // when service name is default "Please select", change it to null value. Jieming added at 2012/12/21
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#272#>");
return false;
}
}
}
...
document.form.qos_ip_x_0.focus();
alert(document.form.qos_ip_x_0.value + " <#2222#>");
return false;
}
}
replace_symbol();
...
alert("<#3007#> "+document.form.qos_min_transferred_x_0.value);
return false;
}
return true;
}
...
code += '<option value="0" selected><#1941#></option>';
else
code += '<option value="0"><#1941#></option>';
if(qos_rulelist_col[5] =="1")
code += '<option value="1" selected><#1940#></option>';
else
code += '<option value="1"><#1940#></option>';
if(qos_rulelist_col[5] =="2")
code += '<option value="2" selected><#2233#></option>';
else
code += '<option value="2"><#2233#></option>';
if(qos_rulelist_col[5] =="3")
code += '<option value="3" selected><#2211#></option>';
else
code += '<option value="3"><#2211#></option>';
if(qos_rulelist_col[5] =="4")
code += '<option value="4" selected><#2212#></option>';
else
code += '<option value="4"><#2212#></option>';
code += '</select></td>';
}
}
code +='<td width="6%">';
...
<option value="2" selected><#2539#></option>
<option value="3"><#2538#></option>
</select>
</div>
</td>
</tr>
...
<thead>
<tr>
<td colspan="4" id="TriggerList" style="border-right:none;"><#1336#>&nbsp;(<#2203#>&nbsp;32)</td>
...
<tr>
<th><#1337#></th>
<th><a href="javascript:void(0);" onClick="openHint(18,6);"><div class="table_text"><#1338#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(18,4);"><div class="table_text"><#1339#></div></a></th>
<th><div class="table_text"><#2020#></div></th>
<th><a href="javascript:void(0);" onClick="openHint(18,5);"><div class="table_text"><div class="table_text"><#2994#></div></a></th>
<th><#1340#></th>
<th><#2202#></th>
</tr>
<tr>
<td width="20%">
<input type="text" maxlength="32" class="input_12_table" style="float:left;width:105px;" placeholder="<#646#>" name="qos_service_name_x_0" onKeyPress="return validator.isString(this, event)" autocorrect="off" autocapitalize="off">
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullQoSList(this);" title="<#2620#>">
...
<img id="pull_arrow_mac" class="pull_arrow"height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#2615#>">
...
<td width="15%">
<select name='qos_prio_x_0' class="input_option" style="width:87px;"> <option value='0'><#1941#></option>
<option value='1' selected><#1940#></option>
<option value='2'><#2233#></option>
<option value='3'><#2211#></option>
<option value='4'><#2212#></option>
</select>
</td>
<td width="6%">
