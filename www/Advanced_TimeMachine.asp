...
document.getElementById("tmPath").innerHTML = '<div style="margin-left:5px;color:#FC0"><#1542#></div>';
...
htmlcode += '<tr height="300px"><td colspan="2"><span class="app_name" style="line-height:100%"><#2386#></span></td></tr>\n';
...
totalSpace = _total;
availSpace = _avail;
document.getElementById("maxVolSize").innerHTML = "<#1260#>: " + _avail + " GB";
...
<tr>
<td>
<div style="width:450px;font-family:Arial;font-size:13px;font-weight:bolder; margin-top:23px;margin-left:30px;"><#1542#> :</div>
</td>
</tr>
</table>
...
<input class="button_gen" type="button" style="margin-left:40%;margin-top:18px;" onclick="cancel_folderTree();" value="<#186#>">
</div>
</div>
...
<tr>
<td align="left">
<span class="formfonttitle"><#2784#></span>
</td>
<td align="right">
...
2. <#2794#> <br>
3. <#2796#><br>
4. <#2786#> ( <a id="faq2" href="" target="_blank" style="text-decoration:underline;"><#2785#></a> )<br>
5. <a id="faq" href="" target="_blank" style="text-decoration:underline;"><#2790#></a><br>
...
<th><#2787#></a></th>
<td>
<input class="button_gen" onclick="selPartition()" type="button" value="<#644#>"/>
...
<th><#2797#></a></th>
<td>
<input id="tm_vol_size" name="tm_vol_size" maxlength="5" class="input_6_table" type="text" maxLength="8" value="<% nvram_get("tm_vol_size"); %>" onKeyPress="return validator.isNumber(this,event);" placeholder="0" autocorrect="off" autocapitalize="off"/> GB (0: <#2196#>)
