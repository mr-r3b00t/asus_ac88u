...
<title><#756#> - Subnet Management</title>
...
alertMsg("<#3455#>", ipConflict_cp.ipAddr, ipConflict_cp.netLegalRangeStart, ipConflict_cp.netLegalRangeEnd);
return false;
}
}
if(cp_freewifi_support){
...
<tr>
<td align="left">
<span class="formfonttitle"><#686#></span>
...
<th><#2102#></th>
<td>
<input type="radio" value="1" name="radioDHCPEnable" class="content_input_fd" checked><#176#>
<input type="radio" value="0" name="radioDHCPEnable" class="content_input_fd"><#175#>
</td>
</tr>
<tr>
...
<input type="radio" value="1" name="dhcp_static" /><#176#>
<input type="radio" value="0" name="dhcp_static" /><#175#>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="3" id="GWStatic"><#2119#>&nbsp;(<#2203#>&nbsp;<span id="max_staticIp_num" style="color:#FFF;">8</span>)</td>
</tr>
</thead>
<tr>
...
<input class="button_gen" type="button" onclick="show_subnet_edit(0);" value="<#186#>">
<input id="saveButton" class="button_gen" type="button" onclick="" value="<#1433#>">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#322#> - <#2738#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#356#></div>
<div style="margin-left:8px; margin-bottom:7px;"> <div style="font-size:12px; font-weight:800;display:table-cell;vertical-align:bottom;"><#357#>&nbsp;(<#2203#>&nbsp;8)</div><div style="display:table-cell;padding-left:6px;"><input id="add_subnet_btn" type="button" class="add_btn" onClick="add_subnet();" value=""></div></div>
...
<tr>
<th style="width:19%"><#2584#></th>
<th style="width:19%"><#252#></th>
<th style="width:19%"><#2125#></th>
<th style="width:19%"><#2123#></th>
<th style="width:10%"><#2115#></th>
<th style="width:7%"><#2530#></th>
<th><#1417#></th>
</tr>
</table>
