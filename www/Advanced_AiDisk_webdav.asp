...
<tr>
<td align="left">
<span class="formfonttitle"><#332#> - <#335#></span>
</td>
<td align="right">
...
<div class="formfontdesc"><#2955#></div>
...
<option value="0" <% nvram_match("enable_webdav", "0","selected"); %> ><#3277#></option>
<option value="1" <% nvram_match("enable_webdav", "1","selected"); %> ><#3276#></option>
</select>
</td>
</tr>
