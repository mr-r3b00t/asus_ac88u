...
<div>&nbsp;</div>
<div class="formfonttitle"><#322#> - <#323#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2105#></div>
<div id="VPN_conflict" class="formfontdesc" style="color:#FFCC00;display:none;"><#2106#></div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,13);"><#2151#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,2);"><#2113#></a>
</th>
<td>
...
<th width="30%"><#291#></th>
<td>
<input type="radio" name="lan_proto_radio" class="input" onclick="change_ip_setting('dhcp')" value="dhcp" <% nvram_match("lan_proto", "dhcp", "checked"); %>><#176#>
<input type="radio" name="lan_proto_radio" class="input" onclick="change_ip_setting('static')" value="static" <% nvram_match("lan_proto", "static", "checked"); %>><#175#>
</td>
</tr>
<tr>
<th width="30%">
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(4,1);"><#241#></a>
</th>
<td>
...
<tr>
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(4,2);"><#252#></a>
</th>
<td>
...
<td>
<input type="radio" name="lan_dnsenable_x_radio" value="1" onclick="display_lan_dns(1)" <% nvram_match("lan_dnsenable_x", "1", "checked"); %> /><#176#>
<input type="radio" name="lan_dnsenable_x_radio" value="0" onclick="display_lan_dns(0)" <% nvram_match("lan_dnsenable_x", "0", "checked"); %> /><#175#>
</td>
</tr>
<tr id="table_dns1">
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,13);"><#244#></a>
</th>
<td>
...
<tr id="table_dns2">
<th>
<a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,14);"><#246#></a>
</th>
<td>
