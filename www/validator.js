...
document.getElementById("check_ip_input").innerHTML="<#272#>";
...
alert(document.form.wan_ipaddr_x.value + " <#272#>");
document.form.wan_ipaddr_x1.focus();
return false;
}
...
alert(document.form.wan_ipaddr_x1.value + "<#258#>");
document.form.wan_ipaddr_x1.focus();
document.form.wan_ipaddr_x1.select();
return false;
}
...
if(!groupChar(c)){
alert('<#277#> '+o.value.charAt(i)+' <#278#>');
o.focus();
o.select();
return false;
}
