...
var category_title = ["", "<#804#>", "<#815#>", "<#808#>", "<#817#>","<#803#>", "<#810#>", "<#819#>"];
...
if(adaptiveqos_support){
document.getElementById('content_title').innerHTML = "<#2240#> - <#812#>";
if(document.form.qos_enable.value == "1"){
if(qos_type == 0){ //Traditional Type
add_option(document.getElementById("settingSelection"), '<#2539#>', 3, 0);
add_option(document.getElementById("settingSelection"), '<#2538#>', 4, 0);
}
...
document.getElementById('content_title').innerHTML = "<#311#> - <#2240#>";
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#272#>");
return false;
}
}
}
...
document.form.PC_devicename.focus();
alert(document.form.PC_devicename.value + " <#2222#>");
return false;
}
}
}
...
code += '<thead><tr>';
if(pm_support)
code += '<td colspan="5"><#2455#>&nbsp;(<#2203#>&nbsp;32)</td>';
else
code += '<td colspan="5"><#1392#>&nbsp;(<#2203#>&nbsp;32)</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th style="width:60px" height="30px" title="<#2612#>">';
if(select_all_checked == 1)
code += '<div><div id="selAll" class="all_enable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1231#></div></div>';
else
code += '<div><div id="selAll" class="all_disable" style="margin: auto;width:40px;" onclick="enable_check(this);"><#1231#></div></div>';
code += '</th>';
if(pm_support)
code += '<th style="width:330px" title="Target can be a group name, IP or IP range(ex:192.168.1.5-10)"><#2377#></th>';
else
code += '<th style="width:330px"><#2377#></th>';
code += '<th style="width:130px"><#1552#></th>';
code += '<th style="width:130px"><#2946#></th>';
code += '<th style="width:90px"><#2202#></th>';
code += '</tr>';
...
code += '<input type="text" style="margin-left:10px;float:left;width:255px;" class="input_20_table" name="PC_devicename" onkeyup="device_filter(this);check_field();" placeholder="<#1030#>" autocorrect="off" autocapitalize="off" autocomplete="off">';
code += '<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" onclick="pullLANIPList(this);" title="<#2615#>">';
...
code += '</tr>';
if(qos_bw_rulelist == ""){
code += '<tr><td style="color:#FFCC00;" colspan="10"><#2027#></td></tr>';
}
else{
...
<div class="formfontdesc" style="line-height:20px;font-size:14px;"><#813#></div>
</div>
...
<tr>
<td colspan="2">
<div class="priority priority_highest"><#1941#></div>
</td>
</tr>
<tr>
<td colspan="2">
...
<tr>
<td colspan="2">
<div class="priority priority_lowest"><#2212#></div>
</td>
</tr>
</table>
</td>
...
<input class="button_gen" id="btn_cancel_priority" type="button" onclick="cancel_priority_panel();" value="<#186#>">
<input class="button_gen" type="button" onclick="save_priority();" value="<#1434#>">
</div>
</td>
</tr>
</form>
...
<#1658#>
<ul>
<li id="function_int_desc"><#1659#></li>
<li><#1662#></li>
<li><#1660#></li>
</ul>
<#1661#>
...
<td colspan="2">
<input type="radio" name="nvgfn_enable" class="input" value="1" <% nvram_match("nvgfn_enable", "1", "checked"); %>><#176#>
<input type="radio" name="nvgfn_enable" class="input" value="0" <% nvram_match("nvgfn_enable", "0", "checked"); %>><#175#>
</td>
</tr>
<tr>
<th><#1639#></th>
...
<div id="qos_enable_hint" style="color:#FC0;margin:5px 0px 0px 100px;display:none"><#1665#></div>
</td>
</tr>
<tr id="qos_type_tr" style="display:none">
<th><#2537#></th>
<td colspan="3">
<input id="int_type" name="qos_type_radio" value="1" onClick="change_qos_type(this.value);" style="display:none;" type="radio" <% nvram_match("qos_type", "1","checked"); %>><a id="int_type_link" class="hintstyle" style="display:none;" href="javascript:void(0);" onClick="openHint(20, 5);"><label for="int_type"><#811#></label></a>
<input id="trad_type" name="qos_type_radio" value="0" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "0","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 6);"><label for="trad_type"><#1668#></label></a>
<input id="bw_limit_type" name="qos_type_radio" value="2" onClick="change_qos_type(this.value);" type="radio" <% nvram_match("qos_type", "2","checked"); %>><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 7)"><label for="bw_limit_type"><#151#></label></a>
...
<th><#1268#></th>
<td colspan="2">
<input id="auto" name="bw_setting_name" onClick="bandwidth_setting();" type="radio"><label for="auto"><#150#></label>
<input id="manu" name="bw_setting_name" onClick="bandwidth_setting();" type="radio"><label for="manu"><#308#></label>
</td>
</tr>
<tr id="wan_1_tr" style="display:none">
<th colspan=3><#1619#></th>
</tr>
<tr id="upload_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#2946#></a></th>
<td>
...
<tr id="download_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(20, 2);"><#1552#></a></th>
<td>
...
<tr>
<td height="30" align="left" valign="top" bgcolor="#4D595D">
<div class="formfontdesc" style="line-height:20px;font-size:14px;"><#814#></div>
</td>
</tr>
</table>
...
<tr>
<td height="50" >
<div style=" *width:136px;margin-left:300px;" class="titlebtn" align="center" onClick="submitQoS();"><span><#184#></span></div>
</td>
</tr>
</table>
</td>
