...
<link rel="icon" href="images/favicon.png"><title><#756#> - <#699#></title>
...
<tr>
<td align="left">
<span class="formfonttitle"><#699#></span>
</td>
<td align="right">
<img onclick="go_setting('/APP_Installation.asp')" align="right" style="cursor:pointer;position:absolute;margin-left:-20px;margin-top:-30px;" title="<#312#>" src="/images/backprev.png" onMouseOver="this.src='/images/backprevclick.png'" onMouseOut="this.src='/images/backprev.png'">
</td>
</tr>
</table>
</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="upnp_desc_id" class="formfontdesc"><#2950#></div>
</td>
</tr>
<tr>
<td>
...
<div id="noUSB" style="color:#FC0;display:none;margin-left:17px;padding-top:2px;padding-bottom:2px;"><#2386#></div>
</td>
</tr>
<tr>
<th><#1534#></th>
...
<th><#1536#></th>
<td>
<input type="radio" value="0" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "0", "checked"); %>><#1537#>
<input type="radio" value="1" name="dms_dir_manual_x" class="input" onClick="set_dms_dir(this);" <% nvram_match("dms_dir_manual", "1", "checked"); %>><#1535#>
</td>
</tr>
</table>
</div>
...
<thead>
<tr>
<td colspan="3" id="GWStatic"><#1535#>&nbsp;(<#2203#>&nbsp;10)</td>
</tr>
</thead>
<tr>
<th><#1532#></th>
...
<tr>
<td width="45%">
<input id="PATH" type="text" class="input_30_table" value="" onclick="get_disk_tree();" autocorrect="off" autocapitalize="off" readonly="readonly"/" placeholder="<#646#>" >
</td>
<td width="40%">
...
<div class="apply_gen">
<input type="button" class="button_gen" onclick="applyRule()" value="<#184#>"/>
</div>
</td>
</tr>
<tr>
