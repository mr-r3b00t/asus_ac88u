...
<textarea id="amas_relese_note_hint" cols='63' rows='18' wrap='normal' readonly='readonly' style='width:98%; font-family:Courier New, Courier, mono; font-size:13px;color:#FFFFFF;background-color:rgb(43, 55, 59); word-wrap:normal; border:0px; '>Loading release note, please wait…</textarea></body>
</html>
