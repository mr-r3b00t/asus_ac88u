...
<script>
option_netstat = new Array("<#2672#>","<#2676#>","<#2677#>","<#2675#>","<#2678#>","<#2673#>","<#1530#>");
optval_netstat = new Array("-a","-t","-u","-w","-x","-l","-r");
option_netstat_nat = new Array("<#2350#>", "<#2351#>", "<#2352#>");
...
document.getElementById("cmdDesc").innerHTML = "<#2370#>";
...
<div>&nbsp;</div>
<div class="formfonttitle"><#2363#> - Netstat</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc" id="cmdDesc"><#2370#></div>
...
<option value="-a"><#2672#></option>
<option value="-ta"><#2676#></option>
<option value="-ua"><#2677#></option>
<option value="-w"><#2675#></option>
<option value="-xa"><#2678#></option>
<option value="-l"><#2673#></option>
<option value="-r"><#1530#></option>
</select>
</td>
</tr>
<tr id="targetip_tr" style="display:none;">
<th width="20%"><#2377#> IP</th>
<td>
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#2616#>">
...
<option value="-r state" selected><#2357#></option>
<option value="-r src"><#2355#></option>
<option value="-r dst"><#2353#></option>
<option value="-r src-port"><#2356#></option>
<option value="-r dst-port"><#2354#></option>
</select>
</td>
</tr>
