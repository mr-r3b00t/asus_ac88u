...
html += '</a>';
html += '<div class="clients" id="ameshNumber" style="cursor:pointer;"><#946#>: <span>0</span></div>';
...
document.getElementById('NM_connect_title').innerHTML = "<#2409#> :";
}
else{
...
document.getElementById("first_wan_title").innerHTML = "<#1650#>:";
...
if(gobi_support)
document.getElementById("first_wan_title").innerHTML = "<#2308#>:";
else
document.getElementById("first_wan_title").innerHTML = "<#336#>:";
}
if(dualwan_second_if == 'wan')
document.getElementById("second_wan_title").innerHTML = "<#1650#>:";
...
if(gobi_support)
document.getElementById("second_wan_title").innerHTML = "<#2308#>:";
else
document.getElementById("second_wan_title").innerHTML = "<#336#>:";
}
}
...
if( ddns_enable == '0')
document.getElementById("ddnsHostName").innerHTML = '<a style="color:#FFF;text-decoration:underline;" href="/Advanced_ASUSDDNS_Content.asp?af=ddns_enable_x"><#1349#></a>';
else if(ddnsName == '')
document.getElementById("ddnsHostName").innerHTML = '<a style="color:#FFF;text-decoration:underline;" href="/Advanced_ASUSDDNS_Content.asp?af=DDNSName"><#2671#></a>';
...
if(sw_mode == "3"){
showtext(document.getElementById("NM_connect_status"), "<div style='margin-top:10px;'><#3287#></div>");
}
else if(sw_mode == "2"){
showtext(document.getElementById("NM_connect_title"), "<div style='margin-top:10px;'><#663#>:</div><br>");
}
else
return 0;
}
...
document.getElementById("clientNumber").innerHTML = "<#1842#>: <span id='_clientNumber'>" + num + "</span>";
}
...
dec_html_code += '<div class="style1"><strong id="diskUnmount'+ device.usbPath +'"><#1502#></strong></div>\n';
}
...
document.getElementById("deviceDec_" + device.usbPath).innerHTML = '<div style="margin:10px;"><#1423#></div>';
else
document.getElementById("deviceDec_" + device.usbPath).innerHTML = '<div style="margin:10px;"><#1420#></div>';
}
...
document.getElementById("changeIconTitle").innerHTML = "<#1416#>";
}
else {
$("#custom_image").slideUp("slow");
document.getElementById("changeIconTitle").innerHTML = "<#1413#>";
}
}
...
if(bwdpi_support) {
document.getElementById("time_scheduling_title").innerHTML = "<#2783#>";
}
...
switch (rssi_t) {
case 1:
connectModeTip = "<#637#>: <#403#>\n";
break;
case 2:
connectModeTip = "<#637#>: <#404#>\n";
break;
case 3:
connectModeTip = "<#637#>: <#405#>\n";
break;
case 4:
connectModeTip = "<#637#>: <#406#>\n";
break;
}
if(stainfo_support) {
if(clientObj.curTx != "")
...
connectModeTip += "<#787#>: " + clientObj.wlConnectTime + "";
}
}
if(sw_mode != 4){
...
document.getElementById('client_login').innerHTML = "<#1363#>";
}
if(clientObj.isPrinter) {
document.getElementById('client_printer').style.display = "";
document.getElementById('client_printer').innerHTML = "<#1364#>";
}
...
var opModeDes = ["none", "<#760#>", "<#390#>", "<#369#>", "<#377#>"];
...
code +='<tr><td style="color:#FFCC00;" colspan="4"><#2027#></td></tr>';
...
<div style="margin:200px auto; width:300px; background-color:#006699; color:#FFFFFF; line-height:150%; border:3px solid #FFF; padding:5px;"><#362#></p></div>
</div>
</noscript>
...
<div style="background: #121C1E;font-size: 16px;padding: 10px 20px;margin: 0 5px;border-radius: 8px;min-width: 80px;text-align: center;cursor:pointer" onclick="hide_notice()"><#186#></div>
<div style="background: #121C1E;font-size: 16px;padding: 10px 20px;margin: 0 5px;border-radius: 8px;min-width: 80px;text-align: center;cursor:pointer" onclick="notice_apply();"><#184#></div>
</div>
</div>
...
<thead>
<tr>
<td colspan="4">Client upload icon&nbsp;(<#2203#>&nbsp;100)</td>
</tr>
</thead>
<tr>
<th width="45%"><#1357#></th>
...
<input class="button_gen" type="button" onclick="btUserIconCancel();" value="<#186#>">
<input class="button_gen" type="button" onclick="btUserIconEdit();" value="<#1433#>">
...
<span title="Change to default client icon" class="IE8HACK" onclick="setDefaultIcon();"><#1419#></span>
<span id="changeIconTitle" class="IE8HACK" title="Change client icon" style="margin-left:10px;" onclick="show_custom_image();"><#1413#></span>
</div>
</td>
...
<tr>
<td>
<div class="type1" onclick="select_image(this.className);" title="Windows device"></div></td>
<td>
<div class="type2" onclick="select_image(this.className);" title="Router"></div></td>
<td>
<div class="type4" onclick="select_image(this.className);" title="NAS/Server"></div></td>
<td>
<div class="type5" onclick="select_image(this.className);" title="IP Cam"></div></td>
<td>
<div class="type6" onclick="select_image(this.className);" title="Macbook"></div></td>
<td>
<div class="type7" onclick="select_image(this.className);" title="Game Console"></div></td>
<td>
<div class="type9" onclick="select_image(this.className);" title="Android Phone"></div></td>
</tr>
<tr>
<td>
<div class="type10" onclick="select_image(this.className);" title="iPhone"></div></td>
<td>
<div class="type11" onclick="select_image(this.className);" title="Apple TV"></div></td>
<td>
<div class="type12" onclick="select_image(this.className);" title="Set-top Box"></div></td>
<td>
<div class="type14" onclick="select_image(this.className);" title="iMac"></div></td>
<td>
<div class="type15" onclick="select_image(this.className);" title="ROG"></div></td>
<td>
<div class="type18" onclick="select_image(this.className);" title="<#1364#>"></div>
</td>
<td>
<div class="type19" onclick="select_image(this.className);" title="Windows Phone"></div></td>
</tr>
<tr>
<td>
<div class="type20" onclick="select_image(this.className);" title="Android Tablet"></div></td>
<td>
<div class="type21" onclick="select_image(this.className);" title="iPad"></div></td>
<td>
<div class="type22" onclick="select_image(this.className);" title="Linux Device"></div></td>
<td>
<div class="type23" onclick="select_image(this.className);" title="Smart TV"></div></td>
<td>
<div class="type24" onclick="select_image(this.className);" title="Repeater"></div></td>
<td>
<div class="type25" onclick="select_image(this.className);" title="Kindle"></div></td>
<td>
<div class="type26" onclick="select_image(this.className);" title="Scanner"></div></td>
</tr>
<tr>
<td>
<div class="type27" onclick="select_image(this.className);" title="Chromecast"></div></td>
<td>
<div class="type28" onclick="select_image(this.className);" title="ASUS smartphone"></div></td>
<td>
<div class="type29" onclick="select_image(this.className);" title="ASUS Pad"></div></td>
<td>
<div class="type30" onclick="select_image(this.className);" title="Windows"></div></td>
<td>
<div class="type31" onclick="select_image(this.className);" title="Android"></div></td>
<td>
<div class="type32" onclick="select_image(this.className);" title="Mac OS"></div></td>
<td>
<div class="type35" onclick="select_image(this.className);" title="Windows laptop"></div></td>
</tr>
<tr id="trUserIcon" style="display:none;">
<td>
<div class="client_upload_div">+
<input type="file" name="uploadIcon" id="uploadIcon" class="client_upload_file" onchange="previewImage(this);" title="Upload client icon" /></div>
</td>
</tr>
</table>
</div>
...
<span onmouseover="return overlib('Enable this button to block this device to access internet.');" onmouseout="return nd();"><#1359#></span></div>
<div class="left" style="cursor:pointer;float:right;" id="radio_BlockInternet_enable"></div>
</div>
<div class="clientList_line"></div>
<div style="height:32px;width:100%;margin:5px 0;">
<div style="width:65%;float:left;line-height:32px;">
<span id="time_scheduling_title" onmouseover="return overlib('Time Scheduling allows you to set the time limit for a client\'s network usage.');" onmouseout="return nd();"><#399#></span></div>
<div align="center" class="left" style="cursor:pointer;float:right;" id="radio_TimeScheduling_enable"></div>
<div id="internetTimeScheduling" class="internetTimeEdit" style="float:right;margin-right:10px;" title="<#2783#>" onclick="redirectTimeScheduling();" ></div>
</div>
<div class="clientList_line"></div>
<div style="height:32px;width:100%;margin:5px 0;">
<div style="width:65%;float:left;line-height:32px;">
<span onmouseover="return overlib('Enable this button to bind specific IP with MAC Address of this device.');" onmouseout="return nd();"><#1361#></span></div>
...
<input class="button_gen" type="button" onclick="edit_delete();" id="deleteBtn" value="<#1417#>" style="display:none;">
<input class="button_gen" type="button" id="blockBtn" value="<#1274#>" title="<#1321#>" style="display:none;">
<script>
...
<input class="button_gen" type="button" onclick="closeClientDetailView();" value="<#186#>">
<input id="edit_confirm" class="button_gen" type="button" onclick="edit_confirm();" value="<#184#>">
...
<div id="first_wan_title"><#1619#>:</div>
...
<div id="second_wan_title"><#1625#>:</div>
...
<div>
<span id="NM_connect_title" style="font-size:12px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#2725#>:</span>
<br>
<strong id="NM_connect_status" class="index_status" style="font-size:14px;"><#561#>...</strong>
</div>
...
<strong id="ddnsHostName" class="index_status" style="font-size:14px;"><#452#></strong>
...
<span style="font-size:14px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#1987#>:</span>
...
<span style="font-size:14px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#2611#>: </span>
<br/>
<strong id="wl_securitylevel_span" class="index_status"></strong>
<img id="iflock">
</div>
<div id="mbModeContext" style="display:none">
<span style="font-size:14px;font-family: Verdana, Arial, Helvetica, sans-serif;"><#344#>: </span>
<br/>
<br/>
<strong class="index_status"><#377#></strong>
</div>
</td>
</tr>
<tr>
...
<input type="button" class="button_gen" value="<#3001#>" style="margin-top:15px;" onClick="pop_clientlist_listview(true)">
