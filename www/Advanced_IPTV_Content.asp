...
document.getElementById("iptv_configure_status").innerHTML = "<#758#>";
else
...
document.getElementById("voip_configure_status").innerHTML = "<#758#>";
else
...
if(val == "12")
document.getElementById("gaming_note").innerHTML = "<#2572#>";
else if(val == "56")
document.getElementById("gaming_note").innerHTML = "<#2573#>";
...
<option value="" <% nvram_match("wan_auth_x_now", "", "selected"); %>><#761#></option>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#322#> - IPTV</div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="IPTV_desc" class="formfontdesc" style="display:none;"><#2108#></div>
<div id="IPTV_desc_DualWAN" class="formfontdesc" style="display:none;"><#2109#></div>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#2571#></a></th>
<td>
...
<th width="30%"><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,28);"><#645#></a></th>
<td>
...
<th width="30%"><#1619#></th>
<td align="left">
<span style="color:#FFFFFF;"><#1621#></span>
<select id="wans_lanport1" name="wans_lanport1" class="input_option" style="margin-left:7px;"></select>
<div style="margin-top:2px;"><span style="color:#FFFFFF;">( <#1620#> : </span><span id="cur_primary" style="color:#FFFFFF;"></span><span style="color:#FFFFFF;"> )</span></div>
</td>
</tr>
...
<option value="0" <% nvram_match("dr_enable_x", "0","selected"); %> ><#3277#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(5,11);"><#2579#> (IGMP Proxy)</a></th>
<td>
<select id="mr_enable_x" name="mr_enable_x" class="input_option">
<option value="0" <% nvram_match("mr_enable_x", "0","selected"); %> ><#3277#></option>
<option value="1" <% nvram_match("mr_enable_x", "1","selected"); %> ><#3276#></option>
</select>
<span id="mr_hint" style="display:none;">( <#2580#> )</span>
<div id="mr_disable" style="display:none;">
<span style="color:#FFF;"><#3277#></span>
<span style="margin-left: 5px;">(Due to hardware limitation, IGMP proxy cannot co-exist with IPTV function.)</span></div>
</td>
</tr>
...
<option value="0" <% nvram_match("emf_enable", "0","selected"); %> ><#3277#></option>
<option value="1" <% nvram_match("emf_enable", "1","selected"); %> ><#3276#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(6, 6);"><#2589#></a></th>
<td>
