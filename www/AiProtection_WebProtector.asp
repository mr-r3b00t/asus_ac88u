...
var category_name = ["<#1047#>", "<#1062#>", "<#1065#>", "<#1069#>"];
var sub_category_name = [["<#1049#>", "<#1050#>", "<#1051#>"],
["<#1052#>", "<#1053#>", "<#1054#>", "<#1055#>", "<#1056#>"],
["<#1067#>", "<#1068#>"],
["<#1070#>", "<#1071#>", "<#1072#>"]];
var category_desc = ["<#1048#>",
"<#1063#>",
"<#1066#>",
"<#1073#>"];
var apps_filter_row = apps_filter.split("<");
...
code += '<thead><tr>';
code += '<td colspan="5"><#1392#>&nbsp;(<#2203#>&nbsp;16)</td>';
code += '</tr></thead>';
code += '<tbody>';
code += '<tr>';
code += '<th width="5%" height="30px" title="<#2612#>">';
code += '<input id="selAll" type="checkbox" onclick="selectAll(this, 0);" value="">';
code += '</th>';
code += '<th width="40%"><#1357#> (<#2488#>)</th>';
code += '<th width="40%"><#1057#></th>';
code += '<th width="10%"><#2202#></th>';
code += '</tr>';
code += '<tr id="main_element">';
code += '<td style="border-bottom:2px solid #000;" title="<#3276#>/<#1345#>">';
...
<tr>
<td align="left">
<div class="formfonttitle" style="width:400px"><#1123#> - <#1046#></div>
</td>
<td>
...
<table class="block_filter_name_table_pressed"><tr><td style="line-height:13px;"><#1046#></td></tr></table>
</div>
...
<table class="block_filter_name_table"><tr><td style="line-height:13px;"><#2783#></td></tr></table>
</div>
</a>
</div>
</td>
...
<span><#1064#></span>
<div>
<a id="faq" href="" style="text-decoration:underline;" target="_blank"><#399#> FAQ</a>
</div>
</td>
</tr>
</table>
...
<input class="button_gen" type="button" onclick="applyRule();" value="<#184#>">
