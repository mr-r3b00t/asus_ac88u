...
document.getElementById('statistic_hint').innerHTML = "* <#2832#>";
}
else{
document.getElementById('statistic_hint').innerHTML = "* <#2831#>";
}
...
var description = "";
if(type == "router"){
document.getElementById('top_client_title').innerHTML = "<#301#>:";
if(period == "monthly"){
description = "<#2825#>";
}
...
if(top5_info == ""){
if(type == "router")
document.getElementById('top_client_name').innerHTML = "<#2818#>";
else
document.getElementById('top_client_name').innerHTML = "<#2817#>";
document.getElementById('top_client_traffic').innerHTML = "<#2819#>";
}
else{
...
if(type == "router")
code = "<option value='all' selected><#2815#></option>";
else
code = "<option value='all' selected><#2814#></option>";
top5_client_array = [];
top5_app_array = [];
...
code += '<th colspan="4"><#1357#>: '+ mac +'</th>';
else
code += '<th colspan="4"><#1357#>: '+ getClientCurrentName(mac); +'</th>';
}
else{
...
if(type == "router"){
code += "<th style='width:55%;text-align:left;'><#2816#></th>";
}
else{
code += '<th style="width:55%;text-align:left;"><#1357#></th>';
}
code += '<th style="width:15%;text-align:right;"><#2407#></th>';
code += '<th style="width:15%;text-align:right;"><#2403#></th>';
code += '<th style="width:15%;text-align:right;"><#2810#></th>';
code += '</tr>';
...
code = '<div style="width:110px;word-wrap:break-word;padding-left:5px;background-color:#B3645B;margin-right:-10px;border-top-left-radius:10px;border-bottom-left-radius:10px;"><#2818#></div>';
}
else{
...
if(document.getElementById('duration_option').value == "monthly"){
document.getElementById('total_traffic_title').innerHTML = "<#2830#>";
}
else if(document.getElementById('duration_option').value == "weekly"){
document.getElementById('total_traffic_title').innerHTML = "<#2837#>";
}
else{ //daily
document.getElementById('total_traffic_title').innerHTML = "<#2829#>";
}
document.getElementById('current_traffic_title').innerHTML = "<#2827#>";
document.getElementById('current_traffic_percent_title').innerHTML = "<#2835#>";
}
...
<div class="formfontdesc"><#2828#></div>
<div style="margin-left:10px;">
<label style="font-size:16px;"><#2717#>:</label>
<input class="input_12_table" id="datepicker" value="">
<div id="statistic_hint" style="text-align:right;margin-top:-21px;padding-right:15px;color:#FC0;font-size:14px;">* <#2831#></div>
</div>
...
<tr>
<td>
<div style="font-size:16px;"><#2716#>:</div>
</td>
<td>
<div id="router" style="width:100px;text-align:center;font-size:14px;border-radius:5px" class="block_filter_pressed" onclick="switch_content(this);"><#2432#></div>
</td>
<td>
<div id="apps" style="width:100px;text-align:center;font-size:14px;border-radius:5px" class="block_filter" onclick="switch_content(this);"><#1238#></div>
</td>
</tr>
</table>
</div>
...
<tr>
<td>
<div style="font-size:16px;"><#2718#>:</div>
</td>
<td>
<select class="input_option" id="traffic_option" onChange="change_traffic_direction(this);">
<option value="both" selected><#2402#></option>
<option value="down"><#2403#></option>
<option value="up"><#2407#></option>
</select>
</td>
<td>
<select class="input_option" id="duration_option" onChange="switch_date_type(this);">
<option value="monthly"><#1514#></option>
<option value="weekly"><#1526#></option>
<option value="daily" selected><#1506#></option>
</select>
</td>
<td>
...
<div onclick="change_top5_clients(0);" style="width:100px;word-wrap:break-word;padding-left:5px;background-color:#B3645B;margin-right:-10px;border-top-left-radius:10px;border-bottom-left-radius:10px;"><#2818#></div>
</td>
<td>
...
<tr>
<th style="font-size:16px;text-align:left;padding-left:10px;width:140px;color:#ADADAD" id="top_client_title"><#301#>:</th>
<td style="font-size:14px;" id="top_client_name"></td>
</tr>
<tr>
<th style="font-size:16px;text-align:left;padding-left:10px;width:140px;color:#ADADAD"><#2836#>:</th>
<td style="font-size:14px;" id="top_client_traffic"></td>
</tr>
<tr>
<th style="font-size:16px;text-align:left;padding-left:10px;width:140px;color:#ADADAD"><#2833#> :</th>
<td></td>
</tr>
</table>
...
<tr>
<td colspan="3">
<div style="font-size:16px;color:#FC0;text-align:center;" id="info_block_title"><#2823#></div>
</td>
</td>
</table>
</div>
