...
<div>&nbsp;</div>
<div class="formfonttitle"><#2363#> - <#2379#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2681#></div>
<div class="formfontdesc"><#2682#></div>
...
<input class="button_gen" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<#2380#>">
...
<thead>
<tr>
<td colspan="2" id="GWStatic"><#2373#>&nbsp;(<#2203#>&nbsp;32)</td>
</tr>
</thead>
<tr>
