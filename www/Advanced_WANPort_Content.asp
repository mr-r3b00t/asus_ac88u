...
var confirm_str = "Configure "+ conflict_lanport_text +" as WAN will disable \""+"<#2342#>"+"\" function, are you sure to do it?";//untranslated
...
consume_warning_str = "<#201#> "+consume_bytes+" <#202#>";
...
<tr><td colspan="2"><#2713#></td></tr><tr><td colspan="2"><#2714#>&nbsp;:&nbsp;<span id="str_detect_time"></span>&nbsp;<#2610#>.</td></tr>
<tr>
<th style="width:30%;"><#2721#></th>
<td>
<input type="text" name="detect_interval" class="input_3_table" maxlength="1" value=""; placeholder="5" autocorrect="off" autocapitalize="off" onKeyPress="return validator.isNumber(this, event);" onblur="update_str_time();" style="width: 38px; margin: 0px;">&nbsp;&nbsp;<#2610#>
</td>
</tr>
<tr>
<th><#2723#></th>
...
<span id="detect_tail_msg">&nbsp;( Detection Time: <span id="detection_time_value"></span>&nbsp;&nbsp;<#2610#>)</span>
</td>
</tr>
</table>
<div style="padding-bottom:10px;width:100%;text-align:center;">
<input id="yesButton" class="button_gen" type="button" value="<#176#>" onclick="change_detect_settings();">
<input id="noButton" class="button_gen" type="button" value="<#175#>" onclick="remain_origins();">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle"><#326#> - <#207#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#1587#><a id="dualwan_faq" target="_blank" style="margin-left:5px; text-decoration: underline;"><#207#> FAQ</a></div>
...
<option value="fo"><#1602#></option>
<option value="lb" <% nvram_match("wans_mode", "lb", "selected"); %>><#1603#></option>
</select>
<span id="wans_mode_fo" style="margin-left:5px; color:#FFF; display:none;"><#1602#></span>
<span id="fb_span" style="display:none"><input type="checkbox" id="fb_checkbox"><#1589#></span>
<script>
...
<div id="lb_note" style="color:#FFCC00; display:none;"><#1599#></div>
<div id="lb_note2" style="color:#FFCC00; display:none;"><#1600#></div>
</td>
</tr>
...
<option value="1" <% nvram_match("wans_standby", "1", "selected"); %>><#3276#></option>
<option value="0" <% nvram_match("wans_standby", "0", "selected"); %>><#3277#></option>
</select>
</td>
</tr>
<tr>
...
<input type="radio" value="1" name="wans_isp_unit" class="content_input_fd" onClick="change_isp_unit(this.value);"><#1619#>
<input type="radio" value="2" name="wans_isp_unit" class="content_input_fd" onClick="change_isp_unit(this.value);"><#1625#>
</td>
</tr>
<tr class="ISPProfile">
<th><#1595#></th>
...
<thead>
<tr>
<td colspan="2"><#1618#><div style="font-weight: normal; font-style: italic; margin-top: 5px;"><#1673#></div></td>
</tr>
</thead>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,3);"><#2722#></a></th>
<td id="retry_intervale_setting"><#211#>
<div><span id="consume_bytes_warning" style=""></span></div>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,5);"><div id="fo_detection_count_hd"><#1594#></div></a></th>
<td id="wandog_maxfail_setting"><#1593#></td>
</tr>
<tr id="wandog_fb_count_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(26,6);"><div id="fb_detection_count_hd"><#1592#></div></a></th>
<td id="wandog_fbcount_setting"><#1591#></td>
</tr>
<tr>
<th><#2360#></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#2619#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
...
<th><#1623#></th>
<td>
<input type="radio" value="1" name="wans_routing_enable" onClick="enable_lb_rules(this.value)" class="content_input_fd" <% nvram_match("wans_routing_enable", "1", "checked"); %>><#176#>
<input type="radio" value="0" name="wans_routing_enable" onClick="enable_lb_rules(this.value)" class="content_input_fd" <% nvram_match("wans_routing_enable", "0", "checked"); %>><#175#>
</td>
</tr>
</table>
