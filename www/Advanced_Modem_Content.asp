...
if(modemlist[i] == "AUTO")
document.getElementById("shown_modems").options[i] = new Option("<#149#>", modemlist[i]);
else
...
<tr>
<td align="left">
<span class="formfonttitle"><#336#> / <#2982#></span>
</td>
<td align="right">
...
<div class="formfontdesc"><#1951#></div>
...
<option value="0" <% nvram_match("modem_android", "0", "selected"); %>><#336#></option>
<option value="1" <% nvram_match("modem_android", "1", "selected"); %>><#1234#></option>
</select>
...
<option value="1" <% nvram_match("modem_autoapn", "1","selected"); %>><#149#></option>
<option value="0" <% nvram_match("modem_autoapn", "0","selected"); %>><#308#></option>
</select>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,9);"><#1946#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,8);"><#1957#></a></th>
<td>
...
<tr>
<th width="40%">
<a class="hintstyle" href="javascript:void(0);" onclick="openHint(21,1);"><#2781#></a>
</th>
<td>
...
<br/><span id="hsdpa_hint" style="display:none;"><#1952#></span>
</td>
</tr>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,3);"><#1962#></a></th>
<td>
<input id="modem_apn" name="modem_apn" class="input_20_table" maxlength="32" type="text" value="" autocorrect="off" autocapitalize="off"/>
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;*margin-left:-3px;*margin-top:1px;" onclick="pullLANIPList(this);" title="<#2614#>" onmouseover="over_var=1;" onmouseout="over_var=0;">
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,10);"><#1949#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,11);"><#2990#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,12);"><#411#></a></th>
<td>
...
<option value="0" <% nvram_match("modem_authmode", "0", "selected"); %>><#761#></option>
...
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,2);"><#2439#></a></th>
<td>
...
<br><span id="pincode_status" style="display:none;"><#407#></span>
</td>
</tr>
<tr>
<th>E-mail</th>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(21,13);"><#1963#></a></th>
<td>
