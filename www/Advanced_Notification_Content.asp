...
txt += '</div></div><div class="noti_type_word" title="General notification related to new function introduce or application suggestion."><#488#></div></div>';
...
<div style="display:"><div style="font-size:12px;color:#FFFFFF;font-weight:bold;display:table-cell;padding-left:7px;"><#1523#></div><div id="change_data_sort" class="noti_event_down" style="display:table-cell;" onclick="change_data_sort(this);"></div><div style="display:table-cell;padding-left:58px;">Notice Type</div><div id="change_priority_sort" class="noti_event_down" style="display:table-cell;" onclick="change_priority_sort(this)"></div><div style="display:table-cell;padding-left: 30px;">Content</div></div>
