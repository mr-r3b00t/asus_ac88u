...
<div class="formfontdesc" id="lb_note" style="color:#FFCC00; display:none;"><#2190#></div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr>
<th><#1629#></th>
<td>
<input type="radio" name="dmz_enable" class="input" onclick="dmz_on_off()" ><#176#>
<input type="radio" name="dmz_enable" class="input" onclick="dmz_on_off()" ><#175#>
</td>
</tr>
<tr id="wan_dmz_ip_tr">
<th colspan=2><#1619#></th>
</tr>
<tr id="dmz_ip_tr">
<th><#2005#></th>
<td>
