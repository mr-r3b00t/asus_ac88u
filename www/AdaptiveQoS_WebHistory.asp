...
var code = "";
code += "<tr>";
code += "<th style='width:20%;text-align:left'><#787#></th>";
code += "<th style='width:30%;text-align:left'><#2488#> / <#1357#></th>";
code += "<th style='width:50%;text-align:left'><#1550#></th>";
code += "</tr>";
...
<div>&nbsp;</div>
<div id="content_title" class="formfonttitle"><#2240#> - <#806#></div>
...
<option value="all" selected><#1232#></option>
</select>
...
<div class="apply_gen">
<input class="button_gen" onClick="httpApi.cleanLog('web_history', updateWebHistory);" type="button" value="<#1415#>" >
<input class="button_gen" onClick="getWebHistory(document.form.clientList.value, '1')" type="button" value="<#1436#>">
</div>
</div>
</td>
</tr>
