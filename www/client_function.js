...
code += '<span title="Change to default client icon" onclick="card_setDefaultIcon();"><#1419#></span>';
code += '<span id="card_changeIconTitle" title="Change client icon" style="margin-left:10px;" onclick="card_show_custom_image();"><#1413#></span>';
code += '</div>';
}
code += '</td>';
...
code += '<input class="button_gen" type="button" style="margin-right:5px;" onclick="card_closeClientListView();" value="<#186#>">';
code += '<input id="card_client_confirm" class="button_gen" type="button" onclick="card_confirm(\''+callBack+'\');" value="<#184#>">';
...
connectModeTip += "<#787#>: " + clientInfo.wlConnectTime + "";
}
}
if(sw_mode != 4){
...
document.getElementById("card_client_ipMethod").style.display = "";
document.getElementById("card_client_ipMethod").innerHTML = "<#1365#>";
...
document.getElementById("card_client_login").innerHTML = "<#1363#>";
}
if(clientInfo.isPrinter) {
document.getElementById("card_client_printer").style.display = "";
document.getElementById("card_client_printer").innerHTML = "<#1364#>";
}
...
document.getElementById("card_changeIconTitle").innerHTML = "<#1416#>";
}
else {
slideFlag = true;
slideUp("card_custom_image", 500);
document.getElementById("card_changeIconTitle").innerHTML = "<#1413#>";
}
}
}
...
code += '<thead><tr>';
code += '<td colspan="4">Client upload icon&nbsp;(<#2203#>&nbsp;100)</td>'; /*untranslated*/
code += '</tr></thead>';
code += '<tr>';
code += '<th width="45%"><#2426#></th>';
code += '<th width="30%"><#2424#></th>';
code += '<th width="15%"><#1358#></th>';
code += '<th width="10%"><#1417#></th>';
code += '</tr>';
code += '</table>';
code += '<div id="card_usericons_block"></div>';
code += '<div style="margin-top:15px;padding-bottom:10px;width:100%;text-align:center;">';
code += '<input class="button_gen" type="button" onclick="uploadIcon_cancel();" value="<#186#>">';
code += '<input class="button_gen" type="button" onclick="uploadIcon_confirm();" value="<#1433#>">';
...
drawSwitchModeHtml += "<div class='block_filter_name' style='color:#93A9B1;'><#1231#></div>";
drawSwitchModeHtml += "</div>";
drawSwitchModeHtml += "<div class='block_filter clientlist_ByInterface' style='cursor:pointer'>";
drawSwitchModeHtml += "<div class='block_filter_name' onclick='changeClientListViewMode();'><#3147#></div>";
drawSwitchModeHtml += "</div>";
}
else {
drawSwitchModeHtml += "<div class='block_filter clientlist_All' style='cursor:pointer'>";
drawSwitchModeHtml += "<div class='block_filter_name' onclick='changeClientListViewMode();'><#1231#></div>";
drawSwitchModeHtml += "</div>";
drawSwitchModeHtml += "<div class='block_filter_pressed clientlist_ByInterface'>";
drawSwitchModeHtml += "<div class='block_filter_name' style='color:#93A9B1;'><#3147#></div>";
drawSwitchModeHtml += "</div>";
}
drawSwitchModeHtml += "</div>";
...
code += "<thead><tr height='28px'><td id='td_all_list_title' colspan='" + wl_colspan + "'><#1368#>";
code += "<a id='all_expander'class='clientlist_expander' onclick='showHideContent(\"clientlist_all_list_Block\", this);'>[ <#1369#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_all_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#1989#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1358#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"all_list\");' style='cursor:pointer;'><#2426#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"all_list\");' style='cursor:pointer;'><#3015#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"all_list\");' style='cursor:pointer;'><#2424#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"all_list\");' style='cursor:pointer;'><#3147#></th>";
...
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"str\", \"all_list\");' style='cursor:pointer;'><#787#></th>";
}
code += "</tr>";
code += "</table>";
...
case "ByInterface" :
code += "<table width='100%' border='1' align='center' cellpadding='0' cellspacing='0' class='FormTable_table' style='margin-top:15px;'>";
code += "<thead><tr height='28px'><td colspan='" + wl_colspan + "'><#2808#>";
code += "<a id='wired_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_wired_list_Block\", this);'>[ <#1369#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_wired_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#1989#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1358#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"wired_list\");' style='cursor:pointer;'><#2426#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"wired_list\");' style='cursor:pointer;'><#3015#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"wired_list\");' style='cursor:pointer;'><#2424#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " ><#3147#></th>";
if(stainfo_support && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<th width=" + obj_width[8] + "><#787#></th>";
}
code += "</tr>";
code += "</table>";
...
code += "<a id='wl" + wl_map[wl_nband_title[i]] + "_expander' class='clientlist_expander' onclick='showHideContent(\"clientlist_wl" + wl_map[wl_nband_title[i]] + "_list_Block\", this);'>[ <#1369#> ]</a>";
code += "</td></tr></thead>";
code += "<tr id='tr_wl" + wl_map[wl_nband_title[i]] + "_title' height='40px'>";
code += "<th class='IE8HACK' width=" + obj_width[0] + "><#1989#></th>";
code += "<th class='IE8HACK' width=" + obj_width[1] + "><#1358#></th>";
code += "<th width=" + obj_width[2] + " onclick='sorter.addBorder(this);sorter.doSorter(2, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#2426#></th>";
code += "<th width=" + obj_width[3] + " onclick='sorter.addBorder(this);sorter.doSorter(3, \"num\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#3015#></th>";
code += "<th width=" + obj_width[4] + " onclick='sorter.addBorder(this);sorter.doSorter(4, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#2424#></th>";
if(!(isSwMode('mb') || isSwMode('ew')))
code += "<th width=" + obj_width[5] + " onclick='sorter.addBorder(this);sorter.doSorter(5, \"num\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#3147#></th>";
if(stainfo_support && !(isSwMode('mb') || isSwMode('ew'))) {
...
code += "<th width=" + obj_width[8] + " onclick='sorter.addBorder(this);sorter.doSorter(8, \"str\", \"wl"+wl_map[wl_nband_title[i]]+"_list\");' style='cursor:pointer;'><#787#></th>";
}
code += "</tr>";
code += "</table>";
...
if(!top.isIE8)
code += "<div style='text-align:center;margin-top:15px;'><input type='button' class='button_gen' onclick='exportClientListLog();' value='<#1348#>'></div>";
code += "</td></tr></tbody>";
code += "</table>";
divObj.innerHTML = code;
...
clientListCode += "<tr id='tr_" + objID + "'><td style='color:#FFCC00;' colspan='" + wl_colspan + "'><#2027#></td></tr>";
}
else {
...
document.getElementById(_obj).innerText = "<#2398#>";
}
else {
slideFlag = true;
slideUp(_controlObj, 100);
document.getElementById(_obj).innerText = "<#2399#>";
}
}
}
...
htmlCode += "<div id='" + _containerID + "_clientlist_dropdown_expand' class='clientlist_dropdown_expand' onclick='expand_hide_Client(\"" + _containerID + "_clientlist_dropdown_expand\", \"" + _containerID + "_clientlist_offline\");' onmouseover='over_var=1;' onmouseout='over_var=0;'><#2399#></div>";
...
if(document.getElementById("" + _containerID + "_clientlist_dropdown_expand").innerText == "<#2399#>") {
