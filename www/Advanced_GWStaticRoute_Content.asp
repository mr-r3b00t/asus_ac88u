...
<div>&nbsp;</div>
<div class="formfonttitle"><#322#> - <#325#></div>
...
<th><#2582#></th>
<td>
<input type="radio" value="1" name="sr_enable_x" class="input" onclick="return change_common_radio(this, 'RouterConfig', 'sr_enable_x', '1')" <% nvram_match("sr_enable_x", "1", "checked"); %>><#176#>
<input type="radio" value="0" name="sr_enable_x" class="input" onclick="return change_common_radio(this, 'RouterConfig', 'sr_enable_x', '0')" <% nvram_match("sr_enable_x", "0", "checked"); %>><#175#>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="6" id="GWStatic"><#2581#>&nbsp;(<#2203#>&nbsp;32)</td>
</tr>
</thead>
<tr>
<th><a href="javascript:void(0);" onClick="openHint(6,1);"><div class="table_text"><#2585#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(6,2);"><div class="table_text"><#2586#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(6,3);"><div class="table_text"><#2584#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(6,4);"><div class="table_text"><#2587#></div></a></th>
<th><a href="javascript:void(0);" onClick="openHint(6,5);"><div class="table_text"><#3147#></div></a></th>
<th><#2202#></th>
</tr>
<tr>
<td width="20%">
...
<img id="pull_arrow" height="14px;" src="/images/arrow-down.gif" style="position:absolute;" onclick="pullLANIPList(this);" title="<#2617#>">
