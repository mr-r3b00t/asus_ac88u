...
case "0":
showtext(document.getElementById("dummyShareStr"), "\"<#2734#>\"");
break;
case "1":
showtext(document.getElementById("dummyShareStr"), "\"<#2735#>\"");
break;
case "2":
showtext(document.getElementById("dummyShareStr"), "\"<#2736#>\"");
break;
}
}
...
<tr>
<td align="left" class="formfonttitle" style="padding-left:20px;" height="72"><#2737#></td>
</tr>
<tr>
...
<input type="button" id="finish" value="<#1424#>" class="button_gen">
</div>
</td>
</tr>
</table>
