...
showtext(document.getElementById("alert_msg2"),"*<#221#>");
...
showtext(document.getElementById("alert_msg2"),"*<#292#>");
...
<thead>
<tr>
<td colspan="2"><span style="color:#FFF"><#2323#>: </span><span style="color:#FFF" id="selected_account"></span><img src="../images/button-close.gif" onClick="parent.hidePop('OverlayMask');"></td>
</tr>
</thead>
<tbody>
<tr valign="middle">
<td height="30" colspan="2" class="hint_word"><#2321#></td>
</tr>
<tr>
<th><#873#>: </th>
<td>
...
<tr>
<th colspan="2" align="right"><input id="Submit" type="button" class="button_gen" value="<#190#>"></th>
</tr>
</table>
</form>
</body>
