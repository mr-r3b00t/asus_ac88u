...
<tr>
<td align="left" class="formfonttitle" style="padding-left:20px;" height="72"><#2732#></td>
</tr>
<tr>
<td>
<div style="margin-left:20px;">
<p><input type="radio" name="check_asus_ddns" id="c1" onClick="switch_ddns();" checked>
<label for="c1"><#1472#></label>
</p>
<br/>
...
<input type="button" id="prevButton" value="<#192#>" onclick="go_pre_page();" class="button_gen">
<input type="button" id="nextButton" value="<#191#>" onclick="apply_eula_check();"class="button_gen">
