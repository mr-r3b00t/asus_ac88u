...
disk_list_array = { "info" : ["<#1511#>", "disk.asp"], "health" : ["<#1504#>", "disk_utility.asp"], "format" : ["<#1426#>", "disk_format.asp"]};
...
if(progressBar >= 5)
progressBar =5;
document.getElementById('scan_message').innerHTML = "<#1513#>";
}
...
progressBar = 15;
document.getElementById('scan_message').innerHTML = "<#1524#>";
}
...
progressBar = 40;
document.getElementById('scan_message').innerHTML = "<#1517#>";
}
...
progressBar = 90;
document.getElementById('scan_message').innerHTML = "<#1516#>";
}
else if(scan_status == 5 && stopScan == 0){
if(progressBar <= 90)
progressBar = 91;
document.getElementById('scan_message').innerHTML = "<#1509#>";
}
else{
...
clearTimeout(timer);
document.getElementById('scan_message').innerHTML = "<#1522#>";
...
<div class="font_style" style="margin-left:10px;margin-bottom:5px;margin-top:10px;"><#1507#></div>
<div >
...
<input id="btn_scan" type="button" class="button_gen" onclick="go_scan();" value="<#531#>">
<input id="btn_abort" type="button" class="button_gen" onclick="abort_scan();" value="<#186#>" style="display:none">
...
<tr>
<td class="list_bg">
<div class="font_style" style="margin-left:12px;margin-top:10px;"><#1521#></div>
<div style="margin-top:5px;*margin-top:-5px;width:283px;" class="line_horizontal"></div>
<div style="margin-left:10px;">
<table>
<tr class="font_style">
<td style="width:100px;">
<div style="margin-bottom:5px;" ><#1510#></div>
<select name="diskmon_freq" onchange="freq_change();" class="input_option">
<option value="0" <% nvram_match("diskmon_freq", "0", "selected"); %>><#1345#></option>
<option value="1" <% nvram_match("diskmon_freq", "1", "selected"); %>><#1514#></option>
<option value="2" <% nvram_match("diskmon_freq", "2", "selected"); %>><#1526#></option>
<option value="3" <% nvram_match("diskmon_freq", "3", "selected"); %>><#1506#></option>
</select>
</td>
<td >
<div id="date_field">
<div style="margin-bottom:5px;"><#1450#></div>
...
<td>
<div id="week_field">
<div style="margin-bottom:5px"><#1525#></div>
...
<td>
<div id="time_field">
<div style="margin-bottom:5px;"><#1523#></div>
...
<div style="margin-top:20px;margin-bottom:10px;" align="center">
<input type="button" class="button_gen" onclick="apply_schedule();" value="<#184#>">
