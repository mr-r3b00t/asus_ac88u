...
document.getElementById("span0").innerHTML = "<#2809#>";
document.getElementById("t0").className = "tabclick_NW";
document.getElementById("wl_wpa_psk_title").innerHTML = "<#360#>";
...
document.form.wl_wpa_psk.value = "<#3210#>";
*/
limit_auth_method();
...
var modedesc = visible ? get_yadns_modedesc(i) + ": <#1842#> " + yadns_clients[i] : "";
...
<input type="hidden" name="wl_nmode_x" value="<% nvram_get("wl_nmode_x"); %>"><input type="hidden" name="wps_band" value="<% nvram_get("wps_band_x"); %>">
...
<span id="span_status" style="cursor:pointer;font-weight: bolder;"><#652#></span>
</div>
</td>
</table>
</td>
...
<p class="formfonttitle_nwm" ><#491#></p>
...
<tr>
<td style="padding:5px 10px 0px 10px; *padding:1px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#3220#></p>
...
<td style="padding:5px 10px 0px 10px; *padding:1px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#3274#></p>
...
<td style="padding:5px 10px 0px 10px; *padding:1px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#763#></p>
...
<td style="padding:5px 10px 0px 10px; *padding:1px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#767#></p>
...
<td style="padding:5px 10px 0px 10px;">
<p id="wl_wpa_psk_title" class="formfonttitle_nwm" ><#3395#></p>
...
<input id="applySecurity" type="button" class="button_gen" value="<#184#>" onclick="submitForm();" >
</td>
</tr>
...
<tr>
<td>
<div style="font-family: Arial, Helvetica, sans-serif;font-weight: bolder;"><#3583#></div>
</td>
</tr>
<tr>
...
<tr id="pincode">
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#2439#></p>
...
<tr>
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" >LAN <#301#></p>
...
<tr id="macaddr_wl2">
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" >Wireless <span id="macaddr_wl2_title">2.4GHz </span><#301#></p>
...
<tr id="macaddr_wl5">
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" >Wireless <span id="macaddr_wl5_title">5GHz </span><#301#></p>
...
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" >Wireless <span id="macaddr_wl5_2_title">5GHz-2 </span><#301#></p>
...
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" >Wireless <span id="macaddr_wl60_title">60GHz </span><#301#></p>
