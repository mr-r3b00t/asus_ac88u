...
function initial(){
if(re_status == -1){
showtext(document.getElementById("Connstatus"), "<#390#>");
document.getElementById("remoteIP_tr").style.display = "none";
setTimeout("set_re_status();",6000);
}
else
set_re_status();
document.getElementById("remoteIP_span").innerHTML = (remoteIP == "")?"<#1235#>":remoteIP;
}
function set_re_status(){
re_status = parent.getConnectingStatus();
if(re_status == 2){
showtext(document.getElementById("Connstatus"), "<#178#>");
document.getElementById("remoteIP_tr").style.display = "";
}
else{
showtext(document.getElementById("Connstatus"), "<#1422#>");
document.getElementById("remoteIP_tr").style.display = "none";
}
}
</script>
...
<tr>
<th><#1237#></th>
<td><input type="button" class="button_gen" value="<#1349#>" onclick="javascript:parent.location.href='../survey.htm';"></td>
</tr>
</table>
</body>
</html>
