...
<div class="formfonttitle_nwm"><#1503#> :</div>
<div>
...
<div style="margin-top:5px;*margin-top:-10px;width:283px;" class="line_horizontal"></div>
<div style="padding:7px;">
<div class="formfonttitle_nwm"><#1836#> :</div>
<div>
...
<div style="margin-top:5px;*margin-top:-10px;width:283px;" class="line_horizontal"></div>
<div class="formfonttitle_nwm" style="margin-left:10px;margin-bottom:5px;margin-top:10px;"><#1835#></div>
<span id="log_field" >
...
<input id="btn_format" type="button" class="button_gen" onclick="go_format();" value="<#1426#>">
