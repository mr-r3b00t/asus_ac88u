...
html += "<div class='aimesh_node_setting_info_title'><#3583#></div>";
...
$('#onBoarding_block').append("<div class='amesh_no_data'><#2027#></div>");
if(typeof parent.show_AMesh_status !== 'undefined' && $.isFunction(parent.show_AMesh_status))
...
parent.$("#amesh_connect_msg").find(".amesh_hint_text.amesh_hint_title").html("<#947#>");
}
});
});
}
...
code += "</div>";
code += "<div class='amesh_router_info_text'><#1842#>: ";
var re_client_num = 0;
...
code += "<div class='amesh_title offline' onclick='show_offline_msg(event);'><#1365#></div>";
}
code += "</div>";
code += "</div>";
code += "</div>";
...
description += "<#30#>";
description += "<br>";
description += "<a style='font-weight:bolder;text-decoration:underline;color:#FC0;' href='https://www.asus.com/AiMesh/' target='_blank'><#31#></a>";
...
$amesh_cancel.attr({"type" : "button", "value" : "<#1433#>"});
...
$amesh_wait_search_text.html("<#940#>");
...
$amesh_cancel.attr({"type" : "button", "value" : "<#186#>"});
$amesh_action_bg.append($amesh_cancel);
$amesh_cancel.click(
function() {
initial_amesh_obj();
...
$amesh_apply.attr({"type" : "button", "value" : "<#184#>"});
...
$aimesh_illustration_bg.append(gen_text("<#993#>", "backhaul_router"));
$aimesh_illustration_bg.append(gen_text("<#946#>", "backhaul_node"));
}
else{
...
$aimesh_illustration_bg.append(gen_text("<#946#>", "backhaul_node for_dsl"));
}
...
result_text += "<li><#943#></li>";
result_text += "<li><#944#></li>";
result_text += "<li><#987#></li>";
result_text += "<li><#945#></li>";
result_text += "<li><#934#></li>";
result_text += "</ol>";
var $amesh_hint_text = $('<div>');
$amesh_hint_text.addClass("amesh_hint_text");
$amesh_hint_text.html(result_text);
...
result_text += "<#931#>";
result_text += "<div style='margin-left: 20px;'>1. <#932#></div>";
result_text += "<div style='margin-left: 20px;'>2. <#933#></div>";
result_text += "<div style='margin-left: 20px;'>3. <#934#></div>";
result_text += "<div style='margin-left: 20px;'>4. <#935#></div>";
}
if(ameshRouter_support && ameshNode_support)
result_text += "b. ";
if(ameshNode_support){
result_text += "<#936#>";
result_text += "<div style='margin-left: 20px;'>1. <#937#></div>";
result_text += "<div style='margin-left: 20px;'>2. <#938#></div>";
result_text += "<div style='margin-left: 20px;'>3. <#939#></div>";
}
var $amesh_hint_text = $('<div>');
$amesh_hint_text.addClass("amesh_hint_text");
$amesh_hint_text.html(result_text);
...
$aimesh_illustration_bg.append(gen_text("Modem", "modem"));
$aimesh_illustration_bg.append(gen_text("<#993#>", "router"));
$aimesh_illustration_bg.append(gen_text("<#946#>", "node"));
}
else{
...
$aimesh_illustration_bg.append(gen_text("<#946#>", "node for_dsl"));
}
var $amesh_clear_bg = $('<div>');
$amesh_clear_bg.css("clear", "both");
$aimesh_illustration_bg.append($amesh_clear_bg);
...
code += "<div class='aimesh_node_static_info_title'><#960#></div>";
...
code += "<div class='aimesh_node_static_info_title'><#241#></div>";
...
code += "<div>";
code += "<div class='aimesh_node_setting_info_title'><#301#></div>";
code += "<div id='aimesh_node_macaddr' class='aimesh_node_setting_info_content'></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#954#></div>";
code += "<select id='aimesh_node_connection_priority' class='aimesh_node_input_select'>";
code += "<option value='3' class='aimesh_node_input_select_option'><#149#></option>";
code += "<option value='2' class='aimesh_node_input_select_option'><#3145#></option>";
code += "</select>";
code += "<div id='aimesh_node_connection_priority_hint' class='aimesh_node_setting_info_content'><#1432#></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#181#></div>";
code += "<div class='aimesh_node_setting_info_content'><span id='aimesh_node_connection_type' class='text_hyperlink'></span></div>";
code += "<div class='clear_both'></div>";
code += "</div>";
code += "<div style='margin-top:10px;'>";
code += "<div class='aimesh_node_setting_info_title'><#1847#></div>";
...
code += "<th class='IE8HACK' width=" + aimesh_node_client_info_width[0] + "><#1358#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[1] + " data-clickID='client_name'><#2426#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[2] + " data-clickID='client_ip'><#3015#></th>";
code += "<th class='aimesh_node_client_item' width=" + aimesh_node_client_info_width[3] + " data-clickID='client_interface'><#3147#></th>";
code += "</tr>";
code += "</table>";
code += "</div>";
...
$popupBgHtml.find("#aimesh_node_moreconfig").html("<#2328#>");
/* settup value end */
/* set event start */
...
block_chars_hint = block_chars_array[i] + " <#2082#>";
}
if(block_chars_hint != "") {
...
function() {
var moreConfig = ($popupBgHtml.find(".aimesh_node_setting_bg").css("display") == "none") ? "<#1416#>" : "<#2328#>";
...
var led_table = ["<#1416#>", "<#2211#>", "<#2233#>", "<#1940#>"];
...
$amesh_close.attr({"type" : "button", "value" : "<#1416#>"});
...
nodeClientHtml = "<tr class='aimesh_node_client_tr'><td style='color:#FFCC00;' colspan='" + aimesh_node_client_list_colspan + "'><#2027#></td></tr>";
else {
...
var nodeIP = (nodeClientObj.ip == "offline") ? "<#3582#>" : nodeClientObj.ip;
...
<tr>
<td colspan="2">
<div class="amesh_title"><#926#></div>
<div class="amesh_title amesh_content"><#929#></div>
</td>
</tr>
...
<tr>
<td width="50%">
<div class="amesh_title amesh_help" onclick="scenario();"><#927#></div>
</td>
<td width="50%" height="32px;" style="text-align:center;">
<input id="searchReadyOnBoarding" type="button" class="button_gen" value="<#1440#>" onClick="searchReadyOnBoarding();">
...
<tr>
<td>
<div id="onBoarding_block"><div class='amesh_no_data'><#2027#></div></div>
</td>
</tr>
<tr>
</table>
