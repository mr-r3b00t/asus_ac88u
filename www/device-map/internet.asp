...
var Days = ~~(total / 24);
if (Days != 0)
value += Days.toString() + " <#1458#> ";
if (Hours != 0)
value += Hours.toString() + " <#1943#> ";
if (Minutes != 0)
value += Minutes.toString() + " <#2246#> ";
if (Seconds != 0)
value += Seconds.toString() + " <#2610#>";
return value;
}
function initial(){
if(parent.wans_flag){
...
showtext(document.getElementById("dualwan_mode"), "<#1603#>");
loadBalance_form(unit);
}
else{
showtext(document.getElementById("dualwan_mode"), "<#1602#>");
...
if(lanproto == "static")
showtext(document.getElementById("LanProto"), "<#162#>");
else
showtext(document.getElementById("LanProto"), "<#161#>");
...
wanlink_type_conv = "<#161#>";
else if(wanlink_type_conv == "static")
wanlink_type_conv = "<#162#>";
...
<p class="formfonttitle_nwm" style="float:left;width:98px;"><#327#></p>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:98px;"><#1588#></p>
...
<p class="formfonttitle_nwm"><#3159#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3158#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1601#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1604#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm" ><#181#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3149#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#252#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#3411#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2584#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2115#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2194#></p>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#208#></p>
<input type="button" class="button_gen" onclick="goToDualWAN();" value="<#1349#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
...
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#1352#></p>
<input type="button" class="button_gen" onclick="goToWAN();" value="<#1349#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
</td>
</tr>
</table>
...
<p class="formfonttitle_nwm"><#663#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2099#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#250#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1950#></p>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;"><#100#></p>
<br />
<input type="button" class="button_gen" onclick="gotoSiteSurvey();" value="<#531#>" style="float:right;">
<div style="margin-top:5px;" class="line_horizontal"></div>
</td>
</tr>
</table>
