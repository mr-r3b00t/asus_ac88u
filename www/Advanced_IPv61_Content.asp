...
var ipv6_service_opt = new Array( new Array("<#1345#>", "disabled"),
new Array("Native", "dhcp6"),
new Array("<#2060#>", "other"),
...
alert("<#3007#> "+document.form.ipv61_dhcp_start_start.value);
...
<option value="disabled" <% nvram_match("ipv61_service", "disabled", "selected"); %>><#1345#></option>
<option value="dhcp6" <% nvram_match("ipv61_service", "dhcp6", "selected"); %>>Native</option>
<option value="other" <% nvram_match("ipv61_service", "other", "selected"); %>><#2060#></option>
...
<option class="content_input_fd" value="eth" <% nvram_match("ipv61_ifdev", "eth","selected"); %>><#3145#></option>
</select>
</td>
</tr>
<tr style="display:none;"><th>DHCP-PD</th>
<td>
<input type="radio" name="ipv61_dhcp_pd" class="input" value="1" onclick="showInputfield2('ipv61_dhcp_pd', this.value);" <% nvram_match("ipv61_dhcp_pd", "1","checked"); %>><#3276#>
<input type="radio" name="ipv61_dhcp_pd" class="input" value="0" onclick="showInputfield2('ipv61_dhcp_pd', this.value);" <% nvram_match("ipv61_dhcp_pd", "0","checked"); %>><#1345#>
</td>
</tr>
<tr style="display:none;"><th>Accept Default Route</th> <td>
<input type="radio" name="_ipv61_accept_defrtr" class="input" value="1" <% nvram_match("ipv61_accept_defrtr", "1","checked"); %>><#3276#>
<input type="radio" name="_ipv61_accept_defrtr" class="input" value="0" <% nvram_match("ipv61_accept_defrtr", "0","checked"); %>><#1345#>
</td>
</tr>
...
<th><#2044#></th>
<td>
<input type="radio" name="ipv61_6rd_dhcp" class="input" value="1" onclick="showInputfield2('ipv61_6rd_dhcp', this.value);" <% nvram_match("ipv61_6rd_dhcp", "1","checked"); %>><#3276#>
<input type="radio" name="ipv61_6rd_dhcp" class="input" value="0" onclick="showInputfield2('ipv61_6rd_dhcp', this.value);" <% nvram_match("ipv61_6rd_dhcp", "0","checked"); %>><#1345#>
</td>
</tr>
<tr style="display:none;">
<th><#2046#></th>
...
<th><#248#></th>
<td>
<input type="radio" name="ipv61_dnsenable" class="input" value="1" onclick="showInputfield2('ipv61_dnsenable', this.value);" <% nvram_match("ipv61_dnsenable", "1","checked"); %>><#3276#>
<input type="radio" name="ipv61_dnsenable" class="input" value="0" onclick="showInputfield2('ipv61_dnsenable', this.value);" <% nvram_match("ipv61_dnsenable", "0","checked"); %>><#1345#>
...
<th><#1635#></th>
<td>
<input type="radio" name="_ipv61_radvd" class="input" value="1" <% nvram_match("ipv61_radvd", "1","checked"); %>><#3276#>
<input type="radio" name="_ipv61_radvd" class="input" value="0" <% nvram_match("ipv61_radvd", "0","checked"); %>><#1345#>
</td>
</tr>
</table>
<div class="apply_gen">
