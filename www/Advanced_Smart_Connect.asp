...
code +='<thead><tr><td colspan="4"><#2693#></td></tr></thead>';
code +='<tr id="band_text"><th width="20%"><#1987#></th>';
if(start_band_idx == '1')
...
code +='<td>';
code +='<input onclick="change_lb(1,'+i+');" type="radio" name="wl'+i+'_bsd_steering_balance" value="1"><#176#>';
code +='<input onclick="change_lb(0,'+i+');" type="radio" name="wl'+i+'_bsd_steering_balance" value="0"><#175#>';
code +='</td>';
}
code +='</tr>';
code +='<tr><th><#2694#></th>';
...
code +='<option selected="" value="0" class="content_input_fd"><#2406#></option>';
code +='<option value="1" class="content_input_fd"><#2405#></option>';
code +='</select></td>';
...
code +='<div id="wl'+i+'_bsd_steering_phy_ld_t" style="display:none;"><#1345#></div>';
code +='</td></tr></table></div></span><span class="steering_unuse_off_'+i+'">- -</span></td>';
}
code +='</tr>';
code +='<tr><th><#2437#></th>';
...
code +='<div id="wl'+i+'_bsd_steering_phy_gd_t" style="display:none;"><#1345#></div>';
code +='</td></tr></table></div></span><span class="steering_unuse_off_'+i+'">- -</span></td>';
}
code +='</tr>';
code +='<tr><th>VHT</th>';
...
code +='<option selected="" value="0" class="content_input_fd"><#1231#></option>';
...
code +='<thead><tr><td colspan="4"><#2689#></td></tr></thead>';
...
code +='<div id="wl'+i+'_bsd_sta_select_policy_phy_ld_t" style="display:none;"><#1345#></div>';
code +='</td></tr></table></div></td>';
}
code +='</tr>';
code +='<tr><th><#2437#></th>';
...
code +='<div id="wl'+i+'_bsd_sta_select_policy_phy_gd_t" style="display:none;"><#1345#></div>';
code +='</td></tr></table></div></td>';
}
code +='</tr>';
code +='<tr><th>VHT</th>';
...
var code="";
code +='<table cellspacing="0" cellpadding="4" bordercolor="#6b8fa3" border="1" align="center" width="100%" class="FormTable" id="MainTable2" style="margin-top:10px">';
code +="<thead><tr><td colspan=\"4\"><#2687#></td></tr></thead>";
code +='<tr id="target_band_text"><th width="20%"><#1988#></th>';
if('<% nvram_get("smart_connect_x"); %>' != 2 && wl_info.band5g_2_support){
for(i = start_band_idx; i < wl_info.wl_if_total; i++){
...
vht_desc = ["<#1231#>","AC only","not-allowed"];
vht_value = [0,1,2];
...
<div>&nbsp;</div>
<div class="formfonttitle"><#315#> - <#2688#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2686#></div>
<div style="text-align:right;margin-top:-36px;padding-bottom:3px;"><input type="button" class="button_gen" value="<#3001#>" onClick="pop_clientlist_listview(true)"></div>
...
<th width="20%"><#2692#></th>
<td>
<input type="text" onkeypress="return validator.isNumber(this,event)" value="100" class="input_6_table" name="windows_time_sec" maxlength="4" autocorrect="off" autocapitalize="off"> <#2610#>
</td>
</tr>
<tr>
<th><#2690#></th>
...
<th><#2691#></th>
<td>
<input type="text" onkeypress="return validator.isNumber(this,event)" value="100" class="input_6_table" name="dwell_time_sec" maxlength="4" autocorrect="off" autocapitalize="off"> <#2610#>
</td>
</tr>
</table>
<div class="apply_gen">
<input type="button" id="restoreButton" class="button_gen" value="<#2638#>" onclick="restoreRule();">
