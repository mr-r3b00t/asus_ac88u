...
var invite_content = "";
var sync_rule_desc = "";
document.getElementById('invite_desc').innerHTML = "<#2771#>: " + htmlEnDeCode.htmlEncode(document.form.router_sync_desc.value);
...
document.getElementById('invite_rule').innerHTML = "<#2773#>: "+sync_rule_desc;
...
document.getElementById('invite_captcha').innerHTML = "<#2599#>: None";
else
document.getElementById('invite_captcha').innerHTML = "<#2599#>: "+captcha;
}
...
document.getElementById('invite_desc').innerHTML = "<#2771#>: "+router_synclist_desc[j];
...
document.getElementById('invite_captcha').innerHTML = "<#2599#>: "+ router_synclist_captcha[j];
...
mailtoCode += "<#2774#>%0D%0A".replace(/ /g, "%20");
mailtoCode += document.getElementById('invite_share').innerHTML.replace(/ /g, "%20") + "%0D%0A";
mailtoCode += '"><div onmouseover="" style="margin-right:15px;background-image:url(images/cloudsync/mail_send.png);background-repeat:no-repeat;width:64px;height:64px;"></div><div style="font-size:12px;margin-top:3px;margin-right:17px;"><#2624#></div></a>';
return mailtoCode;
}
...
var hint_string = "";
hint_string += "<#2593#><br><br>";
hint_string += "<#2595#><br><br>";
hint_string += "<#2594#>";
...
<input class="button_gen" type="button" onclick="confirm_folderTree();" value="<#1433#>">
</div>
</div>
<div id="invitation_block" class="panel_folder" >
<table><tr><td>
<div class="machineName" style="width:200px;font-family:Microsoft JhengHei;font-size:12pt;font-weight:bolder; margin-top:20px;margin-left:30px;"><#1992#></div>
</td></tr></table>
...
<tr>
<td>
<div style="margin-top:10px;width:440px;"><#2774#></div>
</td>
</tr>
<tr>
<td>
...
<input class="button_gen" type="button" onclick="close_invitation_block();" value="<#1416#>" style="margin-top:15px;margin-left:200px">
</div>
</div>
...
<div>&nbsp;</div>
<div class="formfonttitle">AiCloud 2.0 - <#2628#></div>
...
3. <#2765#><br>
4. <#2766#><br>
<span class="formfontdesc" id="wan_ip_hide2" style="color:#FFCC00;display:none;margin-left:0px;">5. <#2767#></span>
</div>
</td>
</tr>
</table>
...
<tr>
<td>
<div style="margin-left:15px;margin-top:3px;"><#2769#></div>
</td>
</tr>
</table>
</div>
...
<tr style="height:40px;">
<th>
<div style="margin-top:5px;"><#2776#></div>
</th>
<td>
<input type="text" id="PATH" class="input_25_table" style="height: 25px;" name="cloud_dir" value="" autocorrect="off" autocapitalize="off">
<input name="button" type="button" class="button_gen" onclick="get_disk_tree();" value="<#1374#>"/>
<div id="noUSB" style="color:#FC0;display:none;margin-left:3px;font-size:12px;line-height:140%;"><#2386#></div>
</td>
</tr>
<tr style="height:40px;">
<th>
<div style="margin-top:5px;"><#1377#></div>
</th>
<td>
<select name="router_sync_rule" class="input_option" style="height:27px;">
<option value="0"><#2596#></option>
<option value="1"><#2598#></option>
<option value="2"><#2597#></option>
</select>
<span>
...
<option value="0"><#761#></option>
<option value="1"><#2216#></option>
<option value="2"><#2768#></option>
</select>
...
<input type="button" id="applyButton" class="button_gen" value="<#1427#>" onclick="domain_name_select();">
...
<a href="cloud_main.asp"><span style="font-family:Lucida Console;text-decoration:underline;color:#FC0"><#2590#></span></a><br><#2591#>
</div>
</td>
</tr>
</table>
...
<thead>
<tr>
<td colspan="6" id="cloud_synclist"><#2775#></td>
</tr>
</thead>
<tr>
<th width="10%"><#2522#></th>
<th width="25%"><#1996#></a></th>
...
<input name="applybutton" id="applybutton" type="button" class="button_gen" onclick="location.href='cloud_syslog.asp'" value="<#1414#>" style="word-wrap:break-word;word-break:normal;">
</div>
</div>
</td>
</tr>
