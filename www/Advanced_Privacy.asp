...
document.getElementById("asus_eula_title").innerHTML = "<#127#>";
document.getElementById("alexa_ifttt").style.display = "none";
}
else if(alexa_support && !ifttt_support){
document.getElementById("asus_eula_title").innerHTML = "<#126#>";
document.getElementById("alexa_ifttt").innerHTML = "<#133#>";
}
}
else
...
<div>&nbsp;</div>
<div id="formfonttitle" class="formfonttitle"><#343#> - <#3581#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div id="privacy_desc" style="font-size:14px; margin: 20px 10px auto 10px; display:none;"><#110#></div>
<div id="asus_eula" class="eula_withdraw" style="display:none;">
<div class="eula_withdraw_title" id="asus_eula_title"><#125#></div>
<div class="eula_withdraw_content">
<div><#128#></div>
<div><#129#></div>
<div style="margin-top:5px;"><#130#>
<ol style="margin-top:0px;">
<li><#131#></li>
<li><#132#></li>
<li id="alexa_ifttt"><#134#></li>
</ol>
</div>
</div>
<div style="text-align: center;">
<div style="margin: 0px auto 10px;">
<input class="button_gen" id="asus_withdraw_btn" onclick="withdraw_eula('asus');" type="button" value="<#147#>"/>
...
<div class="eula_withdraw_title"><#143#></div>
<div class="eula_withdraw_content">
<div><#144#></div>
<div style="margin-top:5px;"><#145#>
<div><#141#></div>
<div><#142#></div>
</div>
</div>
<div style="text-align:center;">
<div style="margin: 0px auto 10px;">
<input class="button_gen" id="tm_withdraw_btn" onclick="withdraw_eula('tm');" type="button" value="<#147#>"/>
