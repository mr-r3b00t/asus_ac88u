...
banner_code +='<div style="margin-top:0px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#757#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin:20px 0 0 15px;*width:136px;background:url(\'images/New_ui/btn_logout.png\') no-repeat;background-size:cover;width:132px;height:34px;float:left;" align="center"><div style="margin:8px 0 0 15px;"><#678#></div></div></a>\n';
}
...
banner_code +='<a href="javascript:logout();"><div style="margin-top:13px;margin-left:125px; *width:136px;" class="titlebtn" align="center"><span><#678#></span></div></a>\n';
banner_code +='<a href="javascript:reboot();"><div style="margin-top:13px;margin-left:0px;*width:136px;" class="titlebtn" align="center"><span><#173#></span></div></a>\n';
}
else{
banner_code +='<div class="banner1" align="center"><img src="images/New_ui/asustitle.png" width="218" height="54" align="left">\n';
banner_code +='<div style="margin-top:13px;margin-left:-90px;*margin-top:0px;*margin-left:0px;" align="center"><span id="modelName_top" onclick="this.focus();" class="modelName_top"><#757#></span></div>';
banner_code +='<a href="javascript:logout();"><div style="margin-top:13px;margin-left:25px; *width:136px;" class="titlebtn" align="center"><span><#678#></span></div></a>\n';
banner_code +='<a href="javascript:reboot();"><div style="margin-top:13px;margin-left:0px;*width:136px;" class="titlebtn" align="center"><span><#173#></span></div></a>\n';
}
...
banner_code +='<span style="font-family:Verdana, Arial, Helvetica, sans-serif;"><#345#>:</sapn><span class="title_link" style="text-decoration: none;" id="op_link"><a href="/Advanced_OperationMode_Content.asp" style="color:white"><span id="sw_mode_span" style="text-decoration: underline;"></span></a></span>\n';
}
banner_code +='<span style="font-family:Verdana, Arial, Helvetica, sans-serif;"><#230#></sapn><a href="/Advanced_FirmwareUpgrade_Content.asp" style="color:white;"><span id="firmver" class="title_link"></span></a>\n';
...
banner_code +='<div style="padding:5px 0 5px 15px;font-size:14px;color:#BDBDBD"><#1241#></div>';
banner_code +='</div>';
banner_code +='</div>';
...
banner_code += "<#2265#>";
banner_code +='</div>';
banner_code +="<span><input style=\"margin-left:30px;\" type=\"checkbox\" name=\"stop_show_chk\" id=\"stop_show_chk\"><#2306#></input></span>";
...
footer_code +='<div align="center" class="copyright"><#228#></div><br>';
...
footer_code += '<td width="20" align="right"><div id="bottom_help_icon" style="margin-right:3px;"></div></td><td width="110" id="bottom_help_title" align="left"><#1934#> & <#2739#></td>';
...
var model_name_supportsite = supportsite_model(support_site_modelid, hw_ver); // @ /js/support_site.js
footer_code += "<td width=\"335\" id=\"bottom_help_link\" align=\"left\"><a style=\"font-weight: bolder;text-decoration:underline;cursor:pointer;\" href=\"https://www.asus.com"+ href_lang +"Networking/"+ model_name_supportsite + tracing_path_Manual +"\" target=\"_blank\"><#2215#></a>&nbsp|&nbsp<a style=\"font-weight: bolder;text-decoration:underline;cursor:pointer;\" href=\"https://www.asus.com"+ href_lang +"Networking/" + model_name_supportsite + tracing_path_Utility +"\" target=\"_blank\"><#2998#></a>";
footer_code += '&nbsp|&nbsp<a id="registration_link" target="_blank" href="https://account.asus.com/" target="_self" style="font-weight: bolder;text-decoration:underline;cursor:pointer;"><#2521#></a>';
if(dsl_support && frs_feedback_support){
footer_code += '&nbsp|&nbsp<a id="fb_link" href="/Advanced_Feedback.asp" target="_self" style="font-weight: bolder;text-decoration:underline;cursor:pointer;"><#2235#></a>';
}
...
footer_code += '&nbsp|&nbsp<a id="fb_link" href="'+location_href+'" target="_self" style="font-weight: bolder;text-decoration:underline;cursor:pointer;"><#2235#></a>';
}
footer_code += '</td>';
...
document.getElementById("sw_mode_span").innerHTML = "<#760#>";
else if(sw_mode == "2"){
if(wlc_express == 1)
document.getElementById("sw_mode_span").innerHTML = "<#392#>";
else if(wlc_express == 2)
document.getElementById("sw_mode_span").innerHTML = "<#394#>";
else
document.getElementById("sw_mode_span").innerHTML = "<#390#>";
}
else if(sw_mode == "3")
document.getElementById("sw_mode_span").innerHTML = "<#369#>";
else if(sw_mode == "4")
document.getElementById("sw_mode_span").innerHTML = "<#377#>";
else
...
code +='<td><span id="proceeding_main_txt"><#305#></span><span id="proceeding_txt" style="color:#FFFFCC;"></span></td>\n';
code +='</tr>\n';
code +='</table>\n';
...
document.getElementById('selected_lang').innerHTML = "<#782#>";
}
...
if(document.getElementById("NM_connect_status")){
document.getElementById("NM_connect_status").innerHTML = "<#178#>";
...
if(document.getElementById("NM_connect_status")){
document.getElementById("NM_connect_status").innerHTML = "<#203#>";
