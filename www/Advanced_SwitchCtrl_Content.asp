...
show_menu();
if(ctf_disable == 1){
document.getElementById("ctfLevelDesc").innerHTML = "<#2333#>";
}
else{
if(ctf_fa_mode == '2')
document.getElementById("ctfLevelDesc").innerHTML = "<#2335#>";
else
document.getElementById("ctfLevelDesc").innerHTML = "<#2334#>";
}
if(lacp_support){
...
<div>&nbsp;</div>
<div class="formfonttitle"><#322#> - <#2741#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div class="formfontdesc"><#2745#></div>
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
<tr id="jumbo_tr">
<th><#2098#></th>
<td>
<select name="jumbo_frame_enable" class="input_option">
<option class="content_input_fd" value="0" <% nvram_match("jumbo_frame_enable", "0","selected"); %>><#3277#></option>
<option class="content_input_fd" value="1" <% nvram_match("jumbo_frame_enable", "1","selected"); %>><#3276#></option>
</select>
</td>
</tr>
<tr id="ctf_tr">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(29,2);"><#2331#></a></th>
<td>
<select name="ctf_disable_force" class="input_option">
<option class="content_input_fd" value="1" <% nvram_match("ctf_disable_force", "1","selected"); %>><#3277#></option>
<option class="content_input_fd" value="0" <% nvram_match("ctf_disable_force", "0","selected"); %>><#149#></option>
</select>
&nbsp
...
<option class="content_input_fd" value="0" <% nvram_match("qca_sfe", "0","selected"); %>><#3277#></option>
<option class="content_input_fd" value="1" <% nvram_match("qca_sfe", "1","selected"); %>><#3276#></option>
</select>
</td>
</tr>
...
<th><#2746#></th>
<td>
<input type="radio" name="gro_disable_force" value="0" <% nvram_match("gro_disable_force", "0", "checked"); %>><#176#>
<input type="radio" name="gro_disable_force" value="1" <% nvram_match("gro_disable_force", "1", "checked"); %>><#175#>
</td>
</tr>
<tr id="lacp_tr" style="display:none;">
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(29,1);"><#2342#></a></th>
<td>
<select name="lacp_enabled" class="input_option" onchange="check_bonding_policy(this);">
<option class="content_input_fd" value="0" <% nvram_match("lacp_enabled", "0","selected"); %>><#3277#></option>
<option class="content_input_fd" value="1" <% nvram_match("lacp_enabled", "1","selected"); %>><#3276#></option>
</select>
<div id="lacp_desc" style="display:none"><span id="lacp_note"><#2344#></span><div>
</td>
</tr>
...
<option value="0"><#1419#></option>
<option value="1"><#2744#></option>
<option value="2"><#2743#></option>
</select>
</td>
</tr>
</table>
