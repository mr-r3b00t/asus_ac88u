...
document.getElementById("accessMethod").innerHTML = "<#854#> <a id=\"cloud_url\" style=\"font-weight: bolder;text-decoration: underline;\" href=\"" + aicloud_url + "\" target=\"_blank\">" + aicloud_url + "</a>";
/*
if(https_port == 443)
document.getElementById("accessMethod").innerHTML = "<#854#> <a id=\"cloud_url\" style=\"font-weight: bolder;text-decoration: underline;\" href=\"https://router.asus.com\" target=\"_blank\">https://router.asus.com</a>";
else{
document.getElementById("accessMethod").innerHTML = "<#854#> <a id=\"cloud_url\" style=\"font-weight: bolder;text-decoration: underline;\" href=\"https://router.asus.com\" target=\"_blank\">https://router.asus.com</a>";
...
document.getElementById("accessMethod").innerHTML = "<#854#> <a style=\"font-weight: bolder;text-decoration: underline;word-break:break-all;\" href=\"https://"+ ddns_hostname + ":"+ https_port +"\" target=\"_blank\">https://"+ ddns_hostname +"</a><br />";
else
document.getElementById("accessMethod").innerHTML = "<#854#> <a style=\"font-weight: bolder;text-decoration: underline;word-break:break-all;\" href=\"https://"+ ddns_hostname + ":"+ https_port +"\" target=\"_blank\">https://"+ ddns_hostname +":"+ https_port +"</a><br />";
document.getElementById("accessMethod").innerHTML += '<#848#>';
}
else{
if(https_port == 443) // if the port number of https is 443, hide it
document.getElementById("accessMethod").innerHTML = "<#854#> <a id=\"cloud_url\" style=\"font-weight: bolder;text-decoration: underline;\" href=\"https://router.asus.com\" target=\"_blank\">https://router.asus.com</a>";
...
document.getElementById("accessMethod").innerHTML += '<br/><#850#>';
}
break;
}
if(!rrsut_support)
...
document.getElementById("privateIP_notes").innerHTML = "<#864#>";
...
if(all_accessable_size > 1)
htmlcode += '<div class="app_desc"><#1260#>: <b>'+ all_accessable_size+" GB" + '</b></div>';
else
htmlcode += '<div class="app_desc"><#1260#>: <b>'+ all_accessable_size+" GB <span style=\'color:#FFCC00\'>(Disk quota can not less than 1GB)" + '</span></b></div>';
htmlcode += '<div class="app_desc"><#2811#>: <b>'+ all_total_size+" GB" + '</b></div>';
htmlcode += '</div><br/><br/></td></tr>\n';
mounted_partition++;
}
}
if(mounted_partition == 0)
htmlcode += '<tr height="360px"><td colspan="2"><span class="app_name" style="line-height:100%"><#2386#></span></td></tr>\n';
...
document.getElementById("return_btn").style.display = "none";
document.getElementById("apps_state_desc").innerHTML += '<span class="app_action" onclick="apps_form(\'cancel\',\'\',\'\');">(<#186#>)</span>';
return false;
}
...
<table>
<tr>
<td><div class="formfontdesc" id="usbHint"><#860#></div></td>
</tr>
<tr>
<td><div class="formfontdesc" id="usbHint2"><#2193#> : <a href="https://www.asus.com/search/results.aspx?SearchKey=AiCloud&SearchType=FAQ&IsSupport=True&Page=1" target="_blank" style="color:#FC0;text-decoration: underline; font-family:Lucida Console;">GO</a></div></td>
</tr>
<tr>
...
<li style="margin-top:-5px;">
<#1674#> <a style="font-weight: bolder;text-decoration: underline;" href="https://www.asus.com/search/results.aspx?SearchKey=AiCloud&SearchType=FAQ&IsSupport=True&Page=1" target="_blank">GO</a>
</li>
</ul>
</td>
<td>
...
<div align="center" style="margin-top:10px;font-size: 18px;text-shadow: 1px 1px 0px black;"><#1372#></div>
</div>
</td>
<td width="6px">
...
<div align="center" style="margin-top:10px;font-size: 18px;text-shadow: 1px 1px 0px black;"><#2679#></div>
</div>
</td>
<td>
<div class="line_vertical"></div>
...
<div align="center" style="margin-top:10px;font-size: 18px;text-shadow: 1px 1px 0px black;"><#2695#></div>
</div>
</td>
<td>
<div class="line_vertical"></div>
...
<td class="cloud_main_radius_right" width="100">
<input name="button" type="button" class="button_gen" onclick="location.href='/cloud_sync.asp'" value="<#1349#>"/>
</td>
</tr>
<tr>
