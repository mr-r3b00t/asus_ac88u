...
<#757#> is currently not protected and uses an unsafe default username and password.
</div>
<div style="margin-bottom:10px;">
<#520#>
</div>
...
<td colspan="2">
<div style="color:#FFF;margin:20px 0px -10px 78px;"><#641#></div>
</td>
</tr>
<tr style="height:72px;">
<td colspan="2">
<div style="margin:20px 0px 0px 78px;">
<input type="text" name="http_username_x" tabindex="1" class="form_input" maxlength="20" value="" autocapitalize="off" autocomplete="off" placeholder="<#641#>">
</div>
</td>
</tr>
<tr id="router_password_tr" style="display:none">
<td colspan="2">
<div style="color:#FFF;margin:20px 0px -20px 78px;"><#400#></div>
</td>
</tr>
<tr style="height:72px;">
<td colspan="2">
<div style="margin:30px 0px 0px 78px;">
<input type="password" autocapitalize="off" autocomplete="off" value="" name="http_passwd_x" tabindex="2" class="form_input" maxlength="17" onkeyup="" onpaste="return false;"/ onBlur="" placeholder="<#400#>">
</div>
</td>
</tr>
<tr id="router_password_confirm_tr" style="display:none">
<td colspan="2">
<div style="color:#FFF;margin:20px 0px -20px 78px;"><#1389#></div>
</td>
</tr>
<tr style="height:72px;">
<td colspan="2">
<div style="margin:30px 0px 0px 78px;">
<input type="password" autocapitalize="off" autocomplete="off" value="" name="http_passwd_2_x" tabindex="3" class="form_input" maxlength="17" onkeyup="" onpaste="return false;"/ onBlur="" placeholder="<#1389#>">
</div>
</td>
</tr>
<tr style="heigh:72px">
...
<input name="btn_modify" type="button" class="button" tabindex="4" onclick="submitForm();" value="<#190#>">
</div>
