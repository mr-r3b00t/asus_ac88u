...
add_option(document.form.KnownGames, "<#646#>", 0, 1);
...
code += '<tr><td style="color:#FFCC00;" colspan="8"><#2027#></td></tr>';
else {
...
html += '<td colspan="8">' + wan_title + '<#2029#>&nbsp;(<#2203#>&nbsp;' + profileMaxNum + ')</td>';
html += '</tr>';
html += '</thead>';
html += '<tr>';
html += '<th width="16%"><#1337#></th>';
html += '<th width="15%"><#2030#></th>';
html += '<th width="15%"><#2031#></th>';
html += '<th width="17%"><#2032#></th>';
html += '<th width="8%"><#2020#></th>';
html += '<th width="17%"><#2028#></th>';
html += '<th width="6%"><#2530#></th>';
html += '<th width="6%"><#1417#></th>';
html += '</tr>';
html += '</table>';
...
.append("<option value='0'><#1619#></option>")
.append("<option value='1'><#1625#></option>")
...
<div>&nbsp;</div>
<div class="formfonttitle"><#326#> - <#329#></div>
<div style="margin:10px 0 10px 5px;" class="splitLine"></div>
<div>
<div id="ftpPortConflict" class="formfontdesc" style="display:none;color:#FFCC00;"></div>
<div class="formfontdesc"><#2017#></div>
<ul style="margin-left:-25px; *margin-left:10px;">
<div class="formfontdesc"><li><#1790#></div>
<div class="formfontdesc" id="FTP_desc"><li><#1765#></div>
</ul>
</div>
<div class="formfontdesc" style="margin-top:-10px;">
<a id="faq" href="" target="_blank" style="font-family:Lucida Console;text-decoration:underline;"><#329#>&nbspFAQ</a>
</div>
<div class="formfontdesc" id="lb_note" style="color:#FFCC00; display:none;"><#2191#></div>
...
<tr>
<th><#2016#><input type="hidden" name="vts_num_x_0" value="<% nvram_get("vts_num_x"); %>" readonly="1" /></th>
<td>
...
<div class="apply_gen">
<input class="button_gen" onclick="editProfile('new')" type="button" value="<#3136#>">
</div>
</td>
</tr>
</tbody>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,26);"><#2031#></a></th>
<td>
...
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,25);"><#2032#></a></th>
<td>
...
<img id="pull_arrow" class="pull_arrow" height="16px;" src="images/arrow-down.gif" align="right" onclick="pullLANIPList(this);" title="<#2617#>">
...
<input class="button_gen" type="button" onclick="cancelProfile();" value="<#186#>">
<input id="saveProfile" class="button_gen" type="button" value="<#1433#>">
</div>
</div>
<div id="footer"></div>
</form>
