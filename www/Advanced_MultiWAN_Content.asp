...
<tr>
<td>
<div class="drword" id="drword" style="height:110px;"><#305#> <#302#>...
<br/>
<br/>
</div>
...
<option value="dhcp"><#161#></option>
<option value="static"><#162#></option>
...
<th><#1638#></th>
<td>
<input type="radio" id="wan_enable_now1" name="wan_enable_now" class="input" value="1" <% nvram_match("wan_enable", "1", "checked"); %>><label for="wan_enable_now1"><#176#></label>
<input type="radio" id="wan_enable_now2" name="wan_enable_now" class="input" value="0" <% nvram_match("wan_enable", "0", "checked"); %>><label for="wan_enable_now2"><#175#></label>
</td>
</tr>
<tr>
<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(7,22);"><#1631#></a></th>
<td>
<input type="radio" id="wan_nat_x_now1" name="wan_nat_x_now" class="input" value="1" <% nvram_match("wan_nat_x", "1", "checked"); %>><label for="wan_nat_x_now1"><#176#></label>
<input type="radio" id="wan_nat_x_now2" name="wan_nat_x_now" class="input" value="0" <% nvram_match("wan_nat_x", "0", "checked"); %>><label for="wan_nat_x_now2"><#175#></label>
</td>
</tr>
<tr>
...
<td>
<input type="radio" id="wan_upnp_enable_now1" name="wan_upnp_enable_now" class="input" value="1" onclick="return change_common_radio(this, 'LANHostConfig', 'wan_upnp_enable', '1')" <% nvram_match("wan_upnp_enable", "1", "checked"); %>><label for="wan_upnp_enable_now1"><#176#></label>
<input type="radio" id="wan_upnp_enable_now2" name="wan_upnp_enable_now" class="input" value="0" onclick="return change_common_radio(this, 'LANHostConfig', 'wan_upnp_enable', '0')" <% nvram_match("wan_upnp_enable", "0", "checked"); %>><label for="wan_upnp_enable_now2"><#175#></label>
</td>
</tr>
</table>
</td>
...
<th><#2186#></th>
<td>
<input type="radio" id="wan_dhcpenable_x_now1" name="wan_dhcpenable_x_now" class="input" value="1" onclick="change_wan_dhcp_enable(1);"><label for="wan_dhcpenable_x_now1"><#176#></label>
<input type="radio" id="wan_dhcpenable_x_now2" name="wan_dhcpenable_x_now" class="input" value="0" onclick="change_wan_dhcp_enable(0);"><label for="wan_dhcpenable_x_now2"><#175#></label>
</td>
</tr>
<tr>
...
<td>
<input type="radio" id="wan_dnsenable_x_now1" name="wan_dnsenable_x_now" class="input" value="1" onclick="change_dnsenable(1);"/><label for="wan_dnsenable_x_now1"><#176#></label>
<input type="radio" id="wan_dnsenable_x_now2" name="wan_dnsenable_x_now" class="input" value="0" onclick="change_dnsenable(0);"/><label for="wan_dnsenable_x_now2"><#175#></label>
...
<div style="margin-top:1px;"><input type="checkbox" name="show_pass_1" onclick="pass_checked(document.form.wan_pppoe_passwd_now);"><#545#></div>
</td>
</tr>
...
<option value="" <% nvram_match("wan_pptp_options_x_now", "","selected"); %>><#149#></option>
<option value="-mppc" <% nvram_match("wan_pptp_options_x_now", "-mppc","selected"); %>><#2384#></option>
...
<tr id="vpn_dhcp">
<th><#2501#></th><td><input type="radio" name="wan_vpndhcp_now" class="input" value="1" onclick="return change_common_radio(this, 'IPConnection', 'wan_vpndhcp', 1)" <% nvram_match("wan_vpndhcp", "1", "checked"); %> /><#176#>
<input type="radio" name="wan_vpndhcp_now" class="input" value="0" onclick="return change_common_radio(this, 'IPConnection', 'wan_vpndhcp', 0)" <% nvram_match("wan_vpndhcp", "0", "checked"); %> /><#175#>
</td>
</tr>
<tr>
...
<option value="0"><#1496#></option>
<option value="1"><#1495#></option>
</select>
</td>
</tr>
<tr>
...
<td>
<input type="radio" id="ttl_inc_enable_now1" name="ttl_inc_enable_now" class="input" value="1"><label for="ttl_inc_enable_now1"><#176#></label>
<input type="radio" id="ttl_inc_enable_now2" name="ttl_inc_enable_now" class="input" value="0"><label for="ttl_inc_enable_now2"><#175#></label>
</td>
</tr>
</table>
</td>
...
<input class="button_gen" type="button" onclick="hide_connection_settings();" value="<#186#>">
<input class="button_gen" type="button" onclick="save_connection_settings();" value="<#1433#>">
</div>
</div>
...
<thead>
<tr>
<td colspan="8"><#327#></td></tr>
</thead>
<tr>
<th style="width:13%">Enable/Disable</th><th style="width:13%">State</th><th><#3148#></th>
<th style="width:20%"><#181#></th>
<th style="width:22%">IP Address</th><th style="width:7%"><#2530#></th>
</tr>
<tr>
<td></td>
<td>Connected</td>
