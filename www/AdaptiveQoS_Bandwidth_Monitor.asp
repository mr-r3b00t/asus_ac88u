...
setTimeout(function(){
if(loop_count >= 60) {
$("#sortable").html("<div style='text-align:center;color:#FFCC00'><#2027#></div>");
return false;
}
if(totalClientNum.online != 0)
show_clients();
...
if(code == ""){
code = "<tr><td colspan='3' style='text-align:center;color:#FFCC00'><div style='padding:5px 0px;border-top:solid 1px #333;'><#1266#></div></td></tr>";
}
$(apps_field).empty();
...
<div style="font-size: 14px;margin-right:8px;"><#2718#></div>
<div>
...
<tr>
<td>
<div class="formfonttitle" style="margin-bottom:0px;margin-left:50px;" title="<#1263#>"><#1265#></div>
</td>
<td >
...
<div style="margin:-10px 0 5px 70px;font-size:16px;text-align:center;"><#2946#></div>
...
<td id="download_unit">
<div style="margin:-10px 0 5px -55px;font-size:16px;text-align:center;"><#1552#></div>
...
<div style="font-size:14px;margin-right:8px;"><#2609#></div>
<div>
...
<table>
<tr>
<td><div class="qos_tab" style="width:110px;border-radius:10px;"><#2669#></div></td>
</tr>
</table>
</div>
</td>
...
<span><#184#></span>
<div style="margin:-30px 0 0px -290px;width:200px;"><a id="faq" href="" style="text-decoration:underline;" target="_blank"><#1267#> FAQ</a></div>
</div>
</td>
</tr>
</table>
