...
code += mals_count;
code += '<span style="font-size: 16px;padding-left: 5px;"><#1112#></span>';
...
if(code == ''){
code += '<div style="font-size:16px;text-align:center;margin-top:70px;color:#FC0"><#1045#></div>';
}
...
code += '<div style="display:table-cell;width:180px;padding-right:5px;"><#1523#></div>';
code += '<div style="display:table-cell;width:80px;padding-right:5px;"><#1043#></div>';
code += '<div style="display:table-cell;width:170px;padding-right:5px;"><#1042#></div>';
code += '<div style="display:table-cell;width:200px;padding-right:5px;"><#1041#></div>';
code += '<div style="display:table-cell;width:50px;padding-right:5px;"></div>';
code += '</div>';
if(dataObj == ""){
code += '<div style="text-align:center;font-size:16px;color:#FC0;margin-top:90px;"><#2027#></div>';
}
else{
...
code += '<div style="display:table-cell;width:200px;height:30px;vertical-align:middle;padding-right:5px;text-decoration:underline;cursor:pointer;" title="<#1152#>" onclick="checkEventSafe(\''+ dataObj[eventID].destination[0] +'\');">'+ dataObj[eventID].destination[0] +'</div>';
...
<div style="margin: 16px 24px;font-size:16px;"><#1040#></div>
<div style="display:flex;justify-content: flex-end;margin: 36px 24px;">
<div class="confirm-button" onclick="hideConfirm();"><#186#></div>
<div class="confirm-button" onclick="eraseDatabase();"><#1433#></div>
</div>
</div>
...
<tr>
<td align="left">
<span class="formfonttitle"><#1123#> - <#1120#></span>
</td>
</tr>
</table>
</div>
...
<div style="font-size:16px;margin:0 0 5px 5px;text-align:center"><#1039#></div>
</div>
...
<div style="text-align:center;font-size:16px;"><#1138#></div>
...
<div style="font-size:16px;margin:0 0 5px 5px;text-align:center;"><#1027#></div>
...
<div>
<div style="display:inline-block;margin:5px 10px"><#1112#></div>
</div>
<div style="width:90%">
<div>
...
<div style="text-align:center;font-size:16px;"><#1044#></div>
<div style="display: flex;">
<div style="margin: 0 8px;"><div id="save_icon" class="icon-container icon-save" title="<#1434#>" onclick="download(csvContent, 'MaliciousSitesBlocking.csv', 'data:text/csv;charset=utf-8');"></div></div>
<div style="margin: 0 8px;"><div id="delete_icon" class="icon-container icon-delete" onclick="showEraseConfirm();" title="<#1417#>"></div></div>
...
<div style="font-size: 24px;"><#3191#></div>
<div onclick="hideWhitelistField();"><img src="images/New_ui/icon_close.svg" alt="" style="width:32px;height:32px;cursor:pointer;"></div>
</div>
<div style="color: #CCCCCC;font-size: 16px;margin: 12px 0 24px 0;"><#1121#></div>
<div>
<div style="font-size: 14px;padding: 0 0 2px 4px;"><#1122#></div>
<div>
...
<input type="button" class="button_gen" value="<#1411#>" onclick="addWhitelist();">
</div>
<div style="width:100%;" class="line_horizontal"></div>
<div style="margin-top:24px;">
<span style="font-size: 24px;padding-right:12px;"><#3191#></span>
<span style="font-size: 14px;"><#2367#>: <b id="list_count">0</b> (<#2203#>&nbsp;64)</span>
</div>
...
<div style="display:table-cell;width:180px;padding-right:5px;"><#1523#></div>
<div style="display:table-cell;width:80px;padding-right:5px;"><#1043#></div>
<div style="display:table-cell;width:170px;padding-right:5px;"><#1042#></div>
<div style="display:table-cell;width:200px;padding-right:5px;"><#1041#></div>
